...
static_assert(alignof(UVerse_enableable) == 0x000008, "Wrong alignment on UVerse_enableable");
static_assert(sizeof(UVerse_enableable) == 0x000028, "Wrong size on UVerse_enableable");
