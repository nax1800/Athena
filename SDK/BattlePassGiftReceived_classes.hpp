...
static_assert(sizeof(UBattlePassGiftReceived_C) == 0x000380, "Wrong size on UBattlePassGiftReceived_C");
static_assert(offsetof(UBattlePassGiftReceived_C, UberGraphFrame) == 0x000340, "Member 'UBattlePassGiftReceived_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UBattlePassGiftReceived_C, Intro) == 0x000348, "Member 'UBattlePassGiftReceived_C::Intro' has a wrong offset!");
static_assert(offsetof(UBattlePassGiftReceived_C, Body) == 0x000350, "Member 'UBattlePassGiftReceived_C::Body' has a wrong offset!");
static_assert(offsetof(UBattlePassGiftReceived_C, CommonLazyImage_0) == 0x000358, "Member 'UBattlePassGiftReceived_C::CommonLazyImage_0' has a wrong offset!");
static_assert(offsetof(UBattlePassGiftReceived_C, GiftScrollBox) == 0x000360, "Member 'UBattlePassGiftReceived_C::GiftScrollBox' has a wrong offset!");
static_assert(offsetof(UBattlePassGiftReceived_C, Header) == 0x000368, "Member 'UBattlePassGiftReceived_C::Header' has a wrong offset!");
static_assert(offsetof(UBattlePassGiftReceived_C, ImageRarityFlare) == 0x000370, "Member 'UBattlePassGiftReceived_C::ImageRarityFlare' has a wrong offset!");
static_assert(offsetof(UBattlePassGiftReceived_C, ShowNextButton) == 0x000378, "Member 'UBattlePassGiftReceived_C::ShowNextButton' has a wrong offset!");
