...
public:
	...
	TArray<class UStaticMesh*>                    StaticMeshAlternateArray;                          // 0x0D48(0x0010)(Edit, BlueprintVisible, ZeroConstructor)
...
static_assert(sizeof(APBW_BP_Parent_C) == 0x000D58, "Wrong size on APBW_BP_Parent_C");
static_assert(offsetof(APBW_BP_Parent_C, UberGraphFrame) == 0x000D40, "Member 'APBW_BP_Parent_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(APBW_BP_Parent_C, StaticMeshAlternateArray) == 0x000D48, "Member 'APBW_BP_Parent_C::StaticMeshAlternateArray' has a wrong offset!");
