...
static_assert(sizeof(VaultRotator_C_SetBackgroundString) == 0x000020, "Wrong size on VaultRotator_C_SetBackgroundString");
...
static_assert(sizeof(VaultRotator_C_ExecuteUbergraph_VaultRotator) == 0x000750, "Wrong size on VaultRotator_C_ExecuteUbergraph_VaultRotator");
