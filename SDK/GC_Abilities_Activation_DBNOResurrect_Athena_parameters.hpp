...
static_assert(sizeof(GC_Abilities_Activation_DBNOResurrect_Athena_C_OnBurst) == 0x0002E8, "Wrong size on GC_Abilities_Activation_DBNOResurrect_Athena_C_OnBurst");
