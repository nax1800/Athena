...
// Function Results_TopPanel.Results_TopPanel_C.WidgetAnimationEvt_Anim_Intro_K2Node_WidgetAnimationEvent_0
// (BlueprintEvent)

void UResults_TopPanel_C::WidgetAnimationEvt_Anim_Intro_K2Node_WidgetAnimationEvent_0()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Results_TopPanel_C", "WidgetAnimationEvt_Anim_Intro_K2Node_WidgetAnimationEvent_0");
