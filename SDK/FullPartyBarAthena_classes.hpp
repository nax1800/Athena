...
static_assert(sizeof(UFullPartyBarAthena_C) == 0x000258, "Wrong size on UFullPartyBarAthena_C");
static_assert(offsetof(UFullPartyBarAthena_C, UberGraphFrame) == 0x000250, "Member 'UFullPartyBarAthena_C::UberGraphFrame' has a wrong offset!");
