...
static_assert(sizeof(UTopBar_C) == 0x0004C0, "Wrong size on UTopBar_C");
static_assert(offsetof(UTopBar_C, UberGraphFrame) == 0x000330, "Member 'UTopBar_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UTopBar_C, IntroSocialPanel) == 0x000338, "Member 'UTopBar_C::IntroSocialPanel' has a wrong offset!");
static_assert(offsetof(UTopBar_C, PartyJoinFlash) == 0x000340, "Member 'UTopBar_C::PartyJoinFlash' has a wrong offset!");
static_assert(offsetof(UTopBar_C, IntroMainMenu) == 0x000348, "Member 'UTopBar_C::IntroMainMenu' has a wrong offset!");
static_assert(offsetof(UTopBar_C, Border_SocialPanel) == 0x000350, "Member 'UTopBar_C::Border_SocialPanel' has a wrong offset!");
static_assert(offsetof(UTopBar_C, BP_FortLiveStreamGrantWindowExpires) == 0x000358, "Member 'UTopBar_C::BP_FortLiveStreamGrantWindowExpires' has a wrong offset!");
static_assert(offsetof(UTopBar_C, BRCurrency) == 0x000360, "Member 'UTopBar_C::BRCurrency' has a wrong offset!");
static_assert(offsetof(UTopBar_C, FortniteLogo) == 0x000368, "Member 'UTopBar_C::FortniteLogo' has a wrong offset!");
static_assert(offsetof(UTopBar_C, FriendInviteBang) == 0x000370, "Member 'UTopBar_C::FriendInviteBang' has a wrong offset!");
static_assert(offsetof(UTopBar_C, HBoxStWContent) == 0x000378, "Member 'UTopBar_C::HBoxStWContent' has a wrong offset!");
static_assert(offsetof(UTopBar_C, HorizontalBoxRatingIcons) == 0x000380, "Member 'UTopBar_C::HorizontalBoxRatingIcons' has a wrong offset!");
static_assert(offsetof(UTopBar_C, LobbyTimer_112) == 0x000388, "Member 'UTopBar_C::LobbyTimer_112' has a wrong offset!");
static_assert(offsetof(UTopBar_C, MainMenu) == 0x000390, "Member 'UTopBar_C::MainMenu' has a wrong offset!");
static_assert(offsetof(UTopBar_C, MainMenuBorder) == 0x000398, "Member 'UTopBar_C::MainMenuBorder' has a wrong offset!");
static_assert(offsetof(UTopBar_C, MainMenuButton) == 0x0003A0, "Member 'UTopBar_C::MainMenuButton' has a wrong offset!");
static_assert(offsetof(UTopBar_C, MiniPartyBar) == 0x0003A8, "Member 'UTopBar_C::MiniPartyBar' has a wrong offset!");
static_assert(offsetof(UTopBar_C, MTXButton) == 0x0003B0, "Member 'UTopBar_C::MTXButton' has a wrong offset!");
static_assert(offsetof(UTopBar_C, MTXButtonContainer) == 0x0003B8, "Member 'UTopBar_C::MTXButtonContainer' has a wrong offset!");
static_assert(offsetof(UTopBar_C, PartyFlash) == 0x0003C0, "Member 'UTopBar_C::PartyFlash' has a wrong offset!");
static_assert(offsetof(UTopBar_C, PowerWidget) == 0x0003C8, "Member 'UTopBar_C::PowerWidget' has a wrong offset!");
static_assert(offsetof(UTopBar_C, SafeZone_0) == 0x0003D0, "Member 'UTopBar_C::SafeZone_0' has a wrong offset!");
static_assert(offsetof(UTopBar_C, SafeZone_4) == 0x0003D8, "Member 'UTopBar_C::SafeZone_4' has a wrong offset!");
static_assert(offsetof(UTopBar_C, SafeZoneRatingIcons) == 0x0003E0, "Member 'UTopBar_C::SafeZoneRatingIcons' has a wrong offset!");
static_assert(offsetof(UTopBar_C, ScaleBox_Social) == 0x0003E8, "Member 'UTopBar_C::ScaleBox_Social' has a wrong offset!");
static_assert(offsetof(UTopBar_C, SizeBox_Social) == 0x0003F0, "Member 'UTopBar_C::SizeBox_Social' has a wrong offset!");
static_assert(offsetof(UTopBar_C, Social) == 0x0003F8, "Member 'UTopBar_C::Social' has a wrong offset!");
static_assert(offsetof(UTopBar_C, SocialPanel) == 0x000400, "Member 'UTopBar_C::SocialPanel' has a wrong offset!");
static_assert(offsetof(UTopBar_C, Top) == 0x000408, "Member 'UTopBar_C::Top' has a wrong offset!");
...
static_assert(offsetof(UTopBar_C, TopBarDetailsNew) == 0x0004B0, "Member 'UTopBar_C::TopBarDetailsNew' has a wrong offset!");
static_assert(offsetof(UTopBar_C, Main_Menu_Sound) == 0x0004B8, "Member 'UTopBar_C::Main_Menu_Sound' has a wrong offset!");
