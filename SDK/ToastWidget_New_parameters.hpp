...
static_assert(offsetof(ToastWidget_New_C_ExecuteUbergraph_ToastWidget_New, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000140, "Member 'ToastWidget_New_C_ExecuteUbergraph_ToastWidget_New::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ToastWidget_New_C_StartIntro, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000000, "Member 'ToastWidget_New_C_StartIntro::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
