...
static_assert(sizeof(UGAB_AthenaDBNORevive_C) == 0x000938, "Wrong size on UGAB_AthenaDBNORevive_C");
static_assert(offsetof(UGAB_AthenaDBNORevive_C, UberGraphFrame) == 0x0008F8, "Member 'UGAB_AthenaDBNORevive_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGAB_AthenaDBNORevive_C, EC_AppliedEffect) == 0x000900, "Member 'UGAB_AthenaDBNORevive_C::EC_AppliedEffect' has a wrong offset!");
static_assert(offsetof(UGAB_AthenaDBNORevive_C, PlayerPawn) == 0x000908, "Member 'UGAB_AthenaDBNORevive_C::PlayerPawn' has a wrong offset!");
static_assert(offsetof(UGAB_AthenaDBNORevive_C, KnockbackMagnitude) == 0x000910, "Member 'UGAB_AthenaDBNORevive_C::KnockbackMagnitude' has a wrong offset!");
static_assert(offsetof(UGAB_AthenaDBNORevive_C, HitActors) == 0x000918, "Member 'UGAB_AthenaDBNORevive_C::HitActors' has a wrong offset!");
static_assert(offsetof(UGAB_AthenaDBNORevive_C, KnockbackStunGE) == 0x000928, "Member 'UGAB_AthenaDBNORevive_C::KnockbackStunGE' has a wrong offset!");
static_assert(offsetof(UGAB_AthenaDBNORevive_C, BP_VictoryDrone) == 0x000930, "Member 'UGAB_AthenaDBNORevive_C::BP_VictoryDrone' has a wrong offset!");
