...
static_assert(offsetof(UMainTabTutorialBangWrapper_C, Content) == 0x000250, "Member 'UMainTabTutorialBangWrapper_C::Content' has a wrong offset!");
static_assert(offsetof(UMainTabTutorialBangWrapper_C, CountText) == 0x000258, "Member 'UMainTabTutorialBangWrapper_C::CountText' has a wrong offset!");
static_assert(offsetof(UMainTabTutorialBangWrapper_C, ModeSwitcher) == 0x000260, "Member 'UMainTabTutorialBangWrapper_C::ModeSwitcher' has a wrong offset!");
static_assert(offsetof(UMainTabTutorialBangWrapper_C, NoMinusCount) == 0x000268, "Member 'UMainTabTutorialBangWrapper_C::NoMinusCount' has a wrong offset!");
static_assert(offsetof(UMainTabTutorialBangWrapper_C, NoMinusCountMinus1) == 0x000270, "Member 'UMainTabTutorialBangWrapper_C::NoMinusCountMinus1' has a wrong offset!");
