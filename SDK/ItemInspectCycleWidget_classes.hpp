...
static_assert(sizeof(UItemInspectCycleWidget_C) == 0x0002A8, "Wrong size on UItemInspectCycleWidget_C");
static_assert(offsetof(UItemInspectCycleWidget_C, UberGraphFrame) == 0x000280, "Member 'UItemInspectCycleWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UItemInspectCycleWidget_C, RightPulse) == 0x000288, "Member 'UItemInspectCycleWidget_C::RightPulse' has a wrong offset!");
static_assert(offsetof(UItemInspectCycleWidget_C, LeftPulse) == 0x000290, "Member 'UItemInspectCycleWidget_C::LeftPulse' has a wrong offset!");
static_assert(offsetof(UItemInspectCycleWidget_C, LeftButton) == 0x000298, "Member 'UItemInspectCycleWidget_C::LeftButton' has a wrong offset!");
static_assert(offsetof(UItemInspectCycleWidget_C, RightButton) == 0x0002A0, "Member 'UItemInspectCycleWidget_C::RightButton' has a wrong offset!");
