...
static_assert(offsetof(Results_Badge_C_ExecuteUbergraph_Results_Badge, CallFunc_BooleanOR_ReturnValue2) == 0x000007, "Member 'Results_Badge_C_ExecuteUbergraph_Results_Badge::CallFunc_BooleanOR_ReturnValue2' has a wrong offset!");
