...
static_assert(alignof(Results_Badge_C_ExecuteUbergraph_Results_Badge) == 0x000008, "Wrong alignment on Results_Badge_C_ExecuteUbergraph_Results_Badge");
static_assert(sizeof(Results_Badge_C_ExecuteUbergraph_Results_Badge) == 0x000028, "Wrong size on Results_Badge_C_ExecuteUbergraph_Results_Badge");
...
static_assert(offsetof(Results_Badge_C_ExecuteUbergraph_Results_Badge, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000008, "Member 'Results_Badge_C_ExecuteUbergraph_Results_Badge::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_Badge_C_ExecuteUbergraph_Results_Badge, CallFunc_PlayAnimationAtTime_ReturnValue1) == 0x000010, "Member 'Results_Badge_C_ExecuteUbergraph_Results_Badge::CallFunc_PlayAnimationAtTime_ReturnValue1' has a wrong offset!");
static_assert(offsetof(Results_Badge_C_ExecuteUbergraph_Results_Badge, CallFunc_BooleanOR_ReturnValue2) == 0x000018, "Member 'Results_Badge_C_ExecuteUbergraph_Results_Badge::CallFunc_BooleanOR_ReturnValue2' has a wrong offset!");
static_assert(offsetof(Results_Badge_C_ExecuteUbergraph_Results_Badge, CallFunc_PlayAnimationAtTime_ReturnValue2) == 0x000020, "Member 'Results_Badge_C_ExecuteUbergraph_Results_Badge::CallFunc_PlayAnimationAtTime_ReturnValue2' has a wrong offset!");
...
static_assert(offsetof(Results_Badge_C_DoDesignTimeRandomization, Temp_text_Variable2) == 0x000038, "Member 'Results_Badge_C_DoDesignTimeRandomization::Temp_text_Variable2' has a wrong offset!");
static_assert(offsetof(Results_Badge_C_DoDesignTimeRandomization, Temp_text_Variable3) == 0x000050, "Member 'Results_Badge_C_DoDesignTimeRandomization::Temp_text_Variable3' has a wrong offset!");
