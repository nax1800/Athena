...
static_assert(alignof(PickupMessageItem_C_ExecuteUbergraph_PickupMessageItem) == 0x000008, "Wrong alignment on PickupMessageItem_C_ExecuteUbergraph_PickupMessageItem");
static_assert(sizeof(PickupMessageItem_C_ExecuteUbergraph_PickupMessageItem) == 0x000010, "Wrong size on PickupMessageItem_C_ExecuteUbergraph_PickupMessageItem");
...
static_assert(offsetof(PickupMessageItem_C_ExecuteUbergraph_PickupMessageItem, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000008, "Member 'PickupMessageItem_C_ExecuteUbergraph_PickupMessageItem::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(PickupMessageItem_C_Setup) == 0x000050, "Wrong size on PickupMessageItem_C_Setup");
...
static_assert(offsetof(PickupMessageItem_C_Setup, CallFunc_GetSmallPreviewImage_ReturnValue) == 0x000020, "Member 'PickupMessageItem_C_Setup::CallFunc_GetSmallPreviewImage_ReturnValue' has a wrong offset!");
static_assert(offsetof(PickupMessageItem_C_Setup, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000048, "Member 'PickupMessageItem_C_Setup::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
