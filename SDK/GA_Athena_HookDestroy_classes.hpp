...
static_assert(sizeof(UGA_Athena_HookDestroy_C) == 0x000968, "Wrong size on UGA_Athena_HookDestroy_C");
static_assert(offsetof(UGA_Athena_HookDestroy_C, UberGraphFrame) == 0x0008F8, "Member 'UGA_Athena_HookDestroy_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HookDestroy_C, PlayerPawn) == 0x000900, "Member 'UGA_Athena_HookDestroy_C::PlayerPawn' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HookDestroy_C, SwitchLockGE) == 0x000908, "Member 'UGA_Athena_HookDestroy_C::SwitchLockGE' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HookDestroy_C, Hit_) == 0x000910, "Member 'UGA_Athena_HookDestroy_C::Hit_' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HookDestroy_C, CleanedAngle) == 0x000914, "Member 'UGA_Athena_HookDestroy_C::CleanedAngle' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HookDestroy_C, LaunchAngleVariations) == 0x000918, "Member 'UGA_Athena_HookDestroy_C::LaunchAngleVariations' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HookDestroy_C, TravelMontage) == 0x000928, "Member 'UGA_Athena_HookDestroy_C::TravelMontage' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HookDestroy_C, Debug) == 0x000930, "Member 'UGA_Athena_HookDestroy_C::Debug' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HookDestroy_C, WeaponActor) == 0x000938, "Member 'UGA_Athena_HookDestroy_C::WeaponActor' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HookDestroy_C, ChangeEquipmentTag) == 0x000940, "Member 'UGA_Athena_HookDestroy_C::ChangeEquipmentTag' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HookDestroy_C, RopeActiveTag) == 0x000960, "Member 'UGA_Athena_HookDestroy_C::RopeActiveTag' has a wrong offset!");
