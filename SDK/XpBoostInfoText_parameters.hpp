...
static_assert(alignof(XpBoostInfoText_C_SetScrollWidget) == 0x000008, "Wrong alignment on XpBoostInfoText_C_SetScrollWidget");
static_assert(sizeof(XpBoostInfoText_C_SetScrollWidget) == 0x000008, "Wrong size on XpBoostInfoText_C_SetScrollWidget");
static_assert(offsetof(XpBoostInfoText_C_SetScrollWidget, CallFunc_GetUINavigationManager_ReturnValue) == 0x000000, "Member 'XpBoostInfoText_C_SetScrollWidget::CallFunc_GetUINavigationManager_ReturnValue' has a wrong offset!");
