...
// Function Results_BadgeLootBar.Results_BadgeLootBar_C.WidgetAnimationEvt_Anim_PostLevelUpIntro_K2Node_WidgetAnimationEvent_2
// (BlueprintEvent)

void UResults_BadgeLootBar_C::WidgetAnimationEvt_Anim_PostLevelUpIntro_K2Node_WidgetAnimationEvent_2()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Results_BadgeLootBar_C", "WidgetAnimationEvt_Anim_PostLevelUpIntro_K2Node_WidgetAnimationEvent_2");

	UObject::ProcessEvent(Func, nullptr);
}


// Function Results_BadgeLootBar.Results_BadgeLootBar_C.WidgetAnimationEvt_Anim_LevelUp_K2Node_WidgetAnimationEvent_1
// (BlueprintEvent)

void UResults_BadgeLootBar_C::WidgetAnimationEvt_Anim_LevelUp_K2Node_WidgetAnimationEvent_1()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Results_BadgeLootBar_C", "WidgetAnimationEvt_Anim_LevelUp_K2Node_WidgetAnimationEvent_1");

	UObject::ProcessEvent(Func, nullptr);
}


// Function Results_BadgeLootBar.Results_BadgeLootBar_C.WidgetAnimationEvt_Anim_Intro_K2Node_WidgetAnimationEvent_0
// (BlueprintEvent)

void UResults_BadgeLootBar_C::WidgetAnimationEvt_Anim_Intro_K2Node_WidgetAnimationEvent_0()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Results_BadgeLootBar_C", "WidgetAnimationEvt_Anim_Intro_K2Node_WidgetAnimationEvent_0");
