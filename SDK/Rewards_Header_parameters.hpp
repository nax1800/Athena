...
static_assert(offsetof(Rewards_Header_C_FadeInSubHeader, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000018, "Member 'Rewards_Header_C_FadeInSubHeader::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
