...
// Function AnimNotify_ActivateDeathPhysics.AnimNotify_ActivateDeathPhysics_C.Received_Notify
// 0x0068 (0x0068 - 0x0000)
struct AnimNotify_ActivateDeathPhysics_C_Received_Notify final
{
public:
	...
	TScriptInterface<class IBPI_Juno_AnimNotify_C> K2Node_DynamicCast_AsBPI_Juno_Anim_Notify;         // 0x0050(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0060(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(AnimNotify_ActivateDeathPhysics_C_Received_Notify) == 0x000008, "Wrong alignment on AnimNotify_ActivateDeathPhysics_C_Received_Notify");
static_assert(sizeof(AnimNotify_ActivateDeathPhysics_C_Received_Notify) == 0x000068, "Wrong size on AnimNotify_ActivateDeathPhysics_C_Received_Notify");
