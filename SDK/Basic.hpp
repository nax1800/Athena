...
namespace Offsets
{
	constexpr int32 GObjects          = 0x1277EEB0;
	constexpr int32 AppendString      = 0x013E3E40;
	constexpr int32 GNames            = 0x1296BD80;
	constexpr int32 GWorld            = 0x127A6BD8;
	constexpr int32 ProcessEvent      = 0x014231E4;
...
public:
	...
	static_assert(false, "FName::ToString causes memory-leak. Read comment above!");                 // 0x0000(0x0004)(Free your allocation with FMemory::Free!)
