...
static_assert(alignof(UTextStyleMinusHeaderMinusS_C) == 0x000010, "Wrong alignment on UTextStyleMinusHeaderMinusS_C");
static_assert(sizeof(UTextStyleMinusHeaderMinusS_C) == 0x0001A0, "Wrong size on UTextStyleMinusHeaderMinusS_C");
