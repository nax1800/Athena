...
static_assert(sizeof(UChangeSubgameButton_C) == 0x000258, "Wrong size on UChangeSubgameButton_C");
static_assert(offsetof(UChangeSubgameButton_C, UberGraphFrame) == 0x000230, "Member 'UChangeSubgameButton_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UChangeSubgameButton_C, ChangeSubgame) == 0x000238, "Member 'UChangeSubgameButton_C::ChangeSubgame' has a wrong offset!");
static_assert(offsetof(UChangeSubgameButton_C, SizeBoxContainer) == 0x000240, "Member 'UChangeSubgameButton_C::SizeBoxContainer' has a wrong offset!");
static_assert(offsetof(UChangeSubgameButton_C, OnClicked) == 0x000248, "Member 'UChangeSubgameButton_C::OnClicked' has a wrong offset!");
