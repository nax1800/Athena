...
static_assert(sizeof(ProgressiveItemStateTitle_C_BP_OnSetHeaderInfo) == 0x000020, "Wrong size on ProgressiveItemStateTitle_C_BP_OnSetHeaderInfo");
...
static_assert(sizeof(ProgressiveItemStateTitle_C_ExecuteUbergraph_ProgressiveItemStateTitle) == 0x000028, "Wrong size on ProgressiveItemStateTitle_C_ExecuteUbergraph_ProgressiveItemStateTitle");
