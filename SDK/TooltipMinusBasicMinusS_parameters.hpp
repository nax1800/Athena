...
static_assert(sizeof(TooltipMinusBasicMinusS_C_Get_Body_Text) == 0x000010, "Wrong size on TooltipMinusBasicMinusS_C_Get_Body_Text");
...
static_assert(sizeof(TooltipMinusBasicMinusS_C_Get_Header_Text) == 0x000010, "Wrong size on TooltipMinusBasicMinusS_C_Get_Header_Text");
