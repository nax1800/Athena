...
public:
	...
	class UUMGSequencePlayer*                     CallFunc_PlayAnimationAtTime_ReturnValue;          // 0x0130(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UUMGSequencePlayer*                     CallFunc_PlayAnimationAtTime_ReturnValue1;         // 0x0138(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UUMGSequencePlayer*                     CallFunc_PlayAnimationAtTime_ReturnValue2;         // 0x0150(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(SquadSlotItemPicker_C_ExecuteUbergraph_SquadSlotItemPicker, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000130, "Member 'SquadSlotItemPicker_C_ExecuteUbergraph_SquadSlotItemPicker::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
static_assert(offsetof(SquadSlotItemPicker_C_ExecuteUbergraph_SquadSlotItemPicker, CallFunc_PlayAnimationAtTime_ReturnValue1) == 0x000138, "Member 'SquadSlotItemPicker_C_ExecuteUbergraph_SquadSlotItemPicker::CallFunc_PlayAnimationAtTime_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(SquadSlotItemPicker_C_ExecuteUbergraph_SquadSlotItemPicker, CallFunc_PlayAnimationAtTime_ReturnValue2) == 0x000150, "Member 'SquadSlotItemPicker_C_ExecuteUbergraph_SquadSlotItemPicker::CallFunc_PlayAnimationAtTime_ReturnValue2' has a wrong offset!");
