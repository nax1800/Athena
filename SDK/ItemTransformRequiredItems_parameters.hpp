...
static_assert(offsetof(ItemTransformRequiredItems_C_UpdateItems, Temp_int_Variable2) == 0x0000D0, "Member 'ItemTransformRequiredItems_C_UpdateItems::Temp_int_Variable2' has a wrong offset!");
...
static_assert(offsetof(ItemTransformRequiredItems_C_UpdateItems, Temp_int_Variable3) == 0x0000D8, "Member 'ItemTransformRequiredItems_C_UpdateItems::Temp_int_Variable3' has a wrong offset!");
...
static_assert(offsetof(ItemTransformRequiredItems_C_UpdateItems, Temp_bool_Variable2) == 0x000108, "Member 'ItemTransformRequiredItems_C_UpdateItems::Temp_bool_Variable2' has a wrong offset!");
static_assert(offsetof(ItemTransformRequiredItems_C_UpdateItems, K2Node_Select2_Default) == 0x00010C, "Member 'ItemTransformRequiredItems_C_UpdateItems::K2Node_Select2_Default' has a wrong offset!");
...
static_assert(offsetof(ItemTransformRequiredItems_C_UpdateItems, Temp_bool_Variable3) == 0x000112, "Member 'ItemTransformRequiredItems_C_UpdateItems::Temp_bool_Variable3' has a wrong offset!");
static_assert(offsetof(ItemTransformRequiredItems_C_UpdateItems, K2Node_Select3_Default) == 0x000113, "Member 'ItemTransformRequiredItems_C_UpdateItems::K2Node_Select3_Default' has a wrong offset!");
