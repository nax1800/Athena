...
static_assert(sizeof(AthenaMatchmakingModeButton_C_ExecuteUbergraph_AthenaMatchmakingModeButton) == 0x000250, "Wrong size on AthenaMatchmakingModeButton_C_ExecuteUbergraph_AthenaMatchmakingModeButton");
...
static_assert(sizeof(AthenaMatchmakingModeButton_C_SetTabLabelInfo) == 0x000100, "Wrong size on AthenaMatchmakingModeButton_C_SetTabLabelInfo");
