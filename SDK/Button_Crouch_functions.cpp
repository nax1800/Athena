...
// bool                                    ShouldHide_0                                           (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UButton_Crouch_C::ShouldHide(const struct FFortHUDState& Current_Hud_State, bool* ShouldHide_0) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Button_Crouch_C", "ShouldHide");

	Params::Button_Crouch_C_ShouldHide Parms{};

	Parms.Current_Hud_State = std::move(Current_Hud_State);

	UObject::ProcessEvent(Func, &Parms);

	if (ShouldHide_0 != nullptr)
		*ShouldHide_0 = Parms.ShouldHide_0;
}
