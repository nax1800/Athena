...
{
public:
	class UFortMobileImage*                       SpeakerIcon;                                       // 0x0390(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UFortVoiceChannelSpeakerContainer_C) == 0x0003A0, "Wrong size on UFortVoiceChannelSpeakerContainer_C");
