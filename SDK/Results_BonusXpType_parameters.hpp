...
static_assert(sizeof(Results_BonusXpType_C_ExecuteUbergraph_Results_BonusXpType) == 0x000020, "Wrong size on Results_BonusXpType_C_ExecuteUbergraph_Results_BonusXpType");
...
static_assert(offsetof(Results_BonusXpType_C_ExecuteUbergraph_Results_BonusXpType, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000008, "Member 'Results_BonusXpType_C_ExecuteUbergraph_Results_BonusXpType::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_BonusXpType_C_ExecuteUbergraph_Results_BonusXpType, CallFunc_GetDynamicMaterial_ReturnValue) == 0x000010, "Member 'Results_BonusXpType_C_ExecuteUbergraph_Results_BonusXpType::CallFunc_GetDynamicMaterial_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_BonusXpType_C_ExecuteUbergraph_Results_BonusXpType, CallFunc_GetDynamicMaterial_ReturnValue1) == 0x000018, "Member 'Results_BonusXpType_C_ExecuteUbergraph_Results_BonusXpType::CallFunc_GetDynamicMaterial_ReturnValue1' has a wrong offset!");
