...
static_assert(offsetof(QuestTrackerMainQuestList_C_GetQuestsToDisplay, CallFunc_IsValid_ReturnValue2) == 0x000040, "Member 'QuestTrackerMainQuestList_C_GetQuestsToDisplay::CallFunc_IsValid_ReturnValue2' has a wrong offset!");
