...
static_assert(sizeof(AFMInWorldKnobActorBase) == 0x000430, "Wrong size on AFMInWorldKnobActorBase");
...
static_assert(sizeof(UPlaylistUserOptionFMOutgoingCableConnection) == 0x0001E8, "Wrong size on UPlaylistUserOptionFMOutgoingCableConnection");
