...
static_assert(sizeof(UButton_Mode_C) == 0x0003D8, "Wrong size on UButton_Mode_C");
static_assert(offsetof(UButton_Mode_C, UberGraphFrame_Button_Mode_C) == 0x0003D0, "Member 'UButton_Mode_C::UberGraphFrame_Button_Mode_C' has a wrong offset!");
