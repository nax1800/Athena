...
static_assert(alignof(IDelMarValidatorInterface) == 0x000008, "Wrong alignment on IDelMarValidatorInterface");
static_assert(sizeof(IDelMarValidatorInterface) == 0x000028, "Wrong size on IDelMarValidatorInterface");
...
static_assert(alignof(UDelMarWorldValidator_Task) == 0x000008, "Wrong alignment on UDelMarWorldValidator_Task");
static_assert(sizeof(UDelMarWorldValidator_Task) == 0x000038, "Wrong size on UDelMarWorldValidator_Task");
