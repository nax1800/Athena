...
static_assert(sizeof(AGCN_Loop_Cube_AoE_C) == 0x0008B8, "Wrong size on AGCN_Loop_Cube_AoE_C");
static_assert(offsetof(AGCN_Loop_Cube_AoE_C, UberGraphFrame) == 0x000898, "Member 'AGCN_Loop_Cube_AoE_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_Cube_AoE_C, TargetPlayer) == 0x0008A0, "Member 'AGCN_Loop_Cube_AoE_C::TargetPlayer' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_Cube_AoE_C, TargetDelta) == 0x0008A8, "Member 'AGCN_Loop_Cube_AoE_C::TargetDelta' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_Cube_AoE_C, InterpDelta) == 0x0008AC, "Member 'AGCN_Loop_Cube_AoE_C::InterpDelta' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_Cube_AoE_C, LoopingAudio) == 0x0008B0, "Member 'AGCN_Loop_Cube_AoE_C::LoopingAudio' has a wrong offset!");
