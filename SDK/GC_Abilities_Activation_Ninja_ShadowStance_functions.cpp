...
// Parameters:
// class APlayerPawn_Ninja_C*              Ninja_Pawn                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AGC_Abilities_Activation_Ninja_ShadowStance_C::Save_Material(class APlayerPawn_Ninja_C* Ninja_Pawn)
{
	static class UFunction* Func = nullptr;
...
void AGC_Abilities_Activation_Ninja_ShadowStance_C::Override_Material_to_Dissolve_Material(class APlayerPawn_Ninja_C* Ninja_Pawn)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class APlayerPawn_Ninja_C*              NinjaPawn                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AGC_Abilities_Activation_Ninja_ShadowStance_C::Create_Duplicate_Mesh(class APlayerPawn_Ninja_C* NinjaPawn)
{
	static class UFunction* Func = nullptr;
...
void AGC_Abilities_Activation_Ninja_ShadowStance_C::Restore_OG_Materials(class APlayerPawn_Ninja_C* Ninja_Pawn)
{
	static class UFunction* Func = nullptr;
