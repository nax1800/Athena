...
static_assert(sizeof(ABGA_Athena_Balloons_C) == 0x000720, "Wrong size on ABGA_Athena_Balloons_C");
static_assert(offsetof(ABGA_Athena_Balloons_C, UberGraphFrame) == 0x0006D8, "Member 'ABGA_Athena_Balloons_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABGA_Athena_Balloons_C, P_Balloon_Pop) == 0x0006E0, "Member 'ABGA_Athena_Balloons_C::P_Balloon_Pop' has a wrong offset!");
static_assert(offsetof(ABGA_Athena_Balloons_C, Balloon) == 0x0006E8, "Member 'ABGA_Athena_Balloons_C::Balloon' has a wrong offset!");
static_assert(offsetof(ABGA_Athena_Balloons_C, Scene) == 0x0006F0, "Member 'ABGA_Athena_Balloons_C::Scene' has a wrong offset!");
static_assert(offsetof(ABGA_Athena_Balloons_C, ProjectileMovement) == 0x0006F8, "Member 'ABGA_Athena_Balloons_C::ProjectileMovement' has a wrong offset!");
static_assert(offsetof(ABGA_Athena_Balloons_C, BalloonMID) == 0x000700, "Member 'ABGA_Athena_Balloons_C::BalloonMID' has a wrong offset!");
static_assert(offsetof(ABGA_Athena_Balloons_C, Balloon_Color_Choices) == 0x000708, "Member 'ABGA_Athena_Balloons_C::Balloon_Color_Choices' has a wrong offset!");
static_assert(offsetof(ABGA_Athena_Balloons_C, Balloon_Color_Selection) == 0x000718, "Member 'ABGA_Athena_Balloons_C::Balloon_Color_Selection' has a wrong offset!");
