...
static_assert(sizeof(CrewPurchaseScreen_C_BeginProgress) == 0x000010, "Wrong size on CrewPurchaseScreen_C_BeginProgress");
...
static_assert(sizeof(CrewPurchaseScreen_C_BlockScreenContent) == 0x000018, "Wrong size on CrewPurchaseScreen_C_BlockScreenContent");
...
static_assert(sizeof(CrewPurchaseScreen_C_ContentBlocked) == 0x000020, "Wrong size on CrewPurchaseScreen_C_ContentBlocked");
...
static_assert(sizeof(CrewPurchaseScreen_C_OnSetNavButtonNotificationText) == 0x000010, "Wrong size on CrewPurchaseScreen_C_OnSetNavButtonNotificationText");
...
static_assert(sizeof(CrewPurchaseScreen_C_OnSetPaymentLegalText) == 0x000010, "Wrong size on CrewPurchaseScreen_C_OnSetPaymentLegalText");
...
static_assert(sizeof(CrewPurchaseScreen_C_OnUserInformationTextsUpdated) == 0x000028, "Wrong size on CrewPurchaseScreen_C_OnUserInformationTextsUpdated");
...
static_assert(sizeof(CrewPurchaseScreen_C_Set_Up_Error_Info_Flags) == 0x000028, "Wrong size on CrewPurchaseScreen_C_Set_Up_Error_Info_Flags");
