...
static_assert(sizeof(AthenaConsumablesSharedFunctionLibrary_C_IsOverlappingDeployableBlockVolume) == 0x000280, "Wrong size on AthenaConsumablesSharedFunctionLibrary_C_IsOverlappingDeployableBlockVolume");
