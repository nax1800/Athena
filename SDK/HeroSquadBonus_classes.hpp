...
static_assert(sizeof(UHeroSquadBonus_C) == 0x000400, "Wrong size on UHeroSquadBonus_C");
static_assert(offsetof(UHeroSquadBonus_C, UberGraphFrame) == 0x0002D8, "Member 'UHeroSquadBonus_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UHeroSquadBonus_C, BonusPerkDescription) == 0x0002E0, "Member 'UHeroSquadBonus_C::BonusPerkDescription' has a wrong offset!");
static_assert(offsetof(UHeroSquadBonus_C, BonusPerkIcon) == 0x0002E8, "Member 'UHeroSquadBonus_C::BonusPerkIcon' has a wrong offset!");
static_assert(offsetof(UHeroSquadBonus_C, BonusPerkTitle) == 0x0002F0, "Member 'UHeroSquadBonus_C::BonusPerkTitle' has a wrong offset!");
static_assert(offsetof(UHeroSquadBonus_C, CommonBorderBackground) == 0x0002F8, "Member 'UHeroSquadBonus_C::CommonBorderBackground' has a wrong offset!");
static_assert(offsetof(UHeroSquadBonus_C, ImageLock) == 0x000300, "Member 'UHeroSquadBonus_C::ImageLock' has a wrong offset!");
static_assert(offsetof(UHeroSquadBonus_C, ImageSquadBonusType) == 0x000308, "Member 'UHeroSquadBonus_C::ImageSquadBonusType' has a wrong offset!");
static_assert(offsetof(UHeroSquadBonus_C, PerkIconSlotSizeBox) == 0x000310, "Member 'UHeroSquadBonus_C::PerkIconSlotSizeBox' has a wrong offset!");
static_assert(offsetof(UHeroSquadBonus_C, StatFocus) == 0x000318, "Member 'UHeroSquadBonus_C::StatFocus' has a wrong offset!");
...
static_assert(offsetof(UHeroSquadBonus_C, CachedTooltipDescription) == 0x0003E8, "Member 'UHeroSquadBonus_C::CachedTooltipDescription' has a wrong offset!");
