...
static_assert(offsetof(XpReasonFeedItem_C_PlayPresentEffect, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000008, "Member 'XpReasonFeedItem_C_PlayPresentEffect::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
