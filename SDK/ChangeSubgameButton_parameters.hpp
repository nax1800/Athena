...
public:
	...
	int32                                         CallFunc_GetNumPlayersInLocalParty_ReturnValue;    // 0x0038(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	EFortDialogResult                             K2Node_CustomEvent_Result;                         // 0x0060(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_61[0x7];                                       // 0x0061(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   K2Node_CustomEvent_ResultName;                     // 0x0068(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(EFortDialogResult Result, class FName ResultName)> K2Node_CreateDelegate_OutputDelegate;              // 0x0128(0x0010)(ZeroConstructor, NoDestructor)
};
...
static_assert(offsetof(ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton, CallFunc_GetContext_ReturnValue2) == 0x000030, "Member 'ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton::CallFunc_GetContext_ReturnValue2' has a wrong offset!");
static_assert(offsetof(ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton, CallFunc_GetNumPlayersInLocalParty_ReturnValue) == 0x000038, "Member 'ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton::CallFunc_GetNumPlayersInLocalParty_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton, CallFunc_Greater_IntInt_ReturnValue) == 0x00003C, "Member 'ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton, K2Node_ComponentBoundEvent_Button) == 0x000040, "Member 'ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton::K2Node_ComponentBoundEvent_Button' has a wrong offset!");
static_assert(offsetof(ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton, CallFunc_MakeLiteralText_ReturnValue) == 0x000048, "Member 'ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton::CallFunc_MakeLiteralText_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton, K2Node_CustomEvent_Result) == 0x000060, "Member 'ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton::K2Node_CustomEvent_Result' has a wrong offset!");
static_assert(offsetof(ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton, K2Node_CustomEvent_ResultName) == 0x000068, "Member 'ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton::K2Node_CustomEvent_ResultName' has a wrong offset!");
static_assert(offsetof(ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton, CallFunc_ShowSimpleConfirmationDialog_CustomInput_ReturnValue) == 0x000070, "Member 'ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton::CallFunc_ShowSimpleConfirmationDialog_CustomInput_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton, CallFunc_IsValid_ReturnValue) == 0x000078, "Member 'ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton, K2Node_Event_MyGeometry) == 0x00007C, "Member 'ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton::K2Node_Event_MyGeometry' has a wrong offset!");
static_assert(offsetof(ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton, K2Node_Event_MouseEvent) == 0x0000B8, "Member 'ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton::K2Node_Event_MouseEvent' has a wrong offset!");
static_assert(offsetof(ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton, K2Node_CreateDelegate_OutputDelegate) == 0x000128, "Member 'ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
