...
static_assert(sizeof(UScoutDroneHUD) == 0x0003E8, "Wrong size on UScoutDroneHUD");
...
static_assert(sizeof(UScoutDroneTetherIndicator) == 0x0002E8, "Wrong size on UScoutDroneTetherIndicator");
