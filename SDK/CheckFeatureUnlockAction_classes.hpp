...
static_assert(sizeof(ACheckFeatureUnlockAction_C) == 0x000398, "Wrong size on ACheckFeatureUnlockAction_C");
static_assert(offsetof(ACheckFeatureUnlockAction_C, UberGraphFrame) == 0x000388, "Member 'ACheckFeatureUnlockAction_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ACheckFeatureUnlockAction_C, DefaultSceneRoot) == 0x000390, "Member 'ACheckFeatureUnlockAction_C::DefaultSceneRoot' has a wrong offset!");
