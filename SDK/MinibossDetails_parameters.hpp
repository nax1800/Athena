...
struct MinibossDetails_C_Intro final
{
public:
...
static_assert(sizeof(MinibossDetails_C_Intro) == 0x000030, "Wrong size on MinibossDetails_C_Intro");
...
static_assert(offsetof(MinibossDetails_C_Intro, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000020, "Member 'MinibossDetails_C_Intro::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
static_assert(offsetof(MinibossDetails_C_Intro, CallFunc_PlayAnimationAtTime_ReturnValue1) == 0x000028, "Member 'MinibossDetails_C_Intro::CallFunc_PlayAnimationAtTime_ReturnValue1' has a wrong offset!");

// Function MinibossDetails.MinibossDetails_C.Outro
// 0x0030 (0x0030 - 0x0000)
struct MinibossDetails_C_Outro final
{
public:
	bool                                          CallFunc_IsAnimationPlaying_ReturnValue;           // 0x0000(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(MinibossDetails_C_Outro) == 0x000030, "Wrong size on MinibossDetails_C_Outro");
...
static_assert(offsetof(MinibossDetails_C_Outro, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000020, "Member 'MinibossDetails_C_Outro::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
static_assert(offsetof(MinibossDetails_C_Outro, CallFunc_PlayAnimationAtTime_ReturnValue1) == 0x000028, "Member 'MinibossDetails_C_Outro::CallFunc_PlayAnimationAtTime_ReturnValue1' has a wrong offset!");

// Function MinibossDetails.MinibossDetails_C.Kill
// 0x0030 (0x0030 - 0x0000)
struct MinibossDetails_C_Kill final
{
public:
	bool                                          CallFunc_IsAnimationPlaying_ReturnValue;           // 0x0000(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsAnimationPlaying_ReturnValue1;          // 0x0001(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(MinibossDetails_C_Kill) == 0x000030, "Wrong size on MinibossDetails_C_Kill");
...
static_assert(offsetof(MinibossDetails_C_Kill, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000020, "Member 'MinibossDetails_C_Kill::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
static_assert(offsetof(MinibossDetails_C_Kill, CallFunc_PlayAnimationAtTime_ReturnValue1) == 0x000028, "Member 'MinibossDetails_C_Kill::CallFunc_PlayAnimationAtTime_ReturnValue1' has a wrong offset!");
