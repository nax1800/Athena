...
static_assert(offsetof(UGCN_RiftSpawnerChargeUp_C, ConcurrencySettings) == 0x0001A8, "Member 'UGCN_RiftSpawnerChargeUp_C::ConcurrencySettings' has a wrong offset!");
