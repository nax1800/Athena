...
static_assert(offsetof(GCNL_Enemy_Frozen_C_OnActive, CallFunc_Array_Get_Item) == 0x000248, "Member 'GCNL_Enemy_Frozen_C_OnActive::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(GCNL_Enemy_Frozen_C_OnActive, CallFunc_MakeRotator_ReturnValue) == 0x000250, "Member 'GCNL_Enemy_Frozen_C_OnActive::CallFunc_MakeRotator_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCNL_Enemy_Frozen_C_OnActive, CallFunc_Conv_NameToString_ReturnValue) == 0x000260, "Member 'GCNL_Enemy_Frozen_C_OnActive::CallFunc_Conv_NameToString_ReturnValue' has a wrong offset!");
