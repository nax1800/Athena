...
static_assert(alignof(UButtonStyleMinusSkew_Error_C) == 0x000010, "Wrong alignment on UButtonStyleMinusSkew_Error_C");
static_assert(sizeof(UButtonStyleMinusSkew_Error_C) == 0x000730, "Wrong size on UButtonStyleMinusSkew_Error_C");
