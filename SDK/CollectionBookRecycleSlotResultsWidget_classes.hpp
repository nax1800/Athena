...
static_assert(sizeof(UCollectionBookRecycleSlotResultsWidget_C) == 0x000258, "Wrong size on UCollectionBookRecycleSlotResultsWidget_C");
static_assert(offsetof(UCollectionBookRecycleSlotResultsWidget_C, DisplayNameWidget) == 0x000248, "Member 'UCollectionBookRecycleSlotResultsWidget_C::DisplayNameWidget' has a wrong offset!");
static_assert(offsetof(UCollectionBookRecycleSlotResultsWidget_C, Image_2) == 0x000250, "Member 'UCollectionBookRecycleSlotResultsWidget_C::Image_2' has a wrong offset!");
