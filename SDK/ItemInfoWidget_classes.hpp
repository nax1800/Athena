...
static_assert(sizeof(UItemInfoWidget_C) == 0x000250, "Wrong size on UItemInfoWidget_C");
static_assert(offsetof(UItemInfoWidget_C, UberGraphFrame) == 0x000210, "Member 'UItemInfoWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UItemInfoWidget_C, MainViewItemInfoOverlay) == 0x000218, "Member 'UItemInfoWidget_C::MainViewItemInfoOverlay' has a wrong offset!");
static_assert(offsetof(UItemInfoWidget_C, MainViewItemInfoVB) == 0x000220, "Member 'UItemInfoWidget_C::MainViewItemInfoVB' has a wrong offset!");
static_assert(offsetof(UItemInfoWidget_C, RarityGlow) == 0x000228, "Member 'UItemInfoWidget_C::RarityGlow' has a wrong offset!");
static_assert(offsetof(UItemInfoWidget_C, Rule) == 0x000230, "Member 'UItemInfoWidget_C::Rule' has a wrong offset!");
static_assert(offsetof(UItemInfoWidget_C, Text_Desc) == 0x000238, "Member 'UItemInfoWidget_C::Text_Desc' has a wrong offset!");
static_assert(offsetof(UItemInfoWidget_C, Text_ItemType) == 0x000240, "Member 'UItemInfoWidget_C::Text_ItemType' has a wrong offset!");
static_assert(offsetof(UItemInfoWidget_C, Text_Name) == 0x000248, "Member 'UItemInfoWidget_C::Text_Name' has a wrong offset!");
