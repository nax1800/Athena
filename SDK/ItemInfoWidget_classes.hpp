...
public:
	...
	class UImage*                                 RarityGlow;                                        // 0x0318(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UItemInfoWidget_C) == 0x000320, "Wrong size on UItemInfoWidget_C");
