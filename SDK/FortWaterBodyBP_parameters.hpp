...
static_assert(sizeof(FortWaterBodyBP_C_ExecuteUbergraph_FortWaterBodyBP) == 0x000288, "Wrong size on FortWaterBodyBP_C_ExecuteUbergraph_FortWaterBodyBP");
...
static_assert(sizeof(FortWaterBodyBP_C_OnReceivedBulletImpact) == 0x0000F0, "Wrong size on FortWaterBodyBP_C_OnReceivedBulletImpact");
