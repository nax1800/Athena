...
static_assert(offsetof(UResults_PlayerScoreRow_C, UberGraphFrame) == 0x000230, "Member 'UResults_PlayerScoreRow_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UResults_PlayerScoreRow_C, BasicGradientFill) == 0x000238, "Member 'UResults_PlayerScoreRow_C::BasicGradientFill' has a wrong offset!");
static_assert(offsetof(UResults_PlayerScoreRow_C, Image_Platform) == 0x000240, "Member 'UResults_PlayerScoreRow_C::Image_Platform' has a wrong offset!");
