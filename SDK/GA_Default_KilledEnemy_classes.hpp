...
static_assert(sizeof(UGA_Default_KilledEnemy_C) == 0x000900, "Wrong size on UGA_Default_KilledEnemy_C");
static_assert(offsetof(UGA_Default_KilledEnemy_C, UberGraphFrame) == 0x0008F8, "Member 'UGA_Default_KilledEnemy_C::UberGraphFrame' has a wrong offset!");
