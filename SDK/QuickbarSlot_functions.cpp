...
// Function QuickbarSlot.QuickbarSlot_C.OnRefreshItem
// (Event, Public, BlueprintCallable, BlueprintEvent)

void UQuickbarSlot_C::OnRefreshItem()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("QuickbarSlot_C", "OnRefreshItem");
...
void UQuickbarSlot_C::TryRefreshCooldowns()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("QuickbarSlot_C", "TryRefreshCooldowns");
