...
static_assert(offsetof(PlayerRankEmblem_C_SetBannerSurroundLevel, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000008, "Member 'PlayerRankEmblem_C_SetBannerSurroundLevel::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
