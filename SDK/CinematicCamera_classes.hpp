...
static_assert(sizeof(UCineCameraComponent) == 0x000870, "Wrong size on UCineCameraComponent");
...
static_assert(offsetof(UCineCameraComponent, FocusPlaneVisualizationMesh) == 0x000808, "Member 'UCineCameraComponent::FocusPlaneVisualizationMesh' has a wrong offset!");
static_assert(offsetof(UCineCameraComponent, FocusPlaneVisualizationMaterial) == 0x000810, "Member 'UCineCameraComponent::FocusPlaneVisualizationMaterial' has a wrong offset!");
static_assert(offsetof(UCineCameraComponent, DebugFocusPlaneComponent) == 0x000818, "Member 'UCineCameraComponent::DebugFocusPlaneComponent' has a wrong offset!");
static_assert(offsetof(UCineCameraComponent, DebugFocusPlaneMID) == 0x000820, "Member 'UCineCameraComponent::DebugFocusPlaneMID' has a wrong offset!");
static_assert(offsetof(UCineCameraComponent, FilmbackPresets) == 0x000828, "Member 'UCineCameraComponent::FilmbackPresets' has a wrong offset!");
static_assert(offsetof(UCineCameraComponent, LensPresets) == 0x000838, "Member 'UCineCameraComponent::LensPresets' has a wrong offset!");
static_assert(offsetof(UCineCameraComponent, DefaultFilmbackPresetName) == 0x000848, "Member 'UCineCameraComponent::DefaultFilmbackPresetName' has a wrong offset!");
static_assert(offsetof(UCineCameraComponent, DefaultLensPresetName) == 0x000858, "Member 'UCineCameraComponent::DefaultLensPresetName' has a wrong offset!");
static_assert(offsetof(UCineCameraComponent, DefaultLensFocalLength) == 0x000868, "Member 'UCineCameraComponent::DefaultLensFocalLength' has a wrong offset!");
static_assert(offsetof(UCineCameraComponent, DefaultLensFStop) == 0x00086C, "Member 'UCineCameraComponent::DefaultLensFStop' has a wrong offset!");
