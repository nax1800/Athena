...
static_assert(sizeof(FExpeditionTabInfo) == 0x000110, "Wrong size on FExpeditionTabInfo");
...
static_assert(sizeof(FFortUISurvivorSquadStatMatch) == 0x0004B0, "Wrong size on FFortUISurvivorSquadStatMatch");
