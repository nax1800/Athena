...
static_assert(sizeof(BoostsRoot_C_ExecuteUbergraph_BoostsRoot) == 0x000070, "Wrong size on BoostsRoot_C_ExecuteUbergraph_BoostsRoot");
...
static_assert(offsetof(BoostsRoot_C_ExecuteUbergraph_BoostsRoot, K2Node_DynamicCast_AsIcon_Tab_Button) == 0x000018, "Member 'BoostsRoot_C_ExecuteUbergraph_BoostsRoot::K2Node_DynamicCast_AsIcon_Tab_Button' has a wrong offset!");
static_assert(offsetof(BoostsRoot_C_ExecuteUbergraph_BoostsRoot, K2Node_DynamicCast_bSuccess) == 0x000020, "Member 'BoostsRoot_C_ExecuteUbergraph_BoostsRoot::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BoostsRoot_C_ExecuteUbergraph_BoostsRoot, K2Node_CreateDelegate_OutputDelegate) == 0x000028, "Member 'BoostsRoot_C_ExecuteUbergraph_BoostsRoot::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(BoostsRoot_C_ExecuteUbergraph_BoostsRoot, CallFunc_GetUINavigationManager_ReturnValue) == 0x000038, "Member 'BoostsRoot_C_ExecuteUbergraph_BoostsRoot::CallFunc_GetUINavigationManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(BoostsRoot_C_ExecuteUbergraph_BoostsRoot, CallFunc_GetContext_ReturnValue) == 0x000040, "Member 'BoostsRoot_C_ExecuteUbergraph_BoostsRoot::CallFunc_GetContext_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BoostsRoot_C_ExecuteUbergraph_BoostsRoot, K2Node_DynamicCast_AsXp_Boosts) == 0x000058, "Member 'BoostsRoot_C_ExecuteUbergraph_BoostsRoot::K2Node_DynamicCast_AsXp_Boosts' has a wrong offset!");
...
static_assert(offsetof(BoostsRoot_C_ExecuteUbergraph_BoostsRoot, CallFunc_GetContext_ReturnValue1) == 0x000068, "Member 'BoostsRoot_C_ExecuteUbergraph_BoostsRoot::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
