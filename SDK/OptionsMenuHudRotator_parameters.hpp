...
static_assert(sizeof(OptionsMenuHudRotator_C_ExecuteUbergraph_OptionsMenuHudRotator) == 0x000160, "Wrong size on OptionsMenuHudRotator_C_ExecuteUbergraph_OptionsMenuHudRotator");
