...
static_assert(sizeof(UTabAudioOptions_C) == 0x000258, "Wrong size on UTabAudioOptions_C");
static_assert(offsetof(UTabAudioOptions_C, UberGraphFrame) == 0x000240, "Member 'UTabAudioOptions_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UTabAudioOptions_C, CommonTextBlock_0) == 0x000248, "Member 'UTabAudioOptions_C::CommonTextBlock_0' has a wrong offset!");
static_assert(offsetof(UTabAudioOptions_C, TooltipDisplayReference) == 0x000250, "Member 'UTabAudioOptions_C::TooltipDisplayReference' has a wrong offset!");
