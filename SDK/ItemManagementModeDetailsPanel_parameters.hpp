...
static_assert(alignof(ItemManagementModeDetailsPanel_C_SetScrollFocusOnMulchDetailsPanel) == 0x000008, "Wrong alignment on ItemManagementModeDetailsPanel_C_SetScrollFocusOnMulchDetailsPanel");
static_assert(sizeof(ItemManagementModeDetailsPanel_C_SetScrollFocusOnMulchDetailsPanel) == 0x000010, "Wrong size on ItemManagementModeDetailsPanel_C_SetScrollFocusOnMulchDetailsPanel");
static_assert(offsetof(ItemManagementModeDetailsPanel_C_SetScrollFocusOnMulchDetailsPanel, K2Node_DynamicCast_AsItem_Management_Mulch_Mode_Box) == 0x000000, "Member 'ItemManagementModeDetailsPanel_C_SetScrollFocusOnMulchDetailsPanel::K2Node_DynamicCast_AsItem_Management_Mulch_Mode_Box' has a wrong offset!");
static_assert(offsetof(ItemManagementModeDetailsPanel_C_SetScrollFocusOnMulchDetailsPanel, K2Node_DynamicCast_bSuccess) == 0x000008, "Member 'ItemManagementModeDetailsPanel_C_SetScrollFocusOnMulchDetailsPanel::K2Node_DynamicCast_bSuccess' has a wrong offset!");
