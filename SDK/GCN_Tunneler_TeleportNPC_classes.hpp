...
static_assert(sizeof(AGCN_Tunneler_TeleportNPC_C) == 0x000428, "Wrong size on AGCN_Tunneler_TeleportNPC_C");
static_assert(offsetof(AGCN_Tunneler_TeleportNPC_C, UberGraphFrame) == 0x000420, "Member 'AGCN_Tunneler_TeleportNPC_C::UberGraphFrame' has a wrong offset!");
