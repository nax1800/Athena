...
static_assert(sizeof(UAthenaGamePhaseWidget_C) == 0x000288, "Wrong size on UAthenaGamePhaseWidget_C");
static_assert(offsetof(UAthenaGamePhaseWidget_C, UberGraphFrame) == 0x000278, "Member 'UAthenaGamePhaseWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UAthenaGamePhaseWidget_C, Icon) == 0x000280, "Member 'UAthenaGamePhaseWidget_C::Icon' has a wrong offset!");
