...
static_assert(sizeof(CheckPlayerBanStatus_C_ShowBan) == 0x0000D8, "Wrong size on CheckPlayerBanStatus_C_ShowBan");
...
static_assert(offsetof(CheckPlayerBanStatus_C_ShowBan, K2Node_CreateDelegate_OutputDelegate) == 0x000048, "Member 'CheckPlayerBanStatus_C_ShowBan::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(CheckPlayerBanStatus_C_ShowBan, CallFunc_GetUIManagerWidget_ReturnValue) == 0x000058, "Member 'CheckPlayerBanStatus_C_ShowBan::CallFunc_GetUIManagerWidget_ReturnValue' has a wrong offset!");
static_assert(offsetof(CheckPlayerBanStatus_C_ShowBan, CallFunc_GetContext_ReturnValue) == 0x000060, "Member 'CheckPlayerBanStatus_C_ShowBan::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(CheckPlayerBanStatus_C_ShowBan, CallFunc_IsInZone_ReturnValue) == 0x000068, "Member 'CheckPlayerBanStatus_C_ShowBan::CallFunc_IsInZone_ReturnValue' has a wrong offset!");
static_assert(offsetof(CheckPlayerBanStatus_C_ShowBan, CallFunc_GetContext_ReturnValue1) == 0x000070, "Member 'CheckPlayerBanStatus_C_ShowBan::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
static_assert(offsetof(CheckPlayerBanStatus_C_ShowBan, CallFunc_GetBanInfo_ReturnValue) == 0x000078, "Member 'CheckPlayerBanStatus_C_ShowBan::CallFunc_GetBanInfo_ReturnValue' has a wrong offset!");
static_assert(offsetof(CheckPlayerBanStatus_C_ShowBan, CallFunc_GetContext_ReturnValue2) == 0x0000A8, "Member 'CheckPlayerBanStatus_C_ShowBan::CallFunc_GetContext_ReturnValue2' has a wrong offset!");
static_assert(offsetof(CheckPlayerBanStatus_C_ShowBan, CallFunc_IsUserCurrentlyBanned_ReturnValue) == 0x0000B0, "Member 'CheckPlayerBanStatus_C_ShowBan::CallFunc_IsUserCurrentlyBanned_ReturnValue' has a wrong offset!");
static_assert(offsetof(CheckPlayerBanStatus_C_ShowBan, CallFunc_GetUIManagerWidget_ReturnValue1) == 0x0000B8, "Member 'CheckPlayerBanStatus_C_ShowBan::CallFunc_GetUIManagerWidget_ReturnValue1' has a wrong offset!");
static_assert(offsetof(CheckPlayerBanStatus_C_ShowBan, CallFunc_IsInViewport_ReturnValue) == 0x0000C0, "Member 'CheckPlayerBanStatus_C_ShowBan::CallFunc_IsInViewport_ReturnValue' has a wrong offset!");
static_assert(offsetof(CheckPlayerBanStatus_C_ShowBan, CallFunc_Create_ReturnValue) == 0x0000C8, "Member 'CheckPlayerBanStatus_C_ShowBan::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(CheckPlayerBanStatus_C_ShowBan, CallFunc_BooleanOR_ReturnValue) == 0x0000D0, "Member 'CheckPlayerBanStatus_C_ShowBan::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
