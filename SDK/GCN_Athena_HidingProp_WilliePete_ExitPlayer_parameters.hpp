...
static_assert(sizeof(GCN_Athena_HidingProp_WilliePete_ExitPlayer_C_OnBurst) == 0x0002E8, "Wrong size on GCN_Athena_HidingProp_WilliePete_ExitPlayer_C_OnBurst");
