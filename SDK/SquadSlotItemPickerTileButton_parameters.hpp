...
static_assert(sizeof(SquadSlotItemPickerTileButton_C_ExecuteUbergraph_SquadSlotItemPickerTileButton) == 0x000030, "Wrong size on SquadSlotItemPickerTileButton_C_ExecuteUbergraph_SquadSlotItemPickerTileButton");
...
static_assert(offsetof(SquadSlotItemPickerTileButton_C_ExecuteUbergraph_SquadSlotItemPickerTileButton, CallFunc_IsNullItem_Is_Null_Item) == 0x000020, "Member 'SquadSlotItemPickerTileButton_C_ExecuteUbergraph_SquadSlotItemPickerTileButton::CallFunc_IsNullItem_Is_Null_Item' has a wrong offset!");
static_assert(offsetof(SquadSlotItemPickerTileButton_C_ExecuteUbergraph_SquadSlotItemPickerTileButton, CallFunc_NotEqual_NameName_ReturnValue) == 0x000021, "Member 'SquadSlotItemPickerTileButton_C_ExecuteUbergraph_SquadSlotItemPickerTileButton::CallFunc_NotEqual_NameName_ReturnValue' has a wrong offset!");
static_assert(offsetof(SquadSlotItemPickerTileButton_C_ExecuteUbergraph_SquadSlotItemPickerTileButton, Temp_bool_Variable) == 0x000022, "Member 'SquadSlotItemPickerTileButton_C_ExecuteUbergraph_SquadSlotItemPickerTileButton::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(SquadSlotItemPickerTileButton_C_ExecuteUbergraph_SquadSlotItemPickerTileButton, K2Node_Select_Default) == 0x000028, "Member 'SquadSlotItemPickerTileButton_C_ExecuteUbergraph_SquadSlotItemPickerTileButton::K2Node_Select_Default' has a wrong offset!");
