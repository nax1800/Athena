...
public:
	...
	class UCommonTextBlock*                       Callout;                                           // 0x0230(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UCalloutEntry_C) == 0x000238, "Wrong size on UCalloutEntry_C");
static_assert(offsetof(UCalloutEntry_C, Intro) == 0x000228, "Member 'UCalloutEntry_C::Intro' has a wrong offset!");
static_assert(offsetof(UCalloutEntry_C, Callout) == 0x000230, "Member 'UCalloutEntry_C::Callout' has a wrong offset!");
