...
{
public:
	struct FVector                                Param_HitLocation;                                 // 0x0000(0x000C)(BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(Trap_Floor_Turret_C_SpawnTracer, Param_HitLocation) == 0x000000, "Member 'Trap_Floor_Turret_C_SpawnTracer::Param_HitLocation' has a wrong offset!");
...
{
public:
	bool                                          Param_ShouldFire;                                  // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(Trap_Floor_Turret_C_ShouldFire, Param_ShouldFire) == 0x000000, "Member 'Trap_Floor_Turret_C_ShouldFire::Param_ShouldFire' has a wrong offset!");
...
static_assert(offsetof(Trap_Floor_Turret_C_SpawnImpactEffects, Param_HitLocation) == 0x000000, "Member 'Trap_Floor_Turret_C_SpawnImpactEffects::Param_HitLocation' has a wrong offset!");
