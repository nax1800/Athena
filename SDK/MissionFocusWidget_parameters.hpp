...
static_assert(sizeof(MissionFocusWidget_C_UpdateTimer) == 0x0000C0, "Wrong size on MissionFocusWidget_C_UpdateTimer");
...
static_assert(offsetof(MissionFocusWidget_C_UpdateTimer, CallFunc_IsValid_ReturnValue1) == 0x000080, "Member 'MissionFocusWidget_C_UpdateTimer::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateTimer, CallFunc_GetText_ReturnValue1) == 0x000088, "Member 'MissionFocusWidget_C_UpdateTimer::CallFunc_GetText_ReturnValue1' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateTimer, CallFunc_NotEqual_TextText_ReturnValue1) == 0x0000A0, "Member 'MissionFocusWidget_C_UpdateTimer::CallFunc_NotEqual_TextText_ReturnValue1' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateTimer, CallFunc_IsMissionTimerSet_ReturnValue) == 0x0000A1, "Member 'MissionFocusWidget_C_UpdateTimer::CallFunc_IsMissionTimerSet_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateTimer, CallFunc_IsTimerVisible_ReturnValue) == 0x0000A2, "Member 'MissionFocusWidget_C_UpdateTimer::CallFunc_IsTimerVisible_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateTimer, CallFunc_BooleanAND_ReturnValue) == 0x0000A3, "Member 'MissionFocusWidget_C_UpdateTimer::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateTimer, CallFunc_GetTimeText_ReturnValue) == 0x0000A8, "Member 'MissionFocusWidget_C_UpdateTimer::CallFunc_GetTimeText_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(MissionFocusWidget_C_HandleFocusedMission, CallFunc_IsValid_ReturnValue2) == 0x000031, "Member 'MissionFocusWidget_C_HandleFocusedMission::CallFunc_IsValid_ReturnValue2' has a wrong offset!");
