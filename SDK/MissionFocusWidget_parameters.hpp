...
public:
	...
	TDelegate<void(class AFortMission* FocusedMission)> K2Node_CreateDelegate_OutputDelegate;              // 0x0010(0x0010)(ZeroConstructor, NoDestructor)
...
static_assert(sizeof(MissionFocusWidget_C_ExecuteUbergraph_MissionFocusWidget) == 0x000038, "Wrong size on MissionFocusWidget_C_ExecuteUbergraph_MissionFocusWidget");
...
static_assert(offsetof(MissionFocusWidget_C_ExecuteUbergraph_MissionFocusWidget, CallFunc_GetContext_ReturnValue) == 0x000008, "Member 'MissionFocusWidget_C_ExecuteUbergraph_MissionFocusWidget::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_ExecuteUbergraph_MissionFocusWidget, K2Node_CreateDelegate_OutputDelegate) == 0x000010, "Member 'MissionFocusWidget_C_ExecuteUbergraph_MissionFocusWidget::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
...
static_assert(offsetof(MissionFocusWidget_C_ExecuteUbergraph_MissionFocusWidget, CallFunc_SlotAsVerticalBoxSlot_ReturnValue) == 0x000028, "Member 'MissionFocusWidget_C_ExecuteUbergraph_MissionFocusWidget::CallFunc_SlotAsVerticalBoxSlot_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_ExecuteUbergraph_MissionFocusWidget, CallFunc_SlotAsVerticalBoxSlot_ReturnValue1) == 0x000030, "Member 'MissionFocusWidget_C_ExecuteUbergraph_MissionFocusWidget::CallFunc_SlotAsVerticalBoxSlot_ReturnValue1' has a wrong offset!");
...
public:
	...
	class FText                                   CallFunc_GetTimerLabelText_ReturnValue;            // 0x0040(0x0018)()
	...
	float                                         CallFunc_GetCurrentFocusPercentage_ReturnValue;    // 0x007C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FText                                   CallFunc_GetCurrentFocusDisplayText_ReturnValue;   // 0x0080(0x0018)()
...
static_assert(offsetof(MissionFocusWidget_C_UpdateTimer, CallFunc_GetTimerLabelText_ReturnValue) == 0x000040, "Member 'MissionFocusWidget_C_UpdateTimer::CallFunc_GetTimerLabelText_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateTimer, CallFunc_NotEqual_FloatFloat_ReturnValue) == 0x000058, "Member 'MissionFocusWidget_C_UpdateTimer::CallFunc_NotEqual_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateTimer, CallFunc_BooleanOR_ReturnValue) == 0x000059, "Member 'MissionFocusWidget_C_UpdateTimer::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateTimer, CallFunc_BooleanOR_ReturnValue1) == 0x00005A, "Member 'MissionFocusWidget_C_UpdateTimer::CallFunc_BooleanOR_ReturnValue1' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateTimer, CallFunc_GetText_ReturnValue) == 0x000060, "Member 'MissionFocusWidget_C_UpdateTimer::CallFunc_GetText_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateTimer, CallFunc_NotEqual_TextText_ReturnValue) == 0x000078, "Member 'MissionFocusWidget_C_UpdateTimer::CallFunc_NotEqual_TextText_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateTimer, CallFunc_IsValid_ReturnValue) == 0x000079, "Member 'MissionFocusWidget_C_UpdateTimer::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateTimer, CallFunc_GetCurrentFocusPercentage_ReturnValue) == 0x00007C, "Member 'MissionFocusWidget_C_UpdateTimer::CallFunc_GetCurrentFocusPercentage_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateTimer, CallFunc_GetCurrentFocusDisplayText_ReturnValue) == 0x000080, "Member 'MissionFocusWidget_C_UpdateTimer::CallFunc_GetCurrentFocusDisplayText_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(MissionFocusWidget_C_HandleFocusedMission, CallFunc_IsValid_ReturnValue1) == 0x000009, "Member 'MissionFocusWidget_C_HandleFocusedMission::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(MissionFocusWidget_C_UpdateVisibility, Temp_byte_Variable2) == 0x000008, "Member 'MissionFocusWidget_C_UpdateVisibility::Temp_byte_Variable2' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateVisibility, Temp_byte_Variable3) == 0x000009, "Member 'MissionFocusWidget_C_UpdateVisibility::Temp_byte_Variable3' has a wrong offset!");
...
static_assert(offsetof(MissionFocusWidget_C_UpdateVisibility, Temp_byte_Variable4) == 0x00000B, "Member 'MissionFocusWidget_C_UpdateVisibility::Temp_byte_Variable4' has a wrong offset!");
...
static_assert(offsetof(MissionFocusWidget_C_UpdateVisibility, Temp_byte_Variable5) == 0x00000D, "Member 'MissionFocusWidget_C_UpdateVisibility::Temp_byte_Variable5' has a wrong offset!");
...
static_assert(offsetof(MissionFocusWidget_C_UpdateVisibility, Temp_bool_Variable2) == 0x000010, "Member 'MissionFocusWidget_C_UpdateVisibility::Temp_bool_Variable2' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateVisibility, K2Node_Select2_Default) == 0x000011, "Member 'MissionFocusWidget_C_UpdateVisibility::K2Node_Select2_Default' has a wrong offset!");
...
static_assert(alignof(MissionFocusWidget_C_UpdateAutoRefreshTimer) == 0x000008, "Wrong alignment on MissionFocusWidget_C_UpdateAutoRefreshTimer");
static_assert(sizeof(MissionFocusWidget_C_UpdateAutoRefreshTimer) == 0x000020, "Wrong size on MissionFocusWidget_C_UpdateAutoRefreshTimer");
static_assert(offsetof(MissionFocusWidget_C_UpdateAutoRefreshTimer, CallFunc_IsValid_ReturnValue) == 0x000000, "Member 'MissionFocusWidget_C_UpdateAutoRefreshTimer::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateAutoRefreshTimer, CallFunc_IsMissionTimerSet_ReturnValue) == 0x000001, "Member 'MissionFocusWidget_C_UpdateAutoRefreshTimer::CallFunc_IsMissionTimerSet_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateAutoRefreshTimer, CallFunc_IsTimerVisible_ReturnValue) == 0x000002, "Member 'MissionFocusWidget_C_UpdateAutoRefreshTimer::CallFunc_IsTimerVisible_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateAutoRefreshTimer, CallFunc_BooleanAND_ReturnValue) == 0x000003, "Member 'MissionFocusWidget_C_UpdateAutoRefreshTimer::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateAutoRefreshTimer, CallFunc_K2_IsTimerActiveHandle_ReturnValue) == 0x000004, "Member 'MissionFocusWidget_C_UpdateAutoRefreshTimer::CallFunc_K2_IsTimerActiveHandle_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateAutoRefreshTimer, K2Node_CreateDelegate_OutputDelegate) == 0x000008, "Member 'MissionFocusWidget_C_UpdateAutoRefreshTimer::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateAutoRefreshTimer, CallFunc_K2_SetTimerDelegate_ReturnValue) == 0x000018, "Member 'MissionFocusWidget_C_UpdateAutoRefreshTimer::CallFunc_K2_SetTimerDelegate_ReturnValue' has a wrong offset!");

// Function MissionFocusWidget.MissionFocusWidget_C.Update Countdown Music
// 0x0038 (0x0038 - 0x0000)
struct MissionFocusWidget_C_Update_Countdown_Music final
{
public:
	class AFortMusicManager*                      CallFunc_GetMusicManager_ReturnValue;              // 0x0000(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AMusicManager_C*                        K2Node_DynamicCast_AsMusic_Manager;                // 0x0008(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0010(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x0011(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_12[0x2];                                       // 0x0012(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CallFunc_GetMissionTimerTimeRemaining_ReturnValue; // 0x0014(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(MissionFocusWidget_C_Update_Countdown_Music) == 0x000008, "Wrong alignment on MissionFocusWidget_C_Update_Countdown_Music");
static_assert(sizeof(MissionFocusWidget_C_Update_Countdown_Music) == 0x000038, "Wrong size on MissionFocusWidget_C_Update_Countdown_Music");
static_assert(offsetof(MissionFocusWidget_C_Update_Countdown_Music, CallFunc_GetMusicManager_ReturnValue) == 0x000000, "Member 'MissionFocusWidget_C_Update_Countdown_Music::CallFunc_GetMusicManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_Update_Countdown_Music, K2Node_DynamicCast_AsMusic_Manager) == 0x000008, "Member 'MissionFocusWidget_C_Update_Countdown_Music::K2Node_DynamicCast_AsMusic_Manager' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_Update_Countdown_Music, K2Node_DynamicCast_bSuccess) == 0x000010, "Member 'MissionFocusWidget_C_Update_Countdown_Music::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_Update_Countdown_Music, CallFunc_IsValid_ReturnValue) == 0x000011, "Member 'MissionFocusWidget_C_Update_Countdown_Music::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_Update_Countdown_Music, CallFunc_GetMissionTimerTimeRemaining_ReturnValue) == 0x000014, "Member 'MissionFocusWidget_C_Update_Countdown_Music::CallFunc_GetMissionTimerTimeRemaining_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_Update_Countdown_Music, CallFunc_LessEqual_FloatFloat_ReturnValue) == 0x000018, "Member 'MissionFocusWidget_C_Update_Countdown_Music::CallFunc_LessEqual_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_Update_Countdown_Music, CallFunc_GetDisplayName_ReturnValue) == 0x000020, "Member 'MissionFocusWidget_C_Update_Countdown_Music::CallFunc_GetDisplayName_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_Update_Countdown_Music, CallFunc_EqualEqual_StrStr_ReturnValue) == 0x000030, "Member 'MissionFocusWidget_C_Update_Countdown_Music::CallFunc_EqualEqual_StrStr_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_Update_Countdown_Music, CallFunc_BooleanAND_ReturnValue) == 0x000031, "Member 'MissionFocusWidget_C_Update_Countdown_Music::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
