...
// Function B_Prj_Athena_TNT.B_Prj_Athena_TNT_C.Set Spline Point Locations
// (BlueprintCallable, BlueprintEvent)

void AB_Prj_Athena_TNT_C::Set_Spline_Point_Locations()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("B_Prj_Athena_TNT_C", "Set Spline Point Locations");
...
// Parameters:
// struct FRotator                         InRotation                                             (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor)
// struct FVector                          Normal                                                 (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FRotator                         OutRotation                                            (Parm, OutParm, IsPlainOldData, NoDestructor)
