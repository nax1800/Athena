...
static_assert(sizeof(UAdditionalEntriesIndicator_C) == 0x000238, "Wrong size on UAdditionalEntriesIndicator_C");
static_assert(offsetof(UAdditionalEntriesIndicator_C, Image_0) == 0x000230, "Member 'UAdditionalEntriesIndicator_C::Image_0' has a wrong offset!");
