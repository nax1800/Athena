...
{
public:
	class UImage*                                 ImageModifier;                                     // 0x0230(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UActiveModifierItemHUD_C) == 0x000238, "Wrong size on UActiveModifierItemHUD_C");
static_assert(offsetof(UActiveModifierItemHUD_C, ImageModifier) == 0x000230, "Member 'UActiveModifierItemHUD_C::ImageModifier' has a wrong offset!");
