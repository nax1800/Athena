...
static_assert(sizeof(AthenaWeaponModsWorkbenchWeaponDetails_OnWeaponEquipped) == 0x000018, "Wrong size on AthenaWeaponModsWorkbenchWeaponDetails_OnWeaponEquipped");
