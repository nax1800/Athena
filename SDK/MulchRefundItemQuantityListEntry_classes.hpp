...
static_assert(sizeof(UMulchRefundItemQuantityListEntry_C) == 0x000268, "Wrong size on UMulchRefundItemQuantityListEntry_C");
static_assert(offsetof(UMulchRefundItemQuantityListEntry_C, UberGraphFrame) == 0x000258, "Member 'UMulchRefundItemQuantityListEntry_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UMulchRefundItemQuantityListEntry_C, ItemCountRecycling) == 0x000260, "Member 'UMulchRefundItemQuantityListEntry_C::ItemCountRecycling' has a wrong offset!");
