...
static_assert(sizeof(UControllableRidableComponent) == 0x000728, "Wrong size on UControllableRidableComponent");
...
static_assert(sizeof(UFortCameraMode_Riding) == 0x001CF0, "Wrong size on UFortCameraMode_Riding");
