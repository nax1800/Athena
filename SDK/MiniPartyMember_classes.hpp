...
static_assert(sizeof(UMiniPartyMember_C) == 0x0004A8, "Wrong size on UMiniPartyMember_C");
...
static_assert(offsetof(UMiniPartyMember_C, UIManager) == 0x000498, "Member 'UMiniPartyMember_C::UIManager' has a wrong offset!");
static_assert(offsetof(UMiniPartyMember_C, PartyFinder) == 0x0004A0, "Member 'UMiniPartyMember_C::PartyFinder' has a wrong offset!");
