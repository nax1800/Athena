...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GA_Athena_Grenade_Rethrow_C;        // 0x0C40(0x0008)(Transient, DuplicateTransient)
	class AFortProjectileBase*                    Projectile;                                        // 0x0C48(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         TossDelay;                                         // 0x0C50(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(UGA_Athena_Grenade_Rethrow_C, UberGraphFrame_GA_Athena_Grenade_Rethrow_C) == 0x000C40, "Member 'UGA_Athena_Grenade_Rethrow_C::UberGraphFrame_GA_Athena_Grenade_Rethrow_C' has a wrong offset!");
static_assert(offsetof(UGA_Athena_Grenade_Rethrow_C, Projectile) == 0x000C48, "Member 'UGA_Athena_Grenade_Rethrow_C::Projectile' has a wrong offset!");
static_assert(offsetof(UGA_Athena_Grenade_Rethrow_C, TossDelay) == 0x000C50, "Member 'UGA_Athena_Grenade_Rethrow_C::TossDelay' has a wrong offset!");
