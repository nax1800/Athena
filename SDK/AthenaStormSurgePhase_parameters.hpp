...
static_assert(offsetof(AthenaStormSurgePhase_C_ExecuteUbergraph_AthenaStormSurgePhase, K2Node_CreateDelegate_OutputDelegate) == 0x000008, "Member 'AthenaStormSurgePhase_C_ExecuteUbergraph_AthenaStormSurgePhase::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
...
static_assert(offsetof(AthenaStormSurgePhase_C_Anim_Load, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000000, "Member 'AthenaStormSurgePhase_C_Anim_Load::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
