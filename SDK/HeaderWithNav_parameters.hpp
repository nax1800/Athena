...
static_assert(offsetof(HeaderWithNav_C_ExecuteUbergraph_HeaderWithNav, K2Node_ComponentBoundEvent_Button) == 0x000008, "Member 'HeaderWithNav_C_ExecuteUbergraph_HeaderWithNav::K2Node_ComponentBoundEvent_Button' has a wrong offset!");
static_assert(offsetof(HeaderWithNav_C_ExecuteUbergraph_HeaderWithNav, CallFunc_GetContext_ReturnValue) == 0x000010, "Member 'HeaderWithNav_C_ExecuteUbergraph_HeaderWithNav::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(HeaderWithNav_C_ExecuteUbergraph_HeaderWithNav, K2Node_CreateDelegate_OutputDelegate) == 0x000018, "Member 'HeaderWithNav_C_ExecuteUbergraph_HeaderWithNav::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(HeaderWithNav_C_ExecuteUbergraph_HeaderWithNav, CallFunc_IsUsingGamepad_ReturnValue) == 0x000028, "Member 'HeaderWithNav_C_ExecuteUbergraph_HeaderWithNav::CallFunc_IsUsingGamepad_ReturnValue' has a wrong offset!");
static_assert(offsetof(HeaderWithNav_C_ExecuteUbergraph_HeaderWithNav, K2Node_CustomEvent_bUsingGamepad) == 0x000029, "Member 'HeaderWithNav_C_ExecuteUbergraph_HeaderWithNav::K2Node_CustomEvent_bUsingGamepad' has a wrong offset!");
static_assert(offsetof(HeaderWithNav_C_ExecuteUbergraph_HeaderWithNav, K2Node_ComponentBoundEvent_Button2) == 0x000030, "Member 'HeaderWithNav_C_ExecuteUbergraph_HeaderWithNav::K2Node_ComponentBoundEvent_Button2' has a wrong offset!");
static_assert(offsetof(HeaderWithNav_C_ExecuteUbergraph_HeaderWithNav, CallFunc_GetGameInstanceSubsystem_ReturnValue) == 0x000038, "Member 'HeaderWithNav_C_ExecuteUbergraph_HeaderWithNav::CallFunc_GetGameInstanceSubsystem_ReturnValue' has a wrong offset!");
static_assert(offsetof(HeaderWithNav_C_ExecuteUbergraph_HeaderWithNav, K2Node_Event_IsDesignTime) == 0x000040, "Member 'HeaderWithNav_C_ExecuteUbergraph_HeaderWithNav::K2Node_Event_IsDesignTime' has a wrong offset!");
static_assert(offsetof(HeaderWithNav_C_ExecuteUbergraph_HeaderWithNav, K2Node_ComponentBoundEvent_Button1) == 0x000048, "Member 'HeaderWithNav_C_ExecuteUbergraph_HeaderWithNav::K2Node_ComponentBoundEvent_Button1' has a wrong offset!");
...
public:
	...
	bool                                          CallFunc_BooleanAND_ReturnValue1;                  // 0x020A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(HeaderWithNav_C_Update) == 0x000008, "Wrong alignment on HeaderWithNav_C_Update");
static_assert(sizeof(HeaderWithNav_C_Update) == 0x000210, "Wrong size on HeaderWithNav_C_Update");
...
static_assert(offsetof(HeaderWithNav_C_Update, CallFunc_Not_PreBool_ReturnValue1) == 0x000208, "Member 'HeaderWithNav_C_Update::CallFunc_Not_PreBool_ReturnValue1' has a wrong offset!");
static_assert(offsetof(HeaderWithNav_C_Update, CallFunc_BooleanAND_ReturnValue) == 0x000209, "Member 'HeaderWithNav_C_Update::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(HeaderWithNav_C_Update, CallFunc_BooleanAND_ReturnValue1) == 0x00020A, "Member 'HeaderWithNav_C_Update::CallFunc_BooleanAND_ReturnValue1' has a wrong offset!");
