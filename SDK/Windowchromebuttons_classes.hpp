...
static_assert(sizeof(UWindowchromebuttons_C) == 0x000230, "Wrong size on UWindowchromebuttons_C");
static_assert(offsetof(UWindowchromebuttons_C, UberGraphFrame) == 0x000210, "Member 'UWindowchromebuttons_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWindowchromebuttons_C, FadeOut) == 0x000218, "Member 'UWindowchromebuttons_C::FadeOut' has a wrong offset!");
static_assert(offsetof(UWindowchromebuttons_C, FadeIn) == 0x000220, "Member 'UWindowchromebuttons_C::FadeIn' has a wrong offset!");
static_assert(offsetof(UWindowchromebuttons_C, WindowTitleBarArea_107) == 0x000228, "Member 'UWindowchromebuttons_C::WindowTitleBarArea_107' has a wrong offset!");
