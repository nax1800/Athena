...
static_assert(offsetof(GamepadKeyButton_C_SetContentAlignment, Param_ContentAlignment) == 0x000000, "Member 'GamepadKeyButton_C_SetContentAlignment::Param_ContentAlignment' has a wrong offset!");
