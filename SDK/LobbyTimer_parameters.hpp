...
static_assert(offsetof(LobbyTimer_C_Show_Lobby_Timer, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000008, "Member 'LobbyTimer_C_Show_Lobby_Timer::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
