...
static_assert(sizeof(SocialPanel_C_ExecuteUbergraph_SocialPanel) == 0x000028, "Wrong size on SocialPanel_C_ExecuteUbergraph_SocialPanel");
...
static_assert(offsetof(SocialPanel_C_ExecuteUbergraph_SocialPanel, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000018, "Member 'SocialPanel_C_ExecuteUbergraph_SocialPanel::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
static_assert(offsetof(SocialPanel_C_ExecuteUbergraph_SocialPanel, CallFunc_GetUIManagerWidget_ReturnValue) == 0x000020, "Member 'SocialPanel_C_ExecuteUbergraph_SocialPanel::CallFunc_GetUIManagerWidget_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(SocialPanel_C_ClosePanelAfterAnimation, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000010, "Member 'SocialPanel_C_ClosePanelAfterAnimation::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
