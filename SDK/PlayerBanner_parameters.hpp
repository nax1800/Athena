...
public:
	...
	TDelegate<void(class UObject* Object)>        K2Node_CreateDelegate_OutputDelegate;              // 0x0080(0x0010)(ZeroConstructor, NoDestructor)
};
...
static_assert(offsetof(PlayerBanner_C_RefreshSurround, K2Node_CreateDelegate_OutputDelegate) == 0x000080, "Member 'PlayerBanner_C_RefreshSurround::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
...
public:
	...
	struct FFortAthenaLoadout                     CallFunc_GetLoadoutForPlayer_ReturnValue;          // 0x0018(0x00C8)()
	ESubGame                                      CallFunc_GetSubGame_ReturnValue;                   // 0x00E0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FName                                   CallFunc_Conv_StringToName_ReturnValue1;           // 0x00F0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FFortHomeBaseInfo                      CallFunc_GetHomeBaseInfoForPlayer_Result;          // 0x00F8(0x0040)()
	bool                                          CallFunc_SetBannerImage_Success;                   // 0x0138(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(sizeof(PlayerBanner_C_SetBannerIconAndColorFromProfile) == 0x000140, "Wrong size on PlayerBanner_C_SetBannerIconAndColorFromProfile");
...
static_assert(offsetof(PlayerBanner_C_SetBannerIconAndColorFromProfile, CallFunc_GetSubGame_ReturnValue) == 0x0000E0, "Member 'PlayerBanner_C_SetBannerIconAndColorFromProfile::CallFunc_GetSubGame_ReturnValue' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_SetBannerIconAndColorFromProfile, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x0000E1, "Member 'PlayerBanner_C_SetBannerIconAndColorFromProfile::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_SetBannerIconAndColorFromProfile, CallFunc_Conv_StringToName_ReturnValue) == 0x0000E8, "Member 'PlayerBanner_C_SetBannerIconAndColorFromProfile::CallFunc_Conv_StringToName_ReturnValue' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_SetBannerIconAndColorFromProfile, CallFunc_Conv_StringToName_ReturnValue1) == 0x0000F0, "Member 'PlayerBanner_C_SetBannerIconAndColorFromProfile::CallFunc_Conv_StringToName_ReturnValue1' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_SetBannerIconAndColorFromProfile, CallFunc_GetHomeBaseInfoForPlayer_Result) == 0x0000F8, "Member 'PlayerBanner_C_SetBannerIconAndColorFromProfile::CallFunc_GetHomeBaseInfoForPlayer_Result' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_SetBannerIconAndColorFromProfile, CallFunc_SetBannerImage_Success) == 0x000138, "Member 'PlayerBanner_C_SetBannerIconAndColorFromProfile::CallFunc_SetBannerImage_Success' has a wrong offset!");
