...
static_assert(offsetof(XpMatchProgression_C_ExecuteUbergraph_XpMatchProgression, CallFunc_Conv_IntToFloat_ReturnValue1) == 0x00006C, "Member 'XpMatchProgression_C_ExecuteUbergraph_XpMatchProgression::CallFunc_Conv_IntToFloat_ReturnValue1' has a wrong offset!");
