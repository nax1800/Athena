...
static_assert(sizeof(ABP_Athena_Water_C) == 0x0003A0, "Wrong size on ABP_Athena_Water_C");
static_assert(offsetof(ABP_Athena_Water_C, UberGraphFrame) == 0x000328, "Member 'ABP_Athena_Water_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABP_Athena_Water_C, WaterPost) == 0x000330, "Member 'ABP_Athena_Water_C::WaterPost' has a wrong offset!");
static_assert(offsetof(ABP_Athena_Water_C, Box) == 0x000338, "Member 'ABP_Athena_Water_C::Box' has a wrong offset!");
static_assert(offsetof(ABP_Athena_Water_C, Water_Base) == 0x000340, "Member 'ABP_Athena_Water_C::Water_Base' has a wrong offset!");
static_assert(offsetof(ABP_Athena_Water_C, Water_Plane) == 0x000348, "Member 'ABP_Athena_Water_C::Water_Plane' has a wrong offset!");
static_assert(offsetof(ABP_Athena_Water_C, WaterMaterial) == 0x000350, "Member 'ABP_Athena_Water_C::WaterMaterial' has a wrong offset!");
static_assert(offsetof(ABP_Athena_Water_C, HideGroundPlane) == 0x000358, "Member 'ABP_Athena_Water_C::HideGroundPlane' has a wrong offset!");
static_assert(offsetof(ABP_Athena_Water_C, GroundPlaneMaterialOverride) == 0x000360, "Member 'ABP_Athena_Water_C::GroundPlaneMaterialOverride' has a wrong offset!");
static_assert(offsetof(ABP_Athena_Water_C, CorruptWaterMat) == 0x000368, "Member 'ABP_Athena_Water_C::CorruptWaterMat' has a wrong offset!");
static_assert(offsetof(ABP_Athena_Water_C, IsBouncy) == 0x000369, "Member 'ABP_Athena_Water_C::IsBouncy' has a wrong offset!");
static_assert(offsetof(ABP_Athena_Water_C, VehicleToBounce) == 0x000370, "Member 'ABP_Athena_Water_C::VehicleToBounce' has a wrong offset!");
static_assert(offsetof(ABP_Athena_Water_C, RecentlyBouncedVehicles) == 0x000378, "Member 'ABP_Athena_Water_C::RecentlyBouncedVehicles' has a wrong offset!");
static_assert(offsetof(ABP_Athena_Water_C, IsLootLake) == 0x000388, "Member 'ABP_Athena_Water_C::IsLootLake' has a wrong offset!");
static_assert(offsetof(ABP_Athena_Water_C, HitLocation) == 0x00038C, "Member 'ABP_Athena_Water_C::HitLocation' has a wrong offset!");
static_assert(offsetof(ABP_Athena_Water_C, BounceLake) == 0x000398, "Member 'ABP_Athena_Water_C::BounceLake' has a wrong offset!");
