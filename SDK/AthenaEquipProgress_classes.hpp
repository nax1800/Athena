...
static_assert(offsetof(UAthenaEquipProgress_C, CueCount) == 0x00026C, "Member 'UAthenaEquipProgress_C::CueCount' has a wrong offset!");
static_assert(offsetof(UAthenaEquipProgress_C, VerifyCueCountTimerHandle) == 0x000270, "Member 'UAthenaEquipProgress_C::VerifyCueCountTimerHandle' has a wrong offset!");
