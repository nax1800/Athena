...
static_assert(offsetof(GamepadCustomActionSelectorPanel_v3_C_ExecuteUbergraph_GamepadCustomActionSelectorPanel_v3, K2Node_CreateDelegate_OutputDelegate2) == 0x000088, "Member 'GamepadCustomActionSelectorPanel_v3_C_ExecuteUbergraph_GamepadCustomActionSelectorPanel_v3::K2Node_CreateDelegate_OutputDelegate2' has a wrong offset!");
...
public:
	...
	class FName                                   CustomPresetName_Local;                            // 0x0028(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(GamepadCustomActionSelectorPanel_v3_C_CreateCustomListItem, CustomPresetName_Local) == 0x000028, "Member 'GamepadCustomActionSelectorPanel_v3_C_CreateCustomListItem::CustomPresetName_Local' has a wrong offset!");
...
static_assert(offsetof(GamepadCustomActionSelectorPanel_v3_C_CreateCustomListItem, CallFunc_Conv_StringToName_ReturnValue) == 0x0000C8, "Member 'GamepadCustomActionSelectorPanel_v3_C_CreateCustomListItem::CallFunc_Conv_StringToName_ReturnValue' has a wrong offset!");
