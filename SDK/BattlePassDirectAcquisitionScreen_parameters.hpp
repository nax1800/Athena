...
static_assert(offsetof(BattlePassDirectAcquisitionScreen_C_Intro_Anim__Header_, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000000, "Member 'BattlePassDirectAcquisitionScreen_C_Intro_Anim__Header_::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BattlePassDirectAcquisitionScreen_C_Intro_Anim__OR_, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000000, "Member 'BattlePassDirectAcquisitionScreen_C_Intro_Anim__OR_::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BattlePassDirectAcquisitionScreen_C_Intro_Anim__Tiles_, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000000, "Member 'BattlePassDirectAcquisitionScreen_C_Intro_Anim__Tiles_::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BattlePassDirectAcquisitionScreen_C_Intro_Anim_Reset, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000000, "Member 'BattlePassDirectAcquisitionScreen_C_Intro_Anim_Reset::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
