...
static_assert(sizeof(WBP_Augment_SelectionTimer_C_ExecuteUbergraph_WBP_Augment_SelectionTimer) == 0x000100, "Wrong size on WBP_Augment_SelectionTimer_C_ExecuteUbergraph_WBP_Augment_SelectionTimer");
...
static_assert(sizeof(WBP_Augment_SelectionTimer_C_OnNumPendingAugmentsToGrantUpdated) == 0x0000C0, "Wrong size on WBP_Augment_SelectionTimer_C_OnNumPendingAugmentsToGrantUpdated");
