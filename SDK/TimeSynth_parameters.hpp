...
public:
	...
	TDelegate<void(ETimeSynthEventQuantization QuantizationType, int32 NumBars, float Beat)> OnQuantizationEvent;                               // 0x0008(0x0010)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(TimeSynthComponent_AddQuantizationEventDelegate) == 0x000018, "Wrong size on TimeSynthComponent_AddQuantizationEventDelegate");
...
static_assert(offsetof(TimeSynthComponent_AddQuantizationEventDelegate, OnQuantizationEvent) == 0x000008, "Member 'TimeSynthComponent_AddQuantizationEventDelegate::OnQuantizationEvent' has a wrong offset!");
...
public:
	...
	struct FTimeSynthClipHandle                   ReturnValue;                                       // 0x0010(0x0010)(Parm, OutParm, ReturnParm, NoDestructor, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FTimeSynthEnvelopeFollowerSettings     InSettings;                                        // 0x0000(0x000C)(ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FTimeSynthFilterSettings               InSettings;                                        // 0x0004(0x000C)(ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FTimeSynthClipHandle                   InClipHandle;                                      // 0x0000(0x0010)(Parm, NoDestructor, NativeAccessSpecifierPublic)
	ETimeSynthEventClipQuantization               EventQuantization;                                 // 0x0010(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_11[0x7];                                       // 0x0011(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(TimeSynthComponent_StopClip) == 0x000008, "Wrong alignment on TimeSynthComponent_StopClip");
static_assert(sizeof(TimeSynthComponent_StopClip) == 0x000018, "Wrong size on TimeSynthComponent_StopClip");
...
static_assert(offsetof(TimeSynthComponent_StopClip, EventQuantization) == 0x000010, "Member 'TimeSynthComponent_StopClip::EventQuantization' has a wrong offset!");
...
public:
	...
	struct FTimeSynthTimeDef                      FadeTime;                                          // 0x0014(0x0008)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(TimeSynthComponent_StopClipWithFadeOverride) == 0x000008, "Wrong alignment on TimeSynthComponent_StopClipWithFadeOverride");
static_assert(sizeof(TimeSynthComponent_StopClipWithFadeOverride) == 0x000020, "Wrong size on TimeSynthComponent_StopClipWithFadeOverride");
...
static_assert(offsetof(TimeSynthComponent_StopClipWithFadeOverride, EventQuantization) == 0x000010, "Member 'TimeSynthComponent_StopClipWithFadeOverride::EventQuantization' has a wrong offset!");
static_assert(offsetof(TimeSynthComponent_StopClipWithFadeOverride, FadeTime) == 0x000014, "Member 'TimeSynthComponent_StopClipWithFadeOverride::FadeTime' has a wrong offset!");
