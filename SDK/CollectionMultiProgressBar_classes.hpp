...
static_assert(sizeof(UCollectionMultiProgressBar_C) == 0x0004C8, "Wrong size on UCollectionMultiProgressBar_C");
...
static_assert(offsetof(UCollectionMultiProgressBar_C, bOnlyShowBarWithCountInRange) == 0x000400, "Member 'UCollectionMultiProgressBar_C::bOnlyShowBarWithCountInRange' has a wrong offset!");
static_assert(offsetof(UCollectionMultiProgressBar_C, IconBrush) == 0x000408, "Member 'UCollectionMultiProgressBar_C::IconBrush' has a wrong offset!");
static_assert(offsetof(UCollectionMultiProgressBar_C, IconSize) == 0x000490, "Member 'UCollectionMultiProgressBar_C::IconSize' has a wrong offset!");
static_assert(offsetof(UCollectionMultiProgressBar_C, bShowBarTopIcons) == 0x000491, "Member 'UCollectionMultiProgressBar_C::bShowBarTopIcons' has a wrong offset!");
static_assert(offsetof(UCollectionMultiProgressBar_C, bShowBarSideIcons) == 0x000492, "Member 'UCollectionMultiProgressBar_C::bShowBarSideIcons' has a wrong offset!");
static_assert(offsetof(UCollectionMultiProgressBar_C, BarsMargin) == 0x000494, "Member 'UCollectionMultiProgressBar_C::BarsMargin' has a wrong offset!");
static_assert(offsetof(UCollectionMultiProgressBar_C, BarsIconMargin) == 0x0004A4, "Member 'UCollectionMultiProgressBar_C::BarsIconMargin' has a wrong offset!");
static_assert(offsetof(UCollectionMultiProgressBar_C, BarHeightFactor) == 0x0004B4, "Member 'UCollectionMultiProgressBar_C::BarHeightFactor' has a wrong offset!");
static_assert(offsetof(UCollectionMultiProgressBar_C, PreviousBarWithCountInRange) == 0x0004B8, "Member 'UCollectionMultiProgressBar_C::PreviousBarWithCountInRange' has a wrong offset!");
static_assert(offsetof(UCollectionMultiProgressBar_C, BarHeightOverride) == 0x0004C0, "Member 'UCollectionMultiProgressBar_C::BarHeightOverride' has a wrong offset!");
