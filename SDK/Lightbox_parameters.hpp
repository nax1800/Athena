...
static_assert(sizeof(Lightbox_C_ExecuteUbergraph_Lightbox) == 0x00000C, "Wrong size on Lightbox_C_ExecuteUbergraph_Lightbox");
...
static_assert(offsetof(Lightbox_C_ExecuteUbergraph_Lightbox, Temp_byte_Variable) == 0x000005, "Member 'Lightbox_C_ExecuteUbergraph_Lightbox::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(Lightbox_C_ExecuteUbergraph_Lightbox, Temp_byte_Variable1) == 0x000006, "Member 'Lightbox_C_ExecuteUbergraph_Lightbox::Temp_byte_Variable1' has a wrong offset!");
static_assert(offsetof(Lightbox_C_ExecuteUbergraph_Lightbox, K2Node_Event_IsDesignTime) == 0x000007, "Member 'Lightbox_C_ExecuteUbergraph_Lightbox::K2Node_Event_IsDesignTime' has a wrong offset!");
