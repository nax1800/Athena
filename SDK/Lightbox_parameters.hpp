...
static_assert(offsetof(Lightbox_C_Intro, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000000, "Member 'Lightbox_C_Intro::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Lightbox_C_Outro, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000000, "Member 'Lightbox_C_Outro::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
