...
static_assert(alignof(UBorderMinusSolidBGMinusToolTipShadow_C) == 0x000010, "Wrong alignment on UBorderMinusSolidBGMinusToolTipShadow_C");
static_assert(sizeof(UBorderMinusSolidBGMinusToolTipShadow_C) == 0x0000F0, "Wrong size on UBorderMinusSolidBGMinusToolTipShadow_C");
