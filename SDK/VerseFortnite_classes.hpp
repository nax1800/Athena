...
static_assert(sizeof(UFortActorEntitySubsystem) == 0x0000C0, "Wrong size on UFortActorEntitySubsystem");
...
static_assert(sizeof(UGameplayAbility_PlayAnim) == 0x0003B8, "Wrong size on UGameplayAbility_PlayAnim");
...
static_assert(sizeof(ATeamProxyActor) == 0x0002B8, "Wrong size on ATeamProxyActor");
...
static_assert(sizeof(UAIActionsHandlerComponent) == 0x0000E8, "Wrong size on UAIActionsHandlerComponent");
...
static_assert(sizeof(UFortAthenaAISpawnerDataComponent_Verse) == 0x000048, "Wrong size on UFortAthenaAISpawnerDataComponent_Verse");
...
static_assert(sizeof(UVerseAIPerceptionStimuliSourceComponent) == 0x0000C0, "Wrong size on UVerseAIPerceptionStimuliSourceComponent");
...
static_assert(sizeof(UNPCCharacterDefinition) == 0x0001D8, "Wrong size on UNPCCharacterDefinition");
...
static_assert(sizeof(UNPCCharacterDefinitionComponent) == 0x000170, "Wrong size on UNPCCharacterDefinitionComponent");
...
static_assert(sizeof(UNPCIndicatorComponent) == 0x0000A8, "Wrong size on UNPCIndicatorComponent");
