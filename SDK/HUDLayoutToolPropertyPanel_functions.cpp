...
void UHUDLayoutToolPropertyPanel_C::BndEvt__ToggleEditMode_K2Node_ComponentBoundEvent_5_CommonButtonClicked__DelegateSignature(class UCommonButton* Button)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUDLayoutToolPropertyPanel_C", "BndEvt__ToggleEditMode_K2Node_ComponentBoundEvent_5_CommonButtonClicked__DelegateSignature");

	Params::HUDLayoutToolPropertyPanel_C_BndEvt__ToggleEditMode_K2Node_ComponentBoundEvent_5_CommonButtonClicked__DelegateSignature Parms{};
...
void UHUDLayoutToolPropertyPanel_C::BndEvt__ToggleCombatMode_K2Node_ComponentBoundEvent_4_CommonButtonClicked__DelegateSignature(class UCommonButton* Button)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUDLayoutToolPropertyPanel_C", "BndEvt__ToggleCombatMode_K2Node_ComponentBoundEvent_4_CommonButtonClicked__DelegateSignature");

	Params::HUDLayoutToolPropertyPanel_C_BndEvt__ToggleCombatMode_K2Node_ComponentBoundEvent_4_CommonButtonClicked__DelegateSignature Parms{};
...
void UHUDLayoutToolPropertyPanel_C::BndEvt__ToggleBuildMode_K2Node_ComponentBoundEvent_3_CommonButtonClicked__DelegateSignature(class UCommonButton* Button)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUDLayoutToolPropertyPanel_C", "BndEvt__ToggleBuildMode_K2Node_ComponentBoundEvent_3_CommonButtonClicked__DelegateSignature");

	Params::HUDLayoutToolPropertyPanel_C_BndEvt__ToggleBuildMode_K2Node_ComponentBoundEvent_3_CommonButtonClicked__DelegateSignature Parms{};
...
void UHUDLayoutToolPropertyPanel_C::SetVisibilityButtonStyle(class UCommonButton* Button, bool Show)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUDLayoutToolPropertyPanel_C", "SetVisibilityButtonStyle");

	Params::HUDLayoutToolPropertyPanel_C_SetVisibilityButtonStyle Parms{};
...
void UHUDLayoutToolPropertyPanel_C::InitVisibilityStyles()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUDLayoutToolPropertyPanel_C", "InitVisibilityStyles");
...
void UHUDLayoutToolPropertyPanel_C::UpdateHudVisibility()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUDLayoutToolPropertyPanel_C", "UpdateHudVisibility");
...
void UHUDLayoutToolPropertyPanel_C::GetNextVisibility(uint8 Current_Vis, uint8* Next_Vis) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUDLayoutToolPropertyPanel_C", "GetNextVisibility");

	Params::HUDLayoutToolPropertyPanel_C_GetNextVisibility Parms{};
