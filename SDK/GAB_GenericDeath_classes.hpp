...
public:
	...
	struct FVector                                DeathHitDirection;                                 // 0x0958(0x000C)(Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_964[0x4];                                      // 0x0964(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FHitResult                             DeathHitResult;                                    // 0x0968(0x0088)(Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData, NoDestructor, ContainsInstancedReference)
...
static_assert(sizeof(UGAB_GenericDeath_C) == 0x000AD0, "Wrong size on UGAB_GenericDeath_C");
...
static_assert(offsetof(UGAB_GenericDeath_C, DeathHitResult) == 0x000968, "Member 'UGAB_GenericDeath_C::DeathHitResult' has a wrong offset!");
