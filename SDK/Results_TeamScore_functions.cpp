...
// Function Results_TeamScore.Results_TeamScore_C.WidgetAnimationEvt_Anim_ContinueButtonIntro_K2Node_WidgetAnimationEvent_1
// (BlueprintEvent)

void UResults_TeamScore_C::WidgetAnimationEvt_Anim_ContinueButtonIntro_K2Node_WidgetAnimationEvent_1()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Results_TeamScore_C", "WidgetAnimationEvt_Anim_ContinueButtonIntro_K2Node_WidgetAnimationEvent_1");

	UObject::ProcessEvent(Func, nullptr);
}


// Function Results_TeamScore.Results_TeamScore_C.WidgetAnimationEvt_Anim_ContinueButtonOutro_K2Node_WidgetAnimationEvent_0
// (BlueprintEvent)

void UResults_TeamScore_C::WidgetAnimationEvt_Anim_ContinueButtonOutro_K2Node_WidgetAnimationEvent_0()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Results_TeamScore_C", "WidgetAnimationEvt_Anim_ContinueButtonOutro_K2Node_WidgetAnimationEvent_0");
