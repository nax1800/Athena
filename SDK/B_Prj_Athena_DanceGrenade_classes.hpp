...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_B_Prj_Athena_DanceGrenade_C;        // 0x0788(0x0008)(Transient, DuplicateTransient)
	struct FGameplayTagContainer                  StunAbility;                                       // 0x0790(0x0020)(Edit, BlueprintVisible, DisableEditOnInstance)
...
static_assert(sizeof(AB_Prj_Athena_DanceGrenade_C) == 0x0007B0, "Wrong size on AB_Prj_Athena_DanceGrenade_C");
static_assert(offsetof(AB_Prj_Athena_DanceGrenade_C, UberGraphFrame_B_Prj_Athena_DanceGrenade_C) == 0x000788, "Member 'AB_Prj_Athena_DanceGrenade_C::UberGraphFrame_B_Prj_Athena_DanceGrenade_C' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_DanceGrenade_C, StunAbility) == 0x000790, "Member 'AB_Prj_Athena_DanceGrenade_C::StunAbility' has a wrong offset!");
