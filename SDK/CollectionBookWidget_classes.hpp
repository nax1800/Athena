...
static_assert(sizeof(UCollectionBookWidget_C) == 0x000360, "Wrong size on UCollectionBookWidget_C");
static_assert(offsetof(UCollectionBookWidget_C, UberGraphFrame) == 0x000358, "Member 'UCollectionBookWidget_C::UberGraphFrame' has a wrong offset!");
