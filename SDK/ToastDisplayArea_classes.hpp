...
static_assert(offsetof(UToastDisplayArea_C, UberGraphFrame) == 0x000230, "Member 'UToastDisplayArea_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UToastDisplayArea_C, PowerToastWidget) == 0x000238, "Member 'UToastDisplayArea_C::PowerToastWidget' has a wrong offset!");
static_assert(offsetof(UToastDisplayArea_C, SafeZone_0) == 0x000240, "Member 'UToastDisplayArea_C::SafeZone_0' has a wrong offset!");
static_assert(offsetof(UToastDisplayArea_C, ToastWidget_MinorError) == 0x000248, "Member 'UToastDisplayArea_C::ToastWidget_MinorError' has a wrong offset!");
static_assert(offsetof(UToastDisplayArea_C, ToastWidget_New) == 0x000250, "Member 'UToastDisplayArea_C::ToastWidget_New' has a wrong offset!");
