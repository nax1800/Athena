...
static_assert(sizeof(AMimic_Mission_C) == 0x0007F8, "Wrong size on AMimic_Mission_C");
static_assert(offsetof(AMimic_Mission_C, UberGraphFrame) == 0x0006A0, "Member 'AMimic_Mission_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AMimic_Mission_C, DefaultSceneRoot) == 0x0006A8, "Member 'AMimic_Mission_C::DefaultSceneRoot' has a wrong offset!");
static_assert(offsetof(AMimic_Mission_C, MimicPawn) == 0x0006B0, "Member 'AMimic_Mission_C::MimicPawn' has a wrong offset!");
static_assert(offsetof(AMimic_Mission_C, SavedMimicHealth) == 0x0006B8, "Member 'AMimic_Mission_C::SavedMimicHealth' has a wrong offset!");
static_assert(offsetof(AMimic_Mission_C, KillMimicObjectiveHandle) == 0x0006C0, "Member 'AMimic_Mission_C::KillMimicObjectiveHandle' has a wrong offset!");
static_assert(offsetof(AMimic_Mission_C, DefeatMimicText) == 0x0006E0, "Member 'AMimic_Mission_C::DefeatMimicText' has a wrong offset!");
static_assert(offsetof(AMimic_Mission_C, ChestInteractObjectiveHandle) == 0x0006F8, "Member 'AMimic_Mission_C::ChestInteractObjectiveHandle' has a wrong offset!");
static_assert(offsetof(AMimic_Mission_C, MimicChest) == 0x000718, "Member 'AMimic_Mission_C::MimicChest' has a wrong offset!");
static_assert(offsetof(AMimic_Mission_C, FindMimicText) == 0x000720, "Member 'AMimic_Mission_C::FindMimicText' has a wrong offset!");
static_assert(offsetof(AMimic_Mission_C, ChosenReward) == 0x000738, "Member 'AMimic_Mission_C::ChosenReward' has a wrong offset!");
static_assert(offsetof(AMimic_Mission_C, MimicHealthBarText) == 0x0007D0, "Member 'AMimic_Mission_C::MimicHealthBarText' has a wrong offset!");
static_assert(offsetof(AMimic_Mission_C, Encounter) == 0x0007E8, "Member 'AMimic_Mission_C::Encounter' has a wrong offset!");
static_assert(offsetof(AMimic_Mission_C, ObjectiveStatus) == 0x0007F0, "Member 'AMimic_Mission_C::ObjectiveStatus' has a wrong offset!");
