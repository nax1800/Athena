...
static_assert(sizeof(AMidMatchRiftPoiManagerActor) == 0x000360, "Wrong size on AMidMatchRiftPoiManagerActor");
...
static_assert(sizeof(AMidmatchRiftPoiSpawnIndicator) == 0x000360, "Wrong size on AMidmatchRiftPoiSpawnIndicator");
