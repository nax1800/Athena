...
static_assert(alignof(WBP_UIKit_Tag_Base_C_SetIconSize) == 0x000008, "Wrong alignment on WBP_UIKit_Tag_Base_C_SetIconSize");
static_assert(sizeof(WBP_UIKit_Tag_Base_C_SetIconSize) == 0x000018, "Wrong size on WBP_UIKit_Tag_Base_C_SetIconSize");
