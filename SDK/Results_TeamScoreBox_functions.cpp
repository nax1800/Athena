...
// Function Results_TeamScoreBox.Results_TeamScoreBox_C.WidgetAnimationEvt_Anim_Intro_K2Node_WidgetAnimationEvent_0
// (BlueprintEvent)

void UResults_TeamScoreBox_C::WidgetAnimationEvt_Anim_Intro_K2Node_WidgetAnimationEvent_0()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Results_TeamScoreBox_C", "WidgetAnimationEvt_Anim_Intro_K2Node_WidgetAnimationEvent_0");
