...
static_assert(sizeof(GCN_NPC_Fire_C_OnActive) == 0x0000D8, "Wrong size on GCN_NPC_Fire_C_OnActive");
...
static_assert(offsetof(GCN_NPC_Fire_C_OnActive, K2Node_DynamicCast_AsSmasher_Pawn) == 0x0000C8, "Member 'GCN_NPC_Fire_C_OnActive::K2Node_DynamicCast_AsSmasher_Pawn' has a wrong offset!");
static_assert(offsetof(GCN_NPC_Fire_C_OnActive, K2Node_DynamicCast_bSuccess) == 0x0000D0, "Member 'GCN_NPC_Fire_C_OnActive::K2Node_DynamicCast_bSuccess' has a wrong offset!");
