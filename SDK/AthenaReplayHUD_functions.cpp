...
void UAthenaReplayHUD_C::OnPlayerTargetingChanged(bool bIsTargeting)
{
	static class UFunction* Func = nullptr;
...
void UAthenaReplayHUD_C::OnIndicatorModeChanged(bool bIndicatorsEnabled)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaReplayHUD_C", "OnIndicatorModeChanged");

	Params::AthenaReplayHUD_C_OnIndicatorModeChanged Parms{};
...
void UAthenaReplayHUD_C::OnCursorModeChanged(bool bCursorModeEnabled, class FName ActionName, class UUserWidget* CursorModeContentWidget)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaReplayHUD_C", "OnCursorModeChanged");

	Params::AthenaReplayHUD_C_OnCursorModeChanged Parms{};
