...
public:
	...
	struct FSlateFontInfo                         K2Node_MakeStruct_SlateFontInfo1;                  // 0x00A0(0x0050)(HasGetValueTypeHash)
};
...
static_assert(offsetof(AthenaMatchStatusTextPlayer_C_HighlightMaterialControl, K2Node_MakeStruct_SlateFontInfo1) == 0x0000A0, "Member 'AthenaMatchStatusTextPlayer_C_HighlightMaterialControl::K2Node_MakeStruct_SlateFontInfo1' has a wrong offset!");
