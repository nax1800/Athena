...
static_assert(sizeof(AthenaMatchStatusTextPlayer_C_GetFont) == 0x000058, "Wrong size on AthenaMatchStatusTextPlayer_C_GetFont");
...
static_assert(sizeof(AthenaMatchStatusTextPlayer_C_HighlightMaterialControl) == 0x000108, "Wrong size on AthenaMatchStatusTextPlayer_C_HighlightMaterialControl");
...
static_assert(offsetof(AthenaMatchStatusTextPlayer_C_HighlightMaterialControl, K2Node_MakeStruct_SlateFontInfo) == 0x000058, "Member 'AthenaMatchStatusTextPlayer_C_HighlightMaterialControl::K2Node_MakeStruct_SlateFontInfo' has a wrong offset!");
static_assert(offsetof(AthenaMatchStatusTextPlayer_C_HighlightMaterialControl, K2Node_MakeStruct_SlateFontInfo1) == 0x0000B0, "Member 'AthenaMatchStatusTextPlayer_C_HighlightMaterialControl::K2Node_MakeStruct_SlateFontInfo1' has a wrong offset!");
...
static_assert(sizeof(AthenaMatchStatusTextPlayer_C_SetFont) == 0x000058, "Wrong size on AthenaMatchStatusTextPlayer_C_SetFont");
