...
static_assert(sizeof(ShowdownLobbyViolator_C_ExecuteUbergraph_ShowdownLobbyViolator) == 0x0001F8, "Wrong size on ShowdownLobbyViolator_C_ExecuteUbergraph_ShowdownLobbyViolator");
