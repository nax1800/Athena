...
static_assert(offsetof(Results_CommanderXP_C_ExecuteUbergraph_Results_CommanderXP, CallFunc_BooleanOR_ReturnValue2) == 0x000006, "Member 'Results_CommanderXP_C_ExecuteUbergraph_Results_CommanderXP::CallFunc_BooleanOR_ReturnValue2' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_ExecuteUbergraph_Results_CommanderXP, CallFunc_BooleanOR_ReturnValue3) == 0x000007, "Member 'Results_CommanderXP_C_ExecuteUbergraph_Results_CommanderXP::CallFunc_BooleanOR_ReturnValue3' has a wrong offset!");
...
static_assert(offsetof(Results_CommanderXP_C_ExecuteUbergraph_Results_CommanderXP, CallFunc_IsAnimationPlaying_ReturnValue2) == 0x000011, "Member 'Results_CommanderXP_C_ExecuteUbergraph_Results_CommanderXP::CallFunc_IsAnimationPlaying_ReturnValue2' has a wrong offset!");
...
static_assert(sizeof(Results_CommanderXP_C_Initialize) == 0x000218, "Wrong size on Results_CommanderXP_C_Initialize");
...
static_assert(offsetof(Results_CommanderXP_C_Initialize, CallFunc_GetOwningPlayer_ReturnValue) == 0x000028, "Member 'Results_CommanderXP_C_Initialize::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_Initialize, K2Node_DynamicCast_AsFort_Player_Controller) == 0x000030, "Member 'Results_CommanderXP_C_Initialize::K2Node_DynamicCast_AsFort_Player_Controller' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_Initialize, K2Node_DynamicCast_bSuccess) == 0x000038, "Member 'Results_CommanderXP_C_Initialize::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_Initialize, K2Node_DynamicCast_AsFort_Player_State) == 0x000040, "Member 'Results_CommanderXP_C_Initialize::K2Node_DynamicCast_AsFort_Player_State' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_Initialize, K2Node_DynamicCast_bSuccess1) == 0x000048, "Member 'Results_CommanderXP_C_Initialize::K2Node_DynamicCast_bSuccess1' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_Initialize, CallFunc_GetUniqueID_ReturnValue) == 0x000050, "Member 'Results_CommanderXP_C_Initialize::CallFunc_GetUniqueID_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_Initialize, CallFunc_GetContext_ReturnValue) == 0x000078, "Member 'Results_CommanderXP_C_Initialize::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_Initialize, CallFunc_GetSmallPreviewImage_ReturnValue) == 0x000080, "Member 'Results_CommanderXP_C_Initialize::CallFunc_GetSmallPreviewImage_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_Initialize, CallFunc_GetDynamicMaterial_ReturnValue) == 0x0000A8, "Member 'Results_CommanderXP_C_Initialize::CallFunc_GetDynamicMaterial_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_Initialize, CallFunc_GetOrLoadSynchronously_ReturnValue) == 0x0000B0, "Member 'Results_CommanderXP_C_Initialize::CallFunc_GetOrLoadSynchronously_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_Initialize, CallFunc_GetDynamicMaterial_ReturnValue1) == 0x0000B8, "Member 'Results_CommanderXP_C_Initialize::CallFunc_GetDynamicMaterial_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(Results_CommanderXP_C_Initialize, CallFunc_GetContext_ReturnValue1) == 0x0000C8, "Member 'Results_CommanderXP_C_Initialize::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_Initialize, CallFunc_GetHomeBaseInfo_Result) == 0x0000D0, "Member 'Results_CommanderXP_C_Initialize::CallFunc_GetHomeBaseInfo_Result' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_Initialize, CallFunc_Add_IntInt_ReturnValue) == 0x000110, "Member 'Results_CommanderXP_C_Initialize::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_Initialize, CallFunc_GetContext_ReturnValue2) == 0x000118, "Member 'Results_CommanderXP_C_Initialize::CallFunc_GetContext_ReturnValue2' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_Initialize, CallFunc_GetHomeBaseInfo_Result1) == 0x000120, "Member 'Results_CommanderXP_C_Initialize::CallFunc_GetHomeBaseInfo_Result1' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_Initialize, Temp_int_Variable) == 0x000160, "Member 'Results_CommanderXP_C_Initialize::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_Initialize, CallFunc_GetAccountLevelUpRewards_Rewards) == 0x000168, "Member 'Results_CommanderXP_C_Initialize::CallFunc_GetAccountLevelUpRewards_Rewards' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_Initialize, CallFunc_Conv_StringToName_ReturnValue) == 0x000178, "Member 'Results_CommanderXP_C_Initialize::CallFunc_Conv_StringToName_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_Initialize, CallFunc_Array_Get_Item) == 0x000180, "Member 'Results_CommanderXP_C_Initialize::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_Initialize, CallFunc_Array_Length_ReturnValue) == 0x0001C0, "Member 'Results_CommanderXP_C_Initialize::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_Initialize, CallFunc_Add_IntInt_ReturnValue1) == 0x0001C4, "Member 'Results_CommanderXP_C_Initialize::CallFunc_Add_IntInt_ReturnValue1' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_Initialize, CallFunc_Greater_IntInt_ReturnValue) == 0x0001C8, "Member 'Results_CommanderXP_C_Initialize::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_Initialize, CallFunc_Conv_StringToName_ReturnValue1) == 0x0001D0, "Member 'Results_CommanderXP_C_Initialize::CallFunc_Conv_StringToName_ReturnValue1' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_Initialize, CallFunc_LessEqual_IntInt_ReturnValue) == 0x0001D8, "Member 'Results_CommanderXP_C_Initialize::CallFunc_LessEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_Initialize, CallFunc_Add_IntInt_ReturnValue2) == 0x0001DC, "Member 'Results_CommanderXP_C_Initialize::CallFunc_Add_IntInt_ReturnValue2' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_Initialize, CallFunc_GetScoreReportIndex_ReturnValue) == 0x0001E0, "Member 'Results_CommanderXP_C_Initialize::CallFunc_GetScoreReportIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_Initialize, CallFunc_GetXpInfo_OutXpInfo) == 0x0001E4, "Member 'Results_CommanderXP_C_Initialize::CallFunc_GetXpInfo_OutXpInfo' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_Initialize, CallFunc_GetXpInfo_ReturnValue) == 0x000210, "Member 'Results_CommanderXP_C_Initialize::CallFunc_GetXpInfo_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_Initialize, CallFunc_Divide_FloatFloat_ReturnValue) == 0x000214, "Member 'Results_CommanderXP_C_Initialize::CallFunc_Divide_FloatFloat_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(Results_CommanderXP_C_UpdatePointsForLevel) == 0x0000F8, "Wrong size on Results_CommanderXP_C_UpdatePointsForLevel");
...
static_assert(offsetof(Results_CommanderXP_C_UpdatePointsForLevel, CallFunc_Array_Length_ReturnValue) == 0x0000A8, "Member 'Results_CommanderXP_C_UpdatePointsForLevel::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_UpdatePointsForLevel, CallFunc_Array_Get_Item) == 0x0000B0, "Member 'Results_CommanderXP_C_UpdatePointsForLevel::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(Results_CommanderXP_C_UpdatePointsForLevel, CallFunc_Greater_IntInt_ReturnValue) == 0x0000F0, "Member 'Results_CommanderXP_C_UpdatePointsForLevel::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Results_CommanderXP_C_SetSkippingToEnd, CallFunc_IsAnimationPlaying_ReturnValue2) == 0x000002, "Member 'Results_CommanderXP_C_SetSkippingToEnd::CallFunc_IsAnimationPlaying_ReturnValue2' has a wrong offset!");
...
static_assert(sizeof(Results_CommanderXP_C_PlayAnimationCommon) == 0x000010, "Wrong size on Results_CommanderXP_C_PlayAnimationCommon");
...
static_assert(offsetof(Results_CommanderXP_C_PlayAnimationCommon, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000008, "Member 'Results_CommanderXP_C_PlayAnimationCommon::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
