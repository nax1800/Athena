...
void AB_Athena_GasGrenade_FXVolume_C::AdjustedDistanceFromPlayerToPPVolumeCenter(float Param_ScopeStateSwappedTime, float* DistanceOut, bool* bPlayerIsUsingScope)
{
	static class UFunction* Func = nullptr;
