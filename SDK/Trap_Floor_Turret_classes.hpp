...
public:
	...
	void AttemptFire();
	void SpawnTracer(const struct FVector& Param_HitLocation);
	void ShouldFire(bool* Param_ShouldFire);
	void SpawnImpactEffects(const struct FVector& Param_HitLocation);
