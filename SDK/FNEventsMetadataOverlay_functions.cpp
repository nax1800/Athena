...
// Function FNEventsMetadataOverlay.FNEventsMetadataOverlay_C.EventDispatcher_Prev__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)

void UFNEventsMetadataOverlay_C::EventDispatcher_Prev__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FNEventsMetadataOverlay_C", "EventDispatcher_Prev__DelegateSignature");

	UObject::ProcessEvent(Func, nullptr);
}


// Function FNEventsMetadataOverlay.FNEventsMetadataOverlay_C.EventDispatcher_Skip__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)

void UFNEventsMetadataOverlay_C::EventDispatcher_Skip__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FNEventsMetadataOverlay_C", "EventDispatcher_Skip__DelegateSignature");
