...
static_assert(sizeof(GC_Generic_AdrenalineRush_PeriodicHeal_C_HealthCheck) == 0x000018, "Wrong size on GC_Generic_AdrenalineRush_PeriodicHeal_C_HealthCheck");
...
static_assert(offsetof(GC_Generic_AdrenalineRush_PeriodicHeal_C_HealthCheck, CallFunc_IsValid_ReturnValue) == 0x000008, "Member 'GC_Generic_AdrenalineRush_PeriodicHeal_C_HealthCheck::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(GC_Generic_AdrenalineRush_PeriodicHeal_C_HealthCheck, CallFunc_GetHealth_ReturnValue) == 0x00000C, "Member 'GC_Generic_AdrenalineRush_PeriodicHeal_C_HealthCheck::CallFunc_GetHealth_ReturnValue' has a wrong offset!");
static_assert(offsetof(GC_Generic_AdrenalineRush_PeriodicHeal_C_HealthCheck, CallFunc_Subtract_FloatFloat_ReturnValue) == 0x000010, "Member 'GC_Generic_AdrenalineRush_PeriodicHeal_C_HealthCheck::CallFunc_Subtract_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(GC_Generic_AdrenalineRush_PeriodicHeal_C_HealthCheck, CallFunc_Less_FloatFloat_ReturnValue) == 0x000014, "Member 'GC_Generic_AdrenalineRush_PeriodicHeal_C_HealthCheck::CallFunc_Less_FloatFloat_ReturnValue' has a wrong offset!");
