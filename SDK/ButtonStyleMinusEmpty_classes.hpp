...
static_assert(alignof(UButtonStyleMinusEmpty_C) == 0x000010, "Wrong alignment on UButtonStyleMinusEmpty_C");
static_assert(sizeof(UButtonStyleMinusEmpty_C) == 0x000730, "Wrong size on UButtonStyleMinusEmpty_C");
