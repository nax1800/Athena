...
static_assert(sizeof(UOptimusNode_FunctionReference) == 0x000148, "Wrong size on UOptimusNode_FunctionReference");
...
static_assert(sizeof(UOptimusFunctionNodeGraph) == 0x000150, "Wrong size on UOptimusFunctionNodeGraph");
