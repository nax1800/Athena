...
public:
	...
	struct FFortCosmeticModification              K2Node_Event_CosmeticMod;                          // 0x0008(0x04E0)()
	class UMaterialInstanceDynamic*               K2Node_Event_DynamicMaterialInstance;              // 0x04E8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         CallFunc_GetLocalMagazineAmmoCount_ReturnValue;    // 0x04F4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsDedicatedServer_ReturnValue2;           // 0x04F8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(sizeof(B_Minigun_Athena_C_ExecuteUbergraph_B_Minigun_Athena) == 0x000500, "Wrong size on B_Minigun_Athena_C_ExecuteUbergraph_B_Minigun_Athena");
...
static_assert(offsetof(B_Minigun_Athena_C_ExecuteUbergraph_B_Minigun_Athena, K2Node_Event_DynamicMaterialInstance) == 0x0004E8, "Member 'B_Minigun_Athena_C_ExecuteUbergraph_B_Minigun_Athena::K2Node_Event_DynamicMaterialInstance' has a wrong offset!");
static_assert(offsetof(B_Minigun_Athena_C_ExecuteUbergraph_B_Minigun_Athena, CallFunc_IsDedicatedServer_ReturnValue1) == 0x0004F0, "Member 'B_Minigun_Athena_C_ExecuteUbergraph_B_Minigun_Athena::CallFunc_IsDedicatedServer_ReturnValue1' has a wrong offset!");
static_assert(offsetof(B_Minigun_Athena_C_ExecuteUbergraph_B_Minigun_Athena, CallFunc_GetLocalMagazineAmmoCount_ReturnValue) == 0x0004F4, "Member 'B_Minigun_Athena_C_ExecuteUbergraph_B_Minigun_Athena::CallFunc_GetLocalMagazineAmmoCount_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_Minigun_Athena_C_ExecuteUbergraph_B_Minigun_Athena, CallFunc_IsDedicatedServer_ReturnValue2) == 0x0004F8, "Member 'B_Minigun_Athena_C_ExecuteUbergraph_B_Minigun_Athena::CallFunc_IsDedicatedServer_ReturnValue2' has a wrong offset!");
...
static_assert(sizeof(B_Minigun_Athena_C_OnInitCosmeticAlterations) == 0x0004E8, "Wrong size on B_Minigun_Athena_C_OnInitCosmeticAlterations");
...
static_assert(offsetof(B_Minigun_Athena_C_OnInitCosmeticAlterations, DynamicMaterialInstance) == 0x0004E0, "Member 'B_Minigun_Athena_C_OnInitCosmeticAlterations::DynamicMaterialInstance' has a wrong offset!");
