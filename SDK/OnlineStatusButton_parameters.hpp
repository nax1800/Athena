...
public:
	...
	struct FLinearColor                           K2Node_Select1_Default;                            // 0x00B8(0x0010)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UUMGSequencePlayer*                     CallFunc_PlayAnimationAtTime_ReturnValue1;         // 0x00D0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(OnlineStatusButton_C_ExecuteUbergraph_OnlineStatusButton, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x0000C8, "Member 'OnlineStatusButton_C_ExecuteUbergraph_OnlineStatusButton::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
static_assert(offsetof(OnlineStatusButton_C_ExecuteUbergraph_OnlineStatusButton, CallFunc_PlayAnimationAtTime_ReturnValue1) == 0x0000D0, "Member 'OnlineStatusButton_C_ExecuteUbergraph_OnlineStatusButton::CallFunc_PlayAnimationAtTime_ReturnValue1' has a wrong offset!");
