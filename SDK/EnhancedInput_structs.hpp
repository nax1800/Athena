...
static_assert(sizeof(FPlayerKeyMapping) == 0x000078, "Wrong size on FPlayerKeyMapping");
...
static_assert(sizeof(FPlayerMappableKeyProfileCreationArgs) == 0x000028, "Wrong size on FPlayerMappableKeyProfileCreationArgs");
