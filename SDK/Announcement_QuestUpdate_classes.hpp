...
public:
	...
	class UQuestUpdateEntry_C*                    QuestUpdateEntry;                                  // 0x0240(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UAnnouncement_QuestUpdate_C) == 0x000248, "Wrong size on UAnnouncement_QuestUpdate_C");
static_assert(offsetof(UAnnouncement_QuestUpdate_C, UberGraphFrame) == 0x000238, "Member 'UAnnouncement_QuestUpdate_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UAnnouncement_QuestUpdate_C, QuestUpdateEntry) == 0x000240, "Member 'UAnnouncement_QuestUpdate_C::QuestUpdateEntry' has a wrong offset!");
