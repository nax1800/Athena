...
public:
	...
	bool                                          CallFunc_BooleanOR_ReturnValue14;                  // 0x0020(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_BooleanOR_ReturnValue15;                  // 0x0021(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class UUMGSequencePlayer*                     CallFunc_PlayAnimationAtTime_ReturnValue2;         // 0x0030(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_BooleanOR_ReturnValue16;                  // 0x0038(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_BooleanOR_ReturnValue17;                  // 0x0039(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(Results_TeamScore_C_ExecuteUbergraph_Results_TeamScore) == 0x000048, "Wrong size on Results_TeamScore_C_ExecuteUbergraph_Results_TeamScore");
...
static_assert(offsetof(Results_TeamScore_C_ExecuteUbergraph_Results_TeamScore, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000018, "Member 'Results_TeamScore_C_ExecuteUbergraph_Results_TeamScore::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_TeamScore_C_ExecuteUbergraph_Results_TeamScore, CallFunc_BooleanOR_ReturnValue14) == 0x000020, "Member 'Results_TeamScore_C_ExecuteUbergraph_Results_TeamScore::CallFunc_BooleanOR_ReturnValue14' has a wrong offset!");
static_assert(offsetof(Results_TeamScore_C_ExecuteUbergraph_Results_TeamScore, CallFunc_BooleanOR_ReturnValue15) == 0x000021, "Member 'Results_TeamScore_C_ExecuteUbergraph_Results_TeamScore::CallFunc_BooleanOR_ReturnValue15' has a wrong offset!");
static_assert(offsetof(Results_TeamScore_C_ExecuteUbergraph_Results_TeamScore, CallFunc_PlayAnimationAtTime_ReturnValue1) == 0x000028, "Member 'Results_TeamScore_C_ExecuteUbergraph_Results_TeamScore::CallFunc_PlayAnimationAtTime_ReturnValue1' has a wrong offset!");
static_assert(offsetof(Results_TeamScore_C_ExecuteUbergraph_Results_TeamScore, CallFunc_PlayAnimationAtTime_ReturnValue2) == 0x000030, "Member 'Results_TeamScore_C_ExecuteUbergraph_Results_TeamScore::CallFunc_PlayAnimationAtTime_ReturnValue2' has a wrong offset!");
static_assert(offsetof(Results_TeamScore_C_ExecuteUbergraph_Results_TeamScore, CallFunc_BooleanOR_ReturnValue16) == 0x000038, "Member 'Results_TeamScore_C_ExecuteUbergraph_Results_TeamScore::CallFunc_BooleanOR_ReturnValue16' has a wrong offset!");
static_assert(offsetof(Results_TeamScore_C_ExecuteUbergraph_Results_TeamScore, CallFunc_BooleanOR_ReturnValue17) == 0x000039, "Member 'Results_TeamScore_C_ExecuteUbergraph_Results_TeamScore::CallFunc_BooleanOR_ReturnValue17' has a wrong offset!");
static_assert(offsetof(Results_TeamScore_C_ExecuteUbergraph_Results_TeamScore, K2Node_ComponentBoundEvent_Button) == 0x000040, "Member 'Results_TeamScore_C_ExecuteUbergraph_Results_TeamScore::K2Node_ComponentBoundEvent_Button' has a wrong offset!");
