...
static_assert(sizeof(AB_Thrower_Flame_AOE_C) == 0x0005A8, "Wrong size on AB_Thrower_Flame_AOE_C");
static_assert(offsetof(AB_Thrower_Flame_AOE_C, UberGraphFrame) == 0x000568, "Member 'AB_Thrower_Flame_AOE_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AB_Thrower_Flame_AOE_C, Scene) == 0x000570, "Member 'AB_Thrower_Flame_AOE_C::Scene' has a wrong offset!");
static_assert(offsetof(AB_Thrower_Flame_AOE_C, Sphere) == 0x000578, "Member 'AB_Thrower_Flame_AOE_C::Sphere' has a wrong offset!");
static_assert(offsetof(AB_Thrower_Flame_AOE_C, Aoe_FX_Loop) == 0x000580, "Member 'AB_Thrower_Flame_AOE_C::Aoe_FX_Loop' has a wrong offset!");
static_assert(offsetof(AB_Thrower_Flame_AOE_C, Aoe_Sound_Cue) == 0x000588, "Member 'AB_Thrower_Flame_AOE_C::Aoe_Sound_Cue' has a wrong offset!");
static_assert(offsetof(AB_Thrower_Flame_AOE_C, StopRotX) == 0x000590, "Member 'AB_Thrower_Flame_AOE_C::StopRotX' has a wrong offset!");
static_assert(offsetof(AB_Thrower_Flame_AOE_C, StopLocatin) == 0x00059C, "Member 'AB_Thrower_Flame_AOE_C::StopLocatin' has a wrong offset!");
