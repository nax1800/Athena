...
public:
	...
	class UImage*                                 SpecialEventTitleImage;                            // 0x02B0(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UAthenaNews_C) == 0x0002D0, "Wrong size on UAthenaNews_C");
static_assert(offsetof(UAthenaNews_C, UberGraphFrame) == 0x000280, "Member 'UAthenaNews_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UAthenaNews_C, Intro) == 0x000288, "Member 'UAthenaNews_C::Intro' has a wrong offset!");
static_assert(offsetof(UAthenaNews_C, AthenaNewsTile) == 0x000290, "Member 'UAthenaNews_C::AthenaNewsTile' has a wrong offset!");
static_assert(offsetof(UAthenaNews_C, AthenaNewsTile_1) == 0x000298, "Member 'UAthenaNews_C::AthenaNewsTile_1' has a wrong offset!");
static_assert(offsetof(UAthenaNews_C, AthenaNewsTile_2) == 0x0002A0, "Member 'UAthenaNews_C::AthenaNewsTile_2' has a wrong offset!");
static_assert(offsetof(UAthenaNews_C, AthenaNewsTile_Spotlight) == 0x0002A8, "Member 'UAthenaNews_C::AthenaNewsTile_Spotlight' has a wrong offset!");
static_assert(offsetof(UAthenaNews_C, SpecialEventTitleImage) == 0x0002B0, "Member 'UAthenaNews_C::SpecialEventTitleImage' has a wrong offset!");
static_assert(offsetof(UAthenaNews_C, WidgetSwitcher_MoTD_Layout) == 0x0002B8, "Member 'UAthenaNews_C::WidgetSwitcher_MoTD_Layout' has a wrong offset!");
static_assert(offsetof(UAthenaNews_C, UpdateStyle) == 0x0002C0, "Member 'UAthenaNews_C::UpdateStyle' has a wrong offset!");
