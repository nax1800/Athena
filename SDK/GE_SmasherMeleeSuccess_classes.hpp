...
static_assert(alignof(UGE_SmasherMeleeSuccess_C) == 0x000008, "Wrong alignment on UGE_SmasherMeleeSuccess_C");
static_assert(sizeof(UGE_SmasherMeleeSuccess_C) == 0x000638, "Wrong size on UGE_SmasherMeleeSuccess_C");
