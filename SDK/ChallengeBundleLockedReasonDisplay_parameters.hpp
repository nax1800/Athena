...
static_assert(sizeof(ChallengeBundleLockedReasonDisplay_C_SetLockReason) == 0x000010, "Wrong size on ChallengeBundleLockedReasonDisplay_C_SetLockReason");
static_assert(offsetof(ChallengeBundleLockedReasonDisplay_C_SetLockReason, Value) == 0x000000, "Member 'ChallengeBundleLockedReasonDisplay_C_SetLockReason::Value' has a wrong offset!");
...
{
public:
	class FText                                   UnlockingSoon;                                     // 0x0000(0x0018)(Edit, BlueprintVisible)
	struct FTimespan                              CallFunc_GetTimespanValue_Result;                  // 0x0018(0x0008)(NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ChallengeBundleLockedReasonDisplay_C_UpdateLockReasonDisplay) == 0x000050, "Wrong size on ChallengeBundleLockedReasonDisplay_C_UpdateLockReasonDisplay");
static_assert(offsetof(ChallengeBundleLockedReasonDisplay_C_UpdateLockReasonDisplay, UnlockingSoon) == 0x000000, "Member 'ChallengeBundleLockedReasonDisplay_C_UpdateLockReasonDisplay::UnlockingSoon' has a wrong offset!");
static_assert(offsetof(ChallengeBundleLockedReasonDisplay_C_UpdateLockReasonDisplay, CallFunc_GetTimespanValue_Result) == 0x000018, "Member 'ChallengeBundleLockedReasonDisplay_C_UpdateLockReasonDisplay::CallFunc_GetTimespanValue_Result' has a wrong offset!");
...
static_assert(offsetof(ChallengeBundleLockedReasonDisplay_C_UpdateLockReasonDisplay, CallFunc_TextToUpper_ReturnValue) == 0x000038, "Member 'ChallengeBundleLockedReasonDisplay_C_UpdateLockReasonDisplay::CallFunc_TextToUpper_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ChallengeBundleLockedReasonDisplay_C_SetTimespanSource, K2Node_CreateDelegate_OutputDelegate) == 0x000028, "Member 'ChallengeBundleLockedReasonDisplay_C_SetTimespanSource::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
