...
static_assert(sizeof(ChallengeBundleLockedReasonDisplay_C_UpdateLockReasonDisplay) == 0x000038, "Wrong size on ChallengeBundleLockedReasonDisplay_C_UpdateLockReasonDisplay");
static_assert(offsetof(ChallengeBundleLockedReasonDisplay_C_UpdateLockReasonDisplay, CallFunc_GetTimespanValue_Result) == 0x000000, "Member 'ChallengeBundleLockedReasonDisplay_C_UpdateLockReasonDisplay::CallFunc_GetTimespanValue_Result' has a wrong offset!");
static_assert(offsetof(ChallengeBundleLockedReasonDisplay_C_UpdateLockReasonDisplay, CallFunc_FormatLockedReason_ReturnValue) == 0x000008, "Member 'ChallengeBundleLockedReasonDisplay_C_UpdateLockReasonDisplay::CallFunc_FormatLockedReason_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChallengeBundleLockedReasonDisplay_C_UpdateLockReasonDisplay, CallFunc_TextToUpper_ReturnValue) == 0x000020, "Member 'ChallengeBundleLockedReasonDisplay_C_UpdateLockReasonDisplay::CallFunc_TextToUpper_ReturnValue' has a wrong offset!");
