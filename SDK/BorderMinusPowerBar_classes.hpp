...
static_assert(alignof(UBorderMinusPowerBar_C) == 0x000010, "Wrong alignment on UBorderMinusPowerBar_C");
static_assert(sizeof(UBorderMinusPowerBar_C) == 0x0000F0, "Wrong size on UBorderMinusPowerBar_C");
