...
static_assert(alignof(ProjectileHuskLobber_C_ProjectileShot__DelegateSignature) == 0x000004, "Wrong alignment on ProjectileHuskLobber_C_ProjectileShot__DelegateSignature");
static_assert(sizeof(ProjectileHuskLobber_C_ProjectileShot__DelegateSignature) == 0x00000C, "Wrong size on ProjectileHuskLobber_C_ProjectileShot__DelegateSignature");
static_assert(offsetof(ProjectileHuskLobber_C_ProjectileShot__DelegateSignature, Location) == 0x000000, "Member 'ProjectileHuskLobber_C_ProjectileShot__DelegateSignature::Location' has a wrong offset!");
