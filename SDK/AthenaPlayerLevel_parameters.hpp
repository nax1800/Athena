...
static_assert(offsetof(AthenaPlayerLevel_C_ExecuteUbergraph_AthenaPlayerLevel, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000068, "Member 'AthenaPlayerLevel_C_ExecuteUbergraph_AthenaPlayerLevel::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaPlayerLevel_C_ExecuteUbergraph_AthenaPlayerLevel, CallFunc_PlayAnimationAtTime_ReturnValue1) == 0x000070, "Member 'AthenaPlayerLevel_C_ExecuteUbergraph_AthenaPlayerLevel::CallFunc_PlayAnimationAtTime_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(AthenaPlayerLevel_C_ExecuteUbergraph_AthenaPlayerLevel, CallFunc_PlayAnimationAtTime_ReturnValue2) == 0x0000C0, "Member 'AthenaPlayerLevel_C_ExecuteUbergraph_AthenaPlayerLevel::CallFunc_PlayAnimationAtTime_ReturnValue2' has a wrong offset!");
