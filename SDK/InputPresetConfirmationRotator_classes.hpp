...
static_assert(sizeof(UInputPresetConfirmationRotator_C) == 0x000250, "Wrong size on UInputPresetConfirmationRotator_C");
static_assert(offsetof(UInputPresetConfirmationRotator_C, UberGraphFrame) == 0x000210, "Member 'UInputPresetConfirmationRotator_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UInputPresetConfirmationRotator_C, ButtonLeft) == 0x000218, "Member 'UInputPresetConfirmationRotator_C::ButtonLeft' has a wrong offset!");
static_assert(offsetof(UInputPresetConfirmationRotator_C, ButtonRight) == 0x000220, "Member 'UInputPresetConfirmationRotator_C::ButtonRight' has a wrong offset!");
static_assert(offsetof(UInputPresetConfirmationRotator_C, Description) == 0x000228, "Member 'UInputPresetConfirmationRotator_C::Description' has a wrong offset!");
static_assert(offsetof(UInputPresetConfirmationRotator_C, Spacer_0) == 0x000230, "Member 'UInputPresetConfirmationRotator_C::Spacer_0' has a wrong offset!");
static_assert(offsetof(UInputPresetConfirmationRotator_C, SubDescription) == 0x000238, "Member 'UInputPresetConfirmationRotator_C::SubDescription' has a wrong offset!");
static_assert(offsetof(UInputPresetConfirmationRotator_C, TextRotator) == 0x000240, "Member 'UInputPresetConfirmationRotator_C::TextRotator' has a wrong offset!");
static_assert(offsetof(UInputPresetConfirmationRotator_C, SelectedIndex) == 0x000248, "Member 'UInputPresetConfirmationRotator_C::SelectedIndex' has a wrong offset!");
static_assert(offsetof(UInputPresetConfirmationRotator_C, Spacer_Width) == 0x00024C, "Member 'UInputPresetConfirmationRotator_C::Spacer_Width' has a wrong offset!");
