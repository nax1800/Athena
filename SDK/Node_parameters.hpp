...
static_assert(alignof(Node_C_SetSelectedState) == 0x000001, "Wrong alignment on Node_C_SetSelectedState");
static_assert(sizeof(Node_C_SetSelectedState) == 0x000009, "Wrong size on Node_C_SetSelectedState");
