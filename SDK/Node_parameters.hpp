...
static_assert(offsetof(Node_C_SetSelectedState, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000010, "Member 'Node_C_SetSelectedState::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
