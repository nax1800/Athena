...
static_assert(offsetof(UDailyQuestProgressWidget_C, ShowCompletionCheck) == 0x000242, "Member 'UDailyQuestProgressWidget_C::ShowCompletionCheck' has a wrong offset!");
