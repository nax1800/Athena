...
static_assert(sizeof(UGA_Athena_Bush_C) == 0x000980, "Wrong size on UGA_Athena_Bush_C");
static_assert(offsetof(UGA_Athena_Bush_C, UberGraphFrame) == 0x0008F8, "Member 'UGA_Athena_Bush_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_Athena_Bush_C, AnimMontageInfo) == 0x000900, "Member 'UGA_Athena_Bush_C::AnimMontageInfo' has a wrong offset!");
static_assert(offsetof(UGA_Athena_Bush_C, PlayerPawn) == 0x000960, "Member 'UGA_Athena_Bush_C::PlayerPawn' has a wrong offset!");
static_assert(offsetof(UGA_Athena_Bush_C, TriggerDuration) == 0x000968, "Member 'UGA_Athena_Bush_C::TriggerDuration' has a wrong offset!");
static_assert(offsetof(UGA_Athena_Bush_C, UseBushObjectiveStat) == 0x000970, "Member 'UGA_Athena_Bush_C::UseBushObjectiveStat' has a wrong offset!");
