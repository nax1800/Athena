...
// Function Results_CommanderXPBar.Results_CommanderXPBar_C.WidgetAnimationEvt_Anim_Intro_K2Node_WidgetAnimationEvent_0
// (BlueprintEvent)

void UResults_CommanderXPBar_C::WidgetAnimationEvt_Anim_Intro_K2Node_WidgetAnimationEvent_0()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Results_CommanderXPBar_C", "WidgetAnimationEvt_Anim_Intro_K2Node_WidgetAnimationEvent_0");
...
void UResults_CommanderXPBar_C::UpdateCommanderLevel()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Results_CommanderXPBar_C", "UpdateCommanderLevel");
