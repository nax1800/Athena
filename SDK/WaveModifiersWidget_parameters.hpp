...
static_assert(sizeof(WaveModifiersWidget_C_PresentNextModifier) == 0x000028, "Wrong size on WaveModifiersWidget_C_PresentNextModifier");
static_assert(offsetof(WaveModifiersWidget_C_PresentNextModifier, Temp_int_Variable) == 0x000000, "Member 'WaveModifiersWidget_C_PresentNextModifier::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(WaveModifiersWidget_C_PresentNextModifier, CallFunc_Array_Get_Item) == 0x000008, "Member 'WaveModifiersWidget_C_PresentNextModifier::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(WaveModifiersWidget_C_PresentNextModifier, CallFunc_Array_IsValidIndex_ReturnValue) == 0x000010, "Member 'WaveModifiersWidget_C_PresentNextModifier::CallFunc_Array_IsValidIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(WaveModifiersWidget_C_PresentNextModifier, CallFunc_AddChildToVerticalBox_ReturnValue) == 0x000018, "Member 'WaveModifiersWidget_C_PresentNextModifier::CallFunc_AddChildToVerticalBox_ReturnValue' has a wrong offset!");
static_assert(offsetof(WaveModifiersWidget_C_PresentNextModifier, CallFunc_Add_IntInt_ReturnValue) == 0x000020, "Member 'WaveModifiersWidget_C_PresentNextModifier::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
