...
static_assert(sizeof(UGA_Ranged_GenericDamage_C) == 0x000938, "Wrong size on UGA_Ranged_GenericDamage_C");
static_assert(offsetof(UGA_Ranged_GenericDamage_C, GT_EventWeaponFire) == 0x000930, "Member 'UGA_Ranged_GenericDamage_C::GT_EventWeaponFire' has a wrong offset!");
