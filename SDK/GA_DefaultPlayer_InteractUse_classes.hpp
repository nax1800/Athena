...
static_assert(sizeof(UGA_DefaultPlayer_InteractUse_C) == 0x000900, "Wrong size on UGA_DefaultPlayer_InteractUse_C");
static_assert(offsetof(UGA_DefaultPlayer_InteractUse_C, UberGraphFrame) == 0x0008F8, "Member 'UGA_DefaultPlayer_InteractUse_C::UberGraphFrame' has a wrong offset!");
