...
static_assert(offsetof(GAB_AIBaseMelee_NoMontage_C_ExecuteUbergraph_GAB_AIBaseMelee_NoMontage, K2Node_CreateDelegate_OutputDelegate) == 0x000008, "Member 'GAB_AIBaseMelee_NoMontage_C_ExecuteUbergraph_GAB_AIBaseMelee_NoMontage::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
