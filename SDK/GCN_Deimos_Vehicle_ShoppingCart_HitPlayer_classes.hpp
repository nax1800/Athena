...
{
public:
	class USoundConcurrency*                      ConcurrencySettings;                               // 0x01A8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UGCN_Deimos_Vehicle_ShoppingCart_HitPlayer_C) == 0x0001B0, "Wrong size on UGCN_Deimos_Vehicle_ShoppingCart_HitPlayer_C");
static_assert(offsetof(UGCN_Deimos_Vehicle_ShoppingCart_HitPlayer_C, ConcurrencySettings) == 0x0001A8, "Member 'UGCN_Deimos_Vehicle_ShoppingCart_HitPlayer_C::ConcurrencySettings' has a wrong offset!");
