...
static_assert(sizeof(UItemStackCounter_C) == 0x0007E0, "Wrong size on UItemStackCounter_C");
...
static_assert(offsetof(UItemStackCounter_C, MultiSizeFont) == 0x000560, "Member 'UItemStackCounter_C::MultiSizeFont' has a wrong offset!");
static_assert(offsetof(UItemStackCounter_C, MultiSizeMargin) == 0x000770, "Member 'UItemStackCounter_C::MultiSizeMargin' has a wrong offset!");
static_assert(offsetof(UItemStackCounter_C, Brush_Size) == 0x0007D0, "Member 'UItemStackCounter_C::Brush_Size' has a wrong offset!");
static_assert(offsetof(UItemStackCounter_C, Count) == 0x0007D4, "Member 'UItemStackCounter_C::Count' has a wrong offset!");
static_assert(offsetof(UItemStackCounter_C, AlwaysVisible) == 0x0007D8, "Member 'UItemStackCounter_C::AlwaysVisible' has a wrong offset!");
static_assert(offsetof(UItemStackCounter_C, TruncateValue) == 0x0007D9, "Member 'UItemStackCounter_C::TruncateValue' has a wrong offset!");
static_assert(offsetof(UItemStackCounter_C, VisibilityWithNoStack) == 0x0007DA, "Member 'UItemStackCounter_C::VisibilityWithNoStack' has a wrong offset!");
