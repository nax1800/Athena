...
public:
	...
	const class UFortItemComponent_Pickup*        CallFunc_GetItemComponentByClass_ReturnValue;      // 0x0358(0x0008)(ConstParm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(B_Pickups_Parent_C_ExecuteUbergraph_B_Pickups_Parent) == 0x000378, "Wrong size on B_Pickups_Parent_C_ExecuteUbergraph_B_Pickups_Parent");
