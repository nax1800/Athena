...
static_assert(sizeof(UItemEntry_C) == 0x000B48, "Wrong size on UItemEntry_C");
static_assert(offsetof(UItemEntry_C, UberGraphFrame) == 0x000B28, "Member 'UItemEntry_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UItemEntry_C, Name_0) == 0x000B30, "Member 'UItemEntry_C::Name_0' has a wrong offset!");
static_assert(offsetof(UItemEntry_C, Entry_Selected) == 0x000B38, "Member 'UItemEntry_C::Entry_Selected' has a wrong offset!");
