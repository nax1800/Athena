...
void AMinigameMode_FiringRangeV2_C::K2_PreGameTransitionEvent()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("MinigameMode_FiringRangeV2_C", "K2_PreGameTransitionEvent");
...
void AMinigameMode_FiringRangeV2_C::HandleMinigameEnded()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("MinigameMode_FiringRangeV2_C", "HandleMinigameEnded");
...
void AMinigameMode_FiringRangeV2_C::Timer_Expired()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("MinigameMode_FiringRangeV2_C", "Timer Expired");
