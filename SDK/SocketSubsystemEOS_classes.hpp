...
public:
	...
	uint8                                         Pad_8F2[0x6];                                      // 0x08F2(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UNetDriverEOSBase) == 0x0008F8, "Wrong size on UNetDriverEOSBase");
