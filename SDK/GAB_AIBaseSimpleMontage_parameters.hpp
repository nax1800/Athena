...
static_assert(offsetof(GAB_AIBaseSimpleMontage_C_ExecuteUbergraph_GAB_AIBaseSimpleMontage, K2Node_CustomEvent_TargetData2) == 0x000028, "Member 'GAB_AIBaseSimpleMontage_C_ExecuteUbergraph_GAB_AIBaseSimpleMontage::K2Node_CustomEvent_TargetData2' has a wrong offset!");
static_assert(offsetof(GAB_AIBaseSimpleMontage_C_ExecuteUbergraph_GAB_AIBaseSimpleMontage, K2Node_CustomEvent_ApplicationTag2) == 0x000048, "Member 'GAB_AIBaseSimpleMontage_C_ExecuteUbergraph_GAB_AIBaseSimpleMontage::K2Node_CustomEvent_ApplicationTag2' has a wrong offset!");
...
static_assert(offsetof(GAB_AIBaseSimpleMontage_C_ExecuteUbergraph_GAB_AIBaseSimpleMontage, K2Node_CreateDelegate_OutputDelegate2) == 0x000088, "Member 'GAB_AIBaseSimpleMontage_C_ExecuteUbergraph_GAB_AIBaseSimpleMontage::K2Node_CreateDelegate_OutputDelegate2' has a wrong offset!");
