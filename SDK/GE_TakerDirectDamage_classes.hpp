...
static_assert(alignof(UGE_TakerDirectDamage_C) == 0x000008, "Wrong alignment on UGE_TakerDirectDamage_C");
static_assert(sizeof(UGE_TakerDirectDamage_C) == 0x000638, "Wrong size on UGE_TakerDirectDamage_C");
