...
static_assert(sizeof(SmallLevelUpReward_C_SetupReward) == 0x000070, "Wrong size on SmallLevelUpReward_C_SetupReward");
...
static_assert(offsetof(SmallLevelUpReward_C_SetupReward, CallFunc_GetOrLoadSynchronously_ReturnValue) == 0x000060, "Member 'SmallLevelUpReward_C_SetupReward::CallFunc_GetOrLoadSynchronously_ReturnValue' has a wrong offset!");
static_assert(offsetof(SmallLevelUpReward_C_SetupReward, Temp_byte_Variable1) == 0x000068, "Member 'SmallLevelUpReward_C_SetupReward::Temp_byte_Variable1' has a wrong offset!");
static_assert(offsetof(SmallLevelUpReward_C_SetupReward, Temp_bool_Variable) == 0x000069, "Member 'SmallLevelUpReward_C_SetupReward::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(SmallLevelUpReward_C_SetupReward, K2Node_Select_Default) == 0x00006A, "Member 'SmallLevelUpReward_C_SetupReward::K2Node_Select_Default' has a wrong offset!");
