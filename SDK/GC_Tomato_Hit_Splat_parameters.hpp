...
static_assert(offsetof(GC_Tomato_Hit_Splat_C_OnBurst, CallFunc_K2_SetWorldRotation_SweepHitResult) == 0x000120, "Member 'GC_Tomato_Hit_Splat_C_OnBurst::CallFunc_K2_SetWorldRotation_SweepHitResult' has a wrong offset!");
