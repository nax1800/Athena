...
static_assert(sizeof(UMonthlyVIPBadgeTooltip_C) == 0x000238, "Wrong size on UMonthlyVIPBadgeTooltip_C");
static_assert(offsetof(UMonthlyVIPBadgeTooltip_C, HBoxBoost) == 0x000230, "Member 'UMonthlyVIPBadgeTooltip_C::HBoxBoost' has a wrong offset!");
