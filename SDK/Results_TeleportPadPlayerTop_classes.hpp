...
static_assert(sizeof(UResults_TeleportPadPlayerTop_C) == 0x000258, "Wrong size on UResults_TeleportPadPlayerTop_C");
...
static_assert(offsetof(UResults_TeleportPadPlayerTop_C, Image_Platform) == 0x000228, "Member 'UResults_TeleportPadPlayerTop_C::Image_Platform' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayerTop_C, PlayerBanner) == 0x000230, "Member 'UResults_TeleportPadPlayerTop_C::PlayerBanner' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayerTop_C, PowerWidget) == 0x000238, "Member 'UResults_TeleportPadPlayerTop_C::PowerWidget' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayerTop_C, ProgressBar) == 0x000240, "Member 'UResults_TeleportPadPlayerTop_C::ProgressBar' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayerTop_C, TextName) == 0x000248, "Member 'UResults_TeleportPadPlayerTop_C::TextName' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayerTop_C, TextXPAmount) == 0x000250, "Member 'UResults_TeleportPadPlayerTop_C::TextXPAmount' has a wrong offset!");
