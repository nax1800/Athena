...
static_assert(offsetof(MessageCenterWidget_C_ExecuteUbergraph_MessageCenterWidget, K2Node_ComponentBoundEvent_Button2) == 0x000028, "Member 'MessageCenterWidget_C_ExecuteUbergraph_MessageCenterWidget::K2Node_ComponentBoundEvent_Button2' has a wrong offset!");
...
static_assert(offsetof(MessageCenterWidget_C_ExecuteUbergraph_MessageCenterWidget, CallFunc_BP_GetSelectedItem_ReturnValue) == 0x000060, "Member 'MessageCenterWidget_C_ExecuteUbergraph_MessageCenterWidget::CallFunc_BP_GetSelectedItem_ReturnValue' has a wrong offset!");
static_assert(offsetof(MessageCenterWidget_C_ExecuteUbergraph_MessageCenterWidget, CallFunc_BP_GetSelectedItem_ReturnValue1) == 0x000068, "Member 'MessageCenterWidget_C_ExecuteUbergraph_MessageCenterWidget::CallFunc_BP_GetSelectedItem_ReturnValue1' has a wrong offset!");
