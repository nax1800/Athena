...
// Parameters:
// float                                   Param_Kills                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AB_Melee_Impact_Pickaxe_15_CandyCane_Parent_C::TurnOnLights(float Param_Kills)
{
	static class UFunction* Func = nullptr;
