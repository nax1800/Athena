...
static_assert(offsetof(AthenaNews_C_ExecuteUbergraph_AthenaNews, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000008, "Member 'AthenaNews_C_ExecuteUbergraph_AthenaNews::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
