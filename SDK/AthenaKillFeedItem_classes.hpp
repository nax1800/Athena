...
{
public:
	class URichTextBlock*                         KillText;                                          // 0x0258(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UAthenaKillFeedItem_C) == 0x000260, "Wrong size on UAthenaKillFeedItem_C");
static_assert(offsetof(UAthenaKillFeedItem_C, KillText) == 0x000258, "Member 'UAthenaKillFeedItem_C::KillText' has a wrong offset!");
