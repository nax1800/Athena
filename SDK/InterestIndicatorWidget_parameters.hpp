...
static_assert(sizeof(InterestIndicatorWidget_C_InitPointOfInterest) == 0x000040, "Wrong size on InterestIndicatorWidget_C_InitPointOfInterest");
...
static_assert(offsetof(InterestIndicatorWidget_C_InitPointOfInterest, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000028, "Member 'InterestIndicatorWidget_C_InitPointOfInterest::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
static_assert(offsetof(InterestIndicatorWidget_C_InitPointOfInterest, CallFunc_PlayAnimationAtTime_ReturnValue1) == 0x000030, "Member 'InterestIndicatorWidget_C_InitPointOfInterest::CallFunc_PlayAnimationAtTime_ReturnValue1' has a wrong offset!");
static_assert(offsetof(InterestIndicatorWidget_C_InitPointOfInterest, CallFunc_NotEqual_ObjectObject_ReturnValue) == 0x000038, "Member 'InterestIndicatorWidget_C_InitPointOfInterest::CallFunc_NotEqual_ObjectObject_ReturnValue' has a wrong offset!");
