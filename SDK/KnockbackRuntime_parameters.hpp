...
static_assert(sizeof(FortAthenaMutator_Knockback_HandleBlockedCharacterMovement) == 0x0000F8, "Wrong size on FortAthenaMutator_Knockback_HandleBlockedCharacterMovement");
