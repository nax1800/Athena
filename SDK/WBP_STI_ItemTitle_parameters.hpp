...
static_assert(sizeof(WBP_STI_ItemTitle_C_Update_Subheading) == 0x000028, "Wrong size on WBP_STI_ItemTitle_C_Update_Subheading");
...
static_assert(sizeof(WBP_STI_ItemTitle_C_Update_Subscribed_Tag) == 0x000048, "Wrong size on WBP_STI_ItemTitle_C_Update_Subscribed_Tag");
