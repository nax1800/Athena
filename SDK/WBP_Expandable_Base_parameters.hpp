...
static_assert(sizeof(WBP_Expandable_Base_C_ExecuteUbergraph_WBP_Expandable_Base) == 0x000030, "Wrong size on WBP_Expandable_Base_C_ExecuteUbergraph_WBP_Expandable_Base");
