...
static_assert(sizeof(SquadStatsWidget_C_ToggleBetweenStats) == 0x000028, "Wrong size on SquadStatsWidget_C_ToggleBetweenStats");
...
static_assert(offsetof(SquadStatsWidget_C_ToggleBetweenStats, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000018, "Member 'SquadStatsWidget_C_ToggleBetweenStats::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
static_assert(offsetof(SquadStatsWidget_C_ToggleBetweenStats, CallFunc_Not_PreBool_ReturnValue) == 0x000020, "Member 'SquadStatsWidget_C_ToggleBetweenStats::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
...
static_assert(alignof(SquadStatsWidget_C_ShowOrHideBonuses) == 0x000008, "Wrong alignment on SquadStatsWidget_C_ShowOrHideBonuses");
static_assert(sizeof(SquadStatsWidget_C_ShowOrHideBonuses) == 0x000040, "Wrong size on SquadStatsWidget_C_ShowOrHideBonuses");
static_assert(offsetof(SquadStatsWidget_C_ShowOrHideBonuses, Temp_byte_Variable) == 0x000000, "Member 'SquadStatsWidget_C_ShowOrHideBonuses::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(SquadStatsWidget_C_ShowOrHideBonuses, Temp_byte_Variable1) == 0x000001, "Member 'SquadStatsWidget_C_ShowOrHideBonuses::Temp_byte_Variable1' has a wrong offset!");
static_assert(offsetof(SquadStatsWidget_C_ShowOrHideBonuses, Temp_bool_Variable) == 0x000002, "Member 'SquadStatsWidget_C_ShowOrHideBonuses::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(SquadStatsWidget_C_ShowOrHideBonuses, K2Node_MakeStruct_SlateChildSize) == 0x000004, "Member 'SquadStatsWidget_C_ShowOrHideBonuses::K2Node_MakeStruct_SlateChildSize' has a wrong offset!");
static_assert(offsetof(SquadStatsWidget_C_ShowOrHideBonuses, K2Node_MakeStruct_SlateChildSize1) == 0x00000C, "Member 'SquadStatsWidget_C_ShowOrHideBonuses::K2Node_MakeStruct_SlateChildSize1' has a wrong offset!");
static_assert(offsetof(SquadStatsWidget_C_ShowOrHideBonuses, CallFunc_SlotAsVerticalBoxSlot_ReturnValue) == 0x000018, "Member 'SquadStatsWidget_C_ShowOrHideBonuses::CallFunc_SlotAsVerticalBoxSlot_ReturnValue' has a wrong offset!");
static_assert(offsetof(SquadStatsWidget_C_ShowOrHideBonuses, CallFunc_SlotAsVerticalBoxSlot_ReturnValue1) == 0x000020, "Member 'SquadStatsWidget_C_ShowOrHideBonuses::CallFunc_SlotAsVerticalBoxSlot_ReturnValue1' has a wrong offset!");
static_assert(offsetof(SquadStatsWidget_C_ShowOrHideBonuses, CallFunc_GetContext_ReturnValue) == 0x000028, "Member 'SquadStatsWidget_C_ShowOrHideBonuses::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(SquadStatsWidget_C_ShowOrHideBonuses, CallFunc_GetTotalItemQuantityByDefinition_ReturnValue) == 0x000030, "Member 'SquadStatsWidget_C_ShowOrHideBonuses::CallFunc_GetTotalItemQuantityByDefinition_ReturnValue' has a wrong offset!");
static_assert(offsetof(SquadStatsWidget_C_ShowOrHideBonuses, CallFunc_GetTotalItemQuantityByDefinition_ReturnValue1) == 0x000034, "Member 'SquadStatsWidget_C_ShowOrHideBonuses::CallFunc_GetTotalItemQuantityByDefinition_ReturnValue1' has a wrong offset!");
static_assert(offsetof(SquadStatsWidget_C_ShowOrHideBonuses, CallFunc_LessEqual_IntInt_ReturnValue) == 0x000038, "Member 'SquadStatsWidget_C_ShowOrHideBonuses::CallFunc_LessEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(SquadStatsWidget_C_ShowOrHideBonuses, CallFunc_LessEqual_IntInt_ReturnValue1) == 0x000039, "Member 'SquadStatsWidget_C_ShowOrHideBonuses::CallFunc_LessEqual_IntInt_ReturnValue1' has a wrong offset!");
static_assert(offsetof(SquadStatsWidget_C_ShowOrHideBonuses, CallFunc_BooleanAND_ReturnValue) == 0x00003A, "Member 'SquadStatsWidget_C_ShowOrHideBonuses::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(SquadStatsWidget_C_ShowOrHideBonuses, K2Node_Select_Default) == 0x00003B, "Member 'SquadStatsWidget_C_ShowOrHideBonuses::K2Node_Select_Default' has a wrong offset!");
