...
// Function Results_Badge.Results_Badge_C.WidgetAnimationEvt_Anim_Convert_K2Node_WidgetAnimationEvent_0
// (BlueprintEvent)

void UResults_Badge_C::WidgetAnimationEvt_Anim_Convert_K2Node_WidgetAnimationEvent_0()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Results_Badge_C", "WidgetAnimationEvt_Anim_Convert_K2Node_WidgetAnimationEvent_0");
