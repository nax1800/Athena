...
static_assert(sizeof(UCommonButton) == 0x000B28, "Wrong size on UCommonButton");
...
static_assert(offsetof(UCommonTextBlock, Style) == 0x000210, "Member 'UCommonTextBlock::Style' has a wrong offset!");
static_assert(offsetof(UCommonTextBlock, ScrollStyle) == 0x000218, "Member 'UCommonTextBlock::ScrollStyle' has a wrong offset!");
...
static_assert(sizeof(UCommonNumericTextBlock) == 0x0002E0, "Wrong size on UCommonNumericTextBlock");
static_assert(offsetof(UCommonNumericTextBlock, OnOutroEvent) == 0x000260, "Member 'UCommonNumericTextBlock::OnOutroEvent' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, OnInterpolationEndedEvent) == 0x000270, "Member 'UCommonNumericTextBlock::OnInterpolationEndedEvent' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, CurrentNumericValue) == 0x000280, "Member 'UCommonNumericTextBlock::CurrentNumericValue' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, NumericType) == 0x000284, "Member 'UCommonNumericTextBlock::NumericType' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, FormattingSpecification) == 0x000288, "Member 'UCommonNumericTextBlock::FormattingSpecification' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, EaseOutInterpolationExponent) == 0x00029C, "Member 'UCommonNumericTextBlock::EaseOutInterpolationExponent' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, InterpolationUpdateInterval) == 0x0002A0, "Member 'UCommonNumericTextBlock::InterpolationUpdateInterval' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, PostInterpolationShrinkDuration) == 0x0002A4, "Member 'UCommonNumericTextBlock::PostInterpolationShrinkDuration' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, PerformSizeInterpolation) == 0x0002A8, "Member 'UCommonNumericTextBlock::PerformSizeInterpolation' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, IsPercentage) == 0x0002A9, "Member 'UCommonNumericTextBlock::IsPercentage' has a wrong offset!");
...
static_assert(sizeof(UCommonPopupButton) == 0x000B38, "Wrong size on UCommonPopupButton");
static_assert(offsetof(UCommonPopupButton, PopupMenuAnchor) == 0x000B28, "Member 'UCommonPopupButton::PopupMenuAnchor' has a wrong offset!");
static_assert(offsetof(UCommonPopupButton, PopupMenu) == 0x000B30, "Member 'UCommonPopupButton::PopupMenu' has a wrong offset!");
...
static_assert(sizeof(UCommonRotator) == 0x000B68, "Wrong size on UCommonRotator");
static_assert(offsetof(UCommonRotator, OnRotated) == 0x000B38, "Member 'UCommonRotator::OnRotated' has a wrong offset!");
static_assert(offsetof(UCommonRotator, MyText) == 0x000B48, "Member 'UCommonRotator::MyText' has a wrong offset!");
...
static_assert(sizeof(UCommonTextStyle) == 0x0000B8, "Wrong size on UCommonTextStyle");
...
static_assert(offsetof(UCommonTextStyle, LineHeightPercentage) == 0x0000B4, "Member 'UCommonTextStyle::LineHeightPercentage' has a wrong offset!");
...
static_assert(offsetof(UCommonUIInputData, InputKeyDataMap) == 0x000038, "Member 'UCommonUIInputData::InputKeyDataMap' has a wrong offset!");
...
static_assert(offsetof(UCommonUISettings, DefaultTextStyle) == 0x000030, "Member 'UCommonUISettings::DefaultTextStyle' has a wrong offset!");
static_assert(offsetof(UCommonUISettings, DefaultButtonStyle) == 0x000058, "Member 'UCommonUISettings::DefaultButtonStyle' has a wrong offset!");
...
static_assert(offsetof(UCommonUISettings, DefaultImageResourceObject) == 0x0000A8, "Member 'UCommonUISettings::DefaultImageResourceObject' has a wrong offset!");
static_assert(offsetof(UCommonUISettings, DefaultThrobberMaterial) == 0x0000D0, "Member 'UCommonUISettings::DefaultThrobberMaterial' has a wrong offset!");
static_assert(offsetof(UCommonUISettings, InputData) == 0x0000F8, "Member 'UCommonUISettings::InputData' has a wrong offset!");
static_assert(offsetof(UCommonUISettings, DefaultTextStyleClass) == 0x000128, "Member 'UCommonUISettings::DefaultTextStyleClass' has a wrong offset!");
static_assert(offsetof(UCommonUISettings, DefaultButtonStyleClass) == 0x000130, "Member 'UCommonUISettings::DefaultButtonStyleClass' has a wrong offset!");
static_assert(offsetof(UCommonUISettings, DefaultBorderStyleClass) == 0x000138, "Member 'UCommonUISettings::DefaultBorderStyleClass' has a wrong offset!");
static_assert(offsetof(UCommonUISettings, DefaultImageResourceObjectInstance) == 0x000140, "Member 'UCommonUISettings::DefaultImageResourceObjectInstance' has a wrong offset!");
static_assert(offsetof(UCommonUISettings, DefaultThrobberMaterialInstance) == 0x000148, "Member 'UCommonUISettings::DefaultThrobberMaterialInstance' has a wrong offset!");
static_assert(offsetof(UCommonUISettings, DefaultThrobberBrush) == 0x000150, "Member 'UCommonUISettings::DefaultThrobberBrush' has a wrong offset!");
static_assert(offsetof(UCommonUISettings, InputDataClass) == 0x0001D8, "Member 'UCommonUISettings::InputDataClass' has a wrong offset!");
