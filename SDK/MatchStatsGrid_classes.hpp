...
static_assert(sizeof(UMatchStatsGrid_C) == 0x000210, "Wrong size on UMatchStatsGrid_C");
static_assert(offsetof(UMatchStatsGrid_C, ProfileStatBox) == 0x000208, "Member 'UMatchStatsGrid_C::ProfileStatBox' has a wrong offset!");
