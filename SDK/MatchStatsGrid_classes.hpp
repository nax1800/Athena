...
{
public:
	class UAthenaProfileStatBox*                  ProfileStatBox;                                    // 0x0228(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UMatchStatsGrid_C) == 0x000230, "Wrong size on UMatchStatsGrid_C");
static_assert(offsetof(UMatchStatsGrid_C, ProfileStatBox) == 0x000228, "Member 'UMatchStatsGrid_C::ProfileStatBox' has a wrong offset!");
