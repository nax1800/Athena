...
static_assert(sizeof(UCollectionBarTopIcon_C) == 0x0002C8, "Wrong size on UCollectionBarTopIcon_C");
static_assert(offsetof(UCollectionBarTopIcon_C, UberGraphFrame) == 0x000230, "Member 'UCollectionBarTopIcon_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UCollectionBarTopIcon_C, Icon) == 0x000238, "Member 'UCollectionBarTopIcon_C::Icon' has a wrong offset!");
static_assert(offsetof(UCollectionBarTopIcon_C, IconBrush) == 0x000240, "Member 'UCollectionBarTopIcon_C::IconBrush' has a wrong offset!");
