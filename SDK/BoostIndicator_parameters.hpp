...
public:
	...
	struct FFortTeamMemberInfo                    CallFunc_Array_Get_Item;                           // 0x0040(0x01F8)(HasGetValueTypeHash)
	bool                                          CallFunc_Less_IntInt_ReturnValue;                  // 0x0238(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsLocalPlayersUniqueID_ReturnValue;       // 0x0239(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(sizeof(BoostIndicator_C_IsPartyMemberBoosted) == 0x000240, "Wrong size on BoostIndicator_C_IsPartyMemberBoosted");
...
static_assert(offsetof(BoostIndicator_C_IsPartyMemberBoosted, CallFunc_Less_IntInt_ReturnValue) == 0x000238, "Member 'BoostIndicator_C_IsPartyMemberBoosted::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BoostIndicator_C_IsPartyMemberBoosted, CallFunc_IsLocalPlayersUniqueID_ReturnValue) == 0x000239, "Member 'BoostIndicator_C_IsPartyMemberBoosted::CallFunc_IsLocalPlayersUniqueID_ReturnValue' has a wrong offset!");
