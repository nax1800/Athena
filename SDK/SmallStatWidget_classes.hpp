...
static_assert(sizeof(USmallStatWidget_C) == 0x000258, "Wrong size on USmallStatWidget_C");
static_assert(offsetof(USmallStatWidget_C, UberGraphFrame) == 0x000240, "Member 'USmallStatWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(USmallStatWidget_C, StatImage) == 0x000248, "Member 'USmallStatWidget_C::StatImage' has a wrong offset!");
static_assert(offsetof(USmallStatWidget_C, StatValue) == 0x000250, "Member 'USmallStatWidget_C::StatValue' has a wrong offset!");
