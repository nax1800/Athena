...
static_assert(sizeof(UMissionTrackerSubEntry_C) == 0x0003D8, "Wrong size on UMissionTrackerSubEntry_C");
...
static_assert(offsetof(UMissionTrackerSubEntry_C, DefaultNonHUDBulletBrush) == 0x000350, "Member 'UMissionTrackerSubEntry_C::DefaultNonHUDBulletBrush' has a wrong offset!");
