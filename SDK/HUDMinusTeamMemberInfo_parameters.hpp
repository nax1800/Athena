...
static_assert(sizeof(HUDMinusTeamMemberInfo_C_ExecuteUbergraph_HUDMinusTeamMemberInfo) == 0x000220, "Wrong size on HUDMinusTeamMemberInfo_C_ExecuteUbergraph_HUDMinusTeamMemberInfo");
...
static_assert(offsetof(HUDMinusTeamMemberInfo_C_ExecuteUbergraph_HUDMinusTeamMemberInfo, K2Node_CreateDelegate_OutputDelegate) == 0x000008, "Member 'HUDMinusTeamMemberInfo_C_ExecuteUbergraph_HUDMinusTeamMemberInfo::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
...
static_assert(offsetof(HUDMinusTeamMemberInfo_C_ExecuteUbergraph_HUDMinusTeamMemberInfo, CallFunc_GetContext_ReturnValue) == 0x000210, "Member 'HUDMinusTeamMemberInfo_C_ExecuteUbergraph_HUDMinusTeamMemberInfo::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUDMinusTeamMemberInfo_C_ExecuteUbergraph_HUDMinusTeamMemberInfo, CallFunc_GetLocalPlayerTeam_ReturnValue) == 0x000218, "Member 'HUDMinusTeamMemberInfo_C_ExecuteUbergraph_HUDMinusTeamMemberInfo::CallFunc_GetLocalPlayerTeam_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(HUDMinusTeamMemberInfo_C_OnPlayerInfoChanged) == 0x0001F8, "Wrong size on HUDMinusTeamMemberInfo_C_OnPlayerInfoChanged");
