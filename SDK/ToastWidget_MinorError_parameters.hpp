...
public:
	...
	class UUMGSequencePlayer*                     CallFunc_PlayAnimationAtTime_ReturnValue;          // 0x0140(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(ToastWidget_MinorError_C_ExecuteUbergraph_ToastWidget_MinorError, K2Node_CreateDelegate_OutputDelegate) == 0x000008, "Member 'ToastWidget_MinorError_C_ExecuteUbergraph_ToastWidget_MinorError::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
...
static_assert(offsetof(ToastWidget_MinorError_C_ExecuteUbergraph_ToastWidget_MinorError, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000140, "Member 'ToastWidget_MinorError_C_ExecuteUbergraph_ToastWidget_MinorError::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ToastWidget_MinorError_C_StartIntro, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000000, "Member 'ToastWidget_MinorError_C_StartIntro::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
...
static_assert(alignof(ToastWidget_MinorError_C_SetupAnimBindings) == 0x000008, "Wrong alignment on ToastWidget_MinorError_C_SetupAnimBindings");
static_assert(sizeof(ToastWidget_MinorError_C_SetupAnimBindings) == 0x000048, "Wrong size on ToastWidget_MinorError_C_SetupAnimBindings");
...
static_assert(offsetof(ToastWidget_MinorError_C_SetupAnimBindings, K2Node_CreateDelegate_OutputDelegate) == 0x000008, "Member 'ToastWidget_MinorError_C_SetupAnimBindings::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(ToastWidget_MinorError_C_SetupAnimBindings, K2Node_CreateDelegate_OutputDelegate1) == 0x000018, "Member 'ToastWidget_MinorError_C_SetupAnimBindings::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
static_assert(offsetof(ToastWidget_MinorError_C_SetupAnimBindings, K2Node_CreateDelegate_OutputDelegate2) == 0x000028, "Member 'ToastWidget_MinorError_C_SetupAnimBindings::K2Node_CreateDelegate_OutputDelegate2' has a wrong offset!");
static_assert(offsetof(ToastWidget_MinorError_C_SetupAnimBindings, K2Node_CreateDelegate_OutputDelegate3) == 0x000038, "Member 'ToastWidget_MinorError_C_SetupAnimBindings::K2Node_CreateDelegate_OutputDelegate3' has a wrong offset!");
