...
static_assert(offsetof(ProfileStatsMatchesSubScreen_C_ExecuteUbergraph_ProfileStatsMatchesSubScreen, K2Node_CreateDelegate_OutputDelegate) == 0x000028, "Member 'ProfileStatsMatchesSubScreen_C_ExecuteUbergraph_ProfileStatsMatchesSubScreen::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(ProfileStatsMatchesSubScreen_C_ExecuteUbergraph_ProfileStatsMatchesSubScreen, K2Node_CreateDelegate_OutputDelegate1) == 0x000038, "Member 'ProfileStatsMatchesSubScreen_C_ExecuteUbergraph_ProfileStatsMatchesSubScreen::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
