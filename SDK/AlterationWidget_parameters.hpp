...
static_assert(offsetof(AlterationWidget_C_InitIcon, CallFunc_ResizeBrush_NewParam) == 0x000038, "Member 'AlterationWidget_C_InitIcon::CallFunc_ResizeBrush_NewParam' has a wrong offset!");
