...
static_assert(sizeof(ActiveModifiersHUD_C_PopulateModifiers) == 0x0000F8, "Wrong size on ActiveModifiersHUD_C_PopulateModifiers");
...
static_assert(offsetof(ActiveModifiersHUD_C_PopulateModifiers, CallFunc_Less_IntInt_ReturnValue) == 0x000064, "Member 'ActiveModifiersHUD_C_PopulateModifiers::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(ActiveModifiersHUD_C_PopulateModifiers, CallFunc_Not_PreBool_ReturnValue) == 0x000065, "Member 'ActiveModifiersHUD_C_PopulateModifiers::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ActiveModifiersHUD_C_PopulateModifiers, CallFunc_AddChildToHorizontalBox_ReturnValue) == 0x0000F0, "Member 'ActiveModifiersHUD_C_PopulateModifiers::CallFunc_AddChildToHorizontalBox_ReturnValue' has a wrong offset!");
