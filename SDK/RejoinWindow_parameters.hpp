...
static_assert(sizeof(RejoinWindow_C_ExecuteUbergraph_RejoinWindow) == 0x000048, "Wrong size on RejoinWindow_C_ExecuteUbergraph_RejoinWindow");
...
static_assert(offsetof(RejoinWindow_C_ExecuteUbergraph_RejoinWindow, CallFunc_IsUserCurrentlyBanned_ReturnValue) == 0x000040, "Member 'RejoinWindow_C_ExecuteUbergraph_RejoinWindow::CallFunc_IsUserCurrentlyBanned_ReturnValue' has a wrong offset!");
