...
static_assert(sizeof(GCNL_Athena_SCMachine_Active_C_ExecuteUbergraph_GCNL_Athena_SCMachine_Active) == 0x000448, "Wrong size on GCNL_Athena_SCMachine_Active_C_ExecuteUbergraph_GCNL_Athena_SCMachine_Active");
