...
static_assert(sizeof(AGCN_Loop_Ice_Deimos_C) == 0x0008A0, "Wrong size on AGCN_Loop_Ice_Deimos_C");
static_assert(offsetof(AGCN_Loop_Ice_Deimos_C, UberGraphFrame) == 0x000898, "Member 'AGCN_Loop_Ice_Deimos_C::UberGraphFrame' has a wrong offset!");
