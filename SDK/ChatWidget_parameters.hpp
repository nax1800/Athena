...
static_assert(offsetof(ChatWidget_C_BindDelegates, CallFunc_GetContext_ReturnValue2) == 0x000040, "Member 'ChatWidget_C_BindDelegates::CallFunc_GetContext_ReturnValue2' has a wrong offset!");
