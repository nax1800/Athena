...
static_assert(alignof(UTextStyleMinusBaseParent_C) == 0x000010, "Wrong alignment on UTextStyleMinusBaseParent_C");
static_assert(sizeof(UTextStyleMinusBaseParent_C) == 0x0001A0, "Wrong size on UTextStyleMinusBaseParent_C");
