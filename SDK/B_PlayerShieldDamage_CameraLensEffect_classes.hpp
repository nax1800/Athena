...
static_assert(sizeof(AB_PlayerShieldDamage_CameraLensEffect_C) == 0x0003F0, "Wrong size on AB_PlayerShieldDamage_CameraLensEffect_C");
static_assert(offsetof(AB_PlayerShieldDamage_CameraLensEffect_C, UberGraphFrame_B_PlayerShieldDamage_CameraLensEffect_C) == 0x0003E8, "Member 'AB_PlayerShieldDamage_CameraLensEffect_C::UberGraphFrame_B_PlayerShieldDamage_CameraLensEffect_C' has a wrong offset!");
