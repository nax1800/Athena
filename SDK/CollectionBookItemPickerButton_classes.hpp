...
static_assert(sizeof(UCollectionBookItemPickerButton_C) == 0x000B60, "Wrong size on UCollectionBookItemPickerButton_C");
static_assert(offsetof(UCollectionBookItemPickerButton_C, RootWidgetSwitcher) == 0x000B58, "Member 'UCollectionBookItemPickerButton_C::RootWidgetSwitcher' has a wrong offset!");
