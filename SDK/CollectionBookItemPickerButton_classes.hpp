...
static_assert(sizeof(UCollectionBookItemPickerButton_C) == 0x0008C8, "Wrong size on UCollectionBookItemPickerButton_C");
static_assert(offsetof(UCollectionBookItemPickerButton_C, RootWidgetSwitcher) == 0x0008C0, "Member 'UCollectionBookItemPickerButton_C::RootWidgetSwitcher' has a wrong offset!");
