...
static_assert(sizeof(ACheckForMessageItems_C) == 0x0003A0, "Wrong size on ACheckForMessageItems_C");
static_assert(offsetof(ACheckForMessageItems_C, UberGraphFrame) == 0x000388, "Member 'ACheckForMessageItems_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ACheckForMessageItems_C, DefaultSceneRoot) == 0x000390, "Member 'ACheckForMessageItems_C::DefaultSceneRoot' has a wrong offset!");
static_assert(offsetof(ACheckForMessageItems_C, GiftBox) == 0x000398, "Member 'ACheckForMessageItems_C::GiftBox' has a wrong offset!");
