...
static_assert(offsetof(AVaultWeaponPlacementHelper_C, PSMinusNoPlayerMinusSparkle) == 0x000328, "Member 'AVaultWeaponPlacementHelper_C::PSMinusNoPlayerMinusSparkle' has a wrong offset!");
static_assert(offsetof(AVaultWeaponPlacementHelper_C, PSMinusNoPlayerMinusSwirl02) == 0x000330, "Member 'AVaultWeaponPlacementHelper_C::PSMinusNoPlayerMinusSwirl02' has a wrong offset!");
static_assert(offsetof(AVaultWeaponPlacementHelper_C, PSMinusNoPlayerMinusSwirl01) == 0x000338, "Member 'AVaultWeaponPlacementHelper_C::PSMinusNoPlayerMinusSwirl01' has a wrong offset!");
