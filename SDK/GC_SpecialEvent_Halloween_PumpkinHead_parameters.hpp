...
static_assert(sizeof(GC_SpecialEvent_Halloween_PumpkinHead_C_OnActive) == 0x0001F8, "Wrong size on GC_SpecialEvent_Halloween_PumpkinHead_C_OnActive");
...
static_assert(offsetof(GC_SpecialEvent_Halloween_PumpkinHead_C_OnActive, CallFunc_K2_AddLocalOffset_SweepHitResult) == 0x0000E0, "Member 'GC_SpecialEvent_Halloween_PumpkinHead_C_OnActive::CallFunc_K2_AddLocalOffset_SweepHitResult' has a wrong offset!");
static_assert(offsetof(GC_SpecialEvent_Halloween_PumpkinHead_C_OnActive, CallFunc_K2_AddLocalRotation_SweepHitResult) == 0x000168, "Member 'GC_SpecialEvent_Halloween_PumpkinHead_C_OnActive::CallFunc_K2_AddLocalRotation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(GC_SpecialEvent_Halloween_PumpkinHead_C_OnActive, CallFunc_K2_AttachToComponent_ReturnValue) == 0x0001F0, "Member 'GC_SpecialEvent_Halloween_PumpkinHead_C_OnActive::CallFunc_K2_AttachToComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(GC_SpecialEvent_Halloween_PumpkinHead_C_OnActive, CallFunc_IsDedicatedServer_ReturnValue) == 0x0001F1, "Member 'GC_SpecialEvent_Halloween_PumpkinHead_C_OnActive::CallFunc_IsDedicatedServer_ReturnValue' has a wrong offset!");
static_assert(offsetof(GC_SpecialEvent_Halloween_PumpkinHead_C_OnActive, CallFunc_K2_AttachToComponent_ReturnValue1) == 0x0001F2, "Member 'GC_SpecialEvent_Halloween_PumpkinHead_C_OnActive::CallFunc_K2_AttachToComponent_ReturnValue1' has a wrong offset!");
