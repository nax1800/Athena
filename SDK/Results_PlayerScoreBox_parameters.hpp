...
public:
	...
	class UCommonNumericTextBlock*                K2Node_ComponentBoundEvent_NumericTextBlock;       // 0x0030(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_ComponentBoundEvent_HadCompleted;           // 0x0038(0x0001)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(Results_PlayerScoreBox_C_ExecuteUbergraph_Results_PlayerScoreBox) == 0x000040, "Wrong size on Results_PlayerScoreBox_C_ExecuteUbergraph_Results_PlayerScoreBox");
...
static_assert(offsetof(Results_PlayerScoreBox_C_ExecuteUbergraph_Results_PlayerScoreBox, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000018, "Member 'Results_PlayerScoreBox_C_ExecuteUbergraph_Results_PlayerScoreBox::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_PlayerScoreBox_C_ExecuteUbergraph_Results_PlayerScoreBox, CallFunc_PlayAnimationAtTime_ReturnValue1) == 0x000020, "Member 'Results_PlayerScoreBox_C_ExecuteUbergraph_Results_PlayerScoreBox::CallFunc_PlayAnimationAtTime_ReturnValue1' has a wrong offset!");
static_assert(offsetof(Results_PlayerScoreBox_C_ExecuteUbergraph_Results_PlayerScoreBox, CallFunc_PlayAnimationAtTime_ReturnValue2) == 0x000028, "Member 'Results_PlayerScoreBox_C_ExecuteUbergraph_Results_PlayerScoreBox::CallFunc_PlayAnimationAtTime_ReturnValue2' has a wrong offset!");
static_assert(offsetof(Results_PlayerScoreBox_C_ExecuteUbergraph_Results_PlayerScoreBox, K2Node_ComponentBoundEvent_NumericTextBlock) == 0x000030, "Member 'Results_PlayerScoreBox_C_ExecuteUbergraph_Results_PlayerScoreBox::K2Node_ComponentBoundEvent_NumericTextBlock' has a wrong offset!");
static_assert(offsetof(Results_PlayerScoreBox_C_ExecuteUbergraph_Results_PlayerScoreBox, K2Node_ComponentBoundEvent_HadCompleted) == 0x000038, "Member 'Results_PlayerScoreBox_C_ExecuteUbergraph_Results_PlayerScoreBox::K2Node_ComponentBoundEvent_HadCompleted' has a wrong offset!");
static_assert(offsetof(Results_PlayerScoreBox_C_ExecuteUbergraph_Results_PlayerScoreBox, CallFunc_NotEqual_FloatFloat_ReturnValue) == 0x000039, "Member 'Results_PlayerScoreBox_C_ExecuteUbergraph_Results_PlayerScoreBox::CallFunc_NotEqual_FloatFloat_ReturnValue' has a wrong offset!");
