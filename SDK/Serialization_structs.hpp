...
static_assert(sizeof(FStructSerializerOptionalTestStruct) == 0x000210, "Wrong size on FStructSerializerOptionalTestStruct");
...
static_assert(sizeof(FStructSerializerTestStruct) == 0x000A00, "Wrong size on FStructSerializerTestStruct");
