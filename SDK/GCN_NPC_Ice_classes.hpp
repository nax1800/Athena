...
static_assert(offsetof(AGCN_NPC_Ice_C, TransitionOutLength) == 0x000420, "Member 'AGCN_NPC_Ice_C::TransitionOutLength' has a wrong offset!");
static_assert(offsetof(AGCN_NPC_Ice_C, VectorParameters) == 0x000428, "Member 'AGCN_NPC_Ice_C::VectorParameters' has a wrong offset!");
static_assert(offsetof(AGCN_NPC_Ice_C, Elemental_Mat_Map) == 0x000478, "Member 'AGCN_NPC_Ice_C::Elemental_Mat_Map' has a wrong offset!");
static_assert(offsetof(AGCN_NPC_Ice_C, Ice_Particle_Husk) == 0x0004C8, "Member 'AGCN_NPC_Ice_C::Ice_Particle_Husk' has a wrong offset!");
static_assert(offsetof(AGCN_NPC_Ice_C, Ice_Particle_Player) == 0x0004D0, "Member 'AGCN_NPC_Ice_C::Ice_Particle_Player' has a wrong offset!");
static_assert(offsetof(AGCN_NPC_Ice_C, Flinger_Ice_Modifier) == 0x0004D8, "Member 'AGCN_NPC_Ice_C::Flinger_Ice_Modifier' has a wrong offset!");
static_assert(offsetof(AGCN_NPC_Ice_C, Actor) == 0x0004E0, "Member 'AGCN_NPC_Ice_C::Actor' has a wrong offset!");
static_assert(offsetof(AGCN_NPC_Ice_C, Mesh) == 0x0004E8, "Member 'AGCN_NPC_Ice_C::Mesh' has a wrong offset!");
