...
static_assert(offsetof(Results_SummaryBadge_C_ExecuteUbergraph_Results_SummaryBadge, Temp_string_Variable2) == 0x000028, "Member 'Results_SummaryBadge_C_ExecuteUbergraph_Results_SummaryBadge::Temp_string_Variable2' has a wrong offset!");
static_assert(offsetof(Results_SummaryBadge_C_ExecuteUbergraph_Results_SummaryBadge, Temp_string_Variable3) == 0x000038, "Member 'Results_SummaryBadge_C_ExecuteUbergraph_Results_SummaryBadge::Temp_string_Variable3' has a wrong offset!");
static_assert(offsetof(Results_SummaryBadge_C_ExecuteUbergraph_Results_SummaryBadge, Temp_string_Variable4) == 0x000048, "Member 'Results_SummaryBadge_C_ExecuteUbergraph_Results_SummaryBadge::Temp_string_Variable4' has a wrong offset!");
static_assert(offsetof(Results_SummaryBadge_C_ExecuteUbergraph_Results_SummaryBadge, Temp_string_Variable5) == 0x000058, "Member 'Results_SummaryBadge_C_ExecuteUbergraph_Results_SummaryBadge::Temp_string_Variable5' has a wrong offset!");
static_assert(offsetof(Results_SummaryBadge_C_ExecuteUbergraph_Results_SummaryBadge, Temp_string_Variable6) == 0x000068, "Member 'Results_SummaryBadge_C_ExecuteUbergraph_Results_SummaryBadge::Temp_string_Variable6' has a wrong offset!");
