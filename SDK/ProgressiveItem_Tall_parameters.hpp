...
static_assert(sizeof(ProgressiveItem_Tall_C_BP_OnInitializeSetInfo) == 0x000080, "Wrong size on ProgressiveItem_Tall_C_BP_OnInitializeSetInfo");
...
static_assert(sizeof(ProgressiveItem_Tall_C_ExecuteUbergraph_ProgressiveItem_Tall) == 0x000098, "Wrong size on ProgressiveItem_Tall_C_ExecuteUbergraph_ProgressiveItem_Tall");
