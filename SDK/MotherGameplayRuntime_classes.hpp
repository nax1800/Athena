...
static_assert(sizeof(AFortCabbageIglooVehicle) == 0x002A80, "Wrong size on AFortCabbageIglooVehicle");
...
static_assert(sizeof(UFortBaseAnimInstance_CageSaddle) == 0x0005E0, "Wrong size on UFortBaseAnimInstance_CageSaddle");
