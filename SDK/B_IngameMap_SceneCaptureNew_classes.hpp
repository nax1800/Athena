...
static_assert(sizeof(AB_IngameMap_SceneCaptureNew_C) == 0x000350, "Wrong size on AB_IngameMap_SceneCaptureNew_C");
static_assert(offsetof(AB_IngameMap_SceneCaptureNew_C, UberGraphFrame) == 0x000340, "Member 'AB_IngameMap_SceneCaptureNew_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AB_IngameMap_SceneCaptureNew_C, PostProcessPlane) == 0x000348, "Member 'AB_IngameMap_SceneCaptureNew_C::PostProcessPlane' has a wrong offset!");
