...
static_assert(sizeof(UScoreStatRowWidget_C) == 0x000258, "Wrong size on UScoreStatRowWidget_C");
static_assert(offsetof(UScoreStatRowWidget_C, UberGraphFrame) == 0x000240, "Member 'UScoreStatRowWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UScoreStatRowWidget_C, StatName) == 0x000248, "Member 'UScoreStatRowWidget_C::StatName' has a wrong offset!");
static_assert(offsetof(UScoreStatRowWidget_C, StatValue) == 0x000250, "Member 'UScoreStatRowWidget_C::StatValue' has a wrong offset!");
