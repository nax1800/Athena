...
public:
	...
	bool                                          CallFunc_IsInSubGame_ReturnValue;                  // 0x0081(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UFortAsyncAction_LockerOperation*       CallFunc_DeleteModularLoadout_ReturnValue;         // 0x0090(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UWBP_UIKit_FilteredInputField_C*        K2Node_DynamicCast_AsWBP_UIKit_Filtered_Input_Field; // 0x0098(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(WBP_NameLoadout_MP_C_ExecuteUbergraph_WBP_NameLoadout_MP) == 0x0000B0, "Wrong size on WBP_NameLoadout_MP_C_ExecuteUbergraph_WBP_NameLoadout_MP");
