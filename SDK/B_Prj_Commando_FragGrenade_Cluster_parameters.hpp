...
static_assert(sizeof(B_Prj_Commando_FragGrenade_Cluster_C_ExecuteUbergraph_B_Prj_Commando_FragGrenade_Cluster) == 0x000248, "Wrong size on B_Prj_Commando_FragGrenade_Cluster_C_ExecuteUbergraph_B_Prj_Commando_FragGrenade_Cluster");
...
static_assert(sizeof(B_Prj_Commando_FragGrenade_Cluster_C_OnStop) == 0x0000F0, "Wrong size on B_Prj_Commando_FragGrenade_Cluster_C_OnStop");
