...
static_assert(offsetof(DailyQuestWidget_C_Collect_Anim, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000000, "Member 'DailyQuestWidget_C_Collect_Anim::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(DailyQuestWidget_C_Entrance_Anim, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000000, "Member 'DailyQuestWidget_C_Entrance_Anim::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
