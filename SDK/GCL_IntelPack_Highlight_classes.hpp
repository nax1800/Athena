...
static_assert(sizeof(AGCL_IntelPack_Highlight_C) == 0x000458, "Wrong size on AGCL_IntelPack_Highlight_C");
static_assert(offsetof(AGCL_IntelPack_Highlight_C, UberGraphFrame) == 0x000420, "Member 'AGCL_IntelPack_Highlight_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AGCL_IntelPack_Highlight_C, Item_to_Highlight) == 0x000428, "Member 'AGCL_IntelPack_Highlight_C::Item_to_Highlight' has a wrong offset!");
static_assert(offsetof(AGCL_IntelPack_Highlight_C, Highlight_Color) == 0x000430, "Member 'AGCL_IntelPack_Highlight_C::Highlight_Color' has a wrong offset!");
static_assert(offsetof(AGCL_IntelPack_Highlight_C, View_Radius) == 0x000440, "Member 'AGCL_IntelPack_Highlight_C::View_Radius' has a wrong offset!");
static_assert(offsetof(AGCL_IntelPack_Highlight_C, IntelFX_MID) == 0x000448, "Member 'AGCL_IntelPack_Highlight_C::IntelFX_MID' has a wrong offset!");
static_assert(offsetof(AGCL_IntelPack_Highlight_C, P_IntelBackPack_Marker) == 0x000450, "Member 'AGCL_IntelPack_Highlight_C::P_IntelBackPack_Marker' has a wrong offset!");
