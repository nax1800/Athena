...
static_assert(alignof(ProfileStatsOverviewSubScreen_C_ExecuteUbergraph_ProfileStatsOverviewSubScreen) == 0x000008, "Wrong alignment on ProfileStatsOverviewSubScreen_C_ExecuteUbergraph_ProfileStatsOverviewSubScreen");
static_assert(sizeof(ProfileStatsOverviewSubScreen_C_ExecuteUbergraph_ProfileStatsOverviewSubScreen) == 0x000018, "Wrong size on ProfileStatsOverviewSubScreen_C_ExecuteUbergraph_ProfileStatsOverviewSubScreen");
...
static_assert(offsetof(ProfileStatsOverviewSubScreen_C_ExecuteUbergraph_ProfileStatsOverviewSubScreen, K2Node_CreateDelegate_OutputDelegate) == 0x000008, "Member 'ProfileStatsOverviewSubScreen_C_ExecuteUbergraph_ProfileStatsOverviewSubScreen::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
