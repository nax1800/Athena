...
// Function HUD.HUD_C.OnPlayerRevived
// (BlueprintCallable, BlueprintEvent)

void UHUD_C::OnPlayerRevived()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_C", "OnPlayerRevived");
...
// Parameters:
// struct FFortPlayerDeathReport           Death_Report                                           (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)

void UHUD_C::OnPlayerDied(const struct FFortPlayerDeathReport& Death_Report)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_C", "OnPlayerDied");

	Params::HUD_C_OnPlayerDied Parms{};

	Parms.Death_Report = std::move(Death_Report);
...
void UHUD_C::SetDeathWidgetVAlignment(EVerticalAlignment V_Alignment)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_C", "SetDeathWidgetVAlignment");

	Params::HUD_C_SetDeathWidgetVAlignment Parms{};
