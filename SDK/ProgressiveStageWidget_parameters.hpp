...
static_assert(sizeof(ProgressiveStageWidget_C_ExecuteUbergraph_ProgressiveStageWidget) == 0x000030, "Wrong size on ProgressiveStageWidget_C_ExecuteUbergraph_ProgressiveStageWidget");
...
static_assert(sizeof(ProgressiveStageWidget_C_OnSetTooltipText) == 0x000010, "Wrong size on ProgressiveStageWidget_C_OnSetTooltipText");
