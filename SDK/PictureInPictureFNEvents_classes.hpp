...
static_assert(sizeof(ULiveEventHUDAd) == 0x0002C8, "Wrong size on ULiveEventHUDAd");
...
static_assert(sizeof(UPictureInPictureFNEventsController) == 0x000768, "Wrong size on UPictureInPictureFNEventsController");
