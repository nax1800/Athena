...
public:
	...
	struct FVector                                K2Node_CustomEvent_EdgeOfStorm;                    // 0x0008(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(GCNL_EdgeOfStorm_C_ExecuteUbergraph_GCNL_EdgeOfStorm) == 0x0000A8, "Wrong size on GCNL_EdgeOfStorm_C_ExecuteUbergraph_GCNL_EdgeOfStorm");
...
static_assert(offsetof(GCNL_EdgeOfStorm_C_ExecuteUbergraph_GCNL_EdgeOfStorm, CallFunc_K2_SetWorldLocation_SweepHitResult) == 0x000018, "Member 'GCNL_EdgeOfStorm_C_ExecuteUbergraph_GCNL_EdgeOfStorm::CallFunc_K2_SetWorldLocation_SweepHitResult' has a wrong offset!");
...
{
public:
	struct FVector                                EdgeOfStorm;                                       // 0x0000(0x000C)(BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
