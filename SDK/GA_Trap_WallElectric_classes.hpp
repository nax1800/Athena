...
static_assert(sizeof(UGA_Trap_WallElectric_C) == 0x000948, "Wrong size on UGA_Trap_WallElectric_C");
static_assert(offsetof(UGA_Trap_WallElectric_C, UberGraphFrame_GA_Trap_WallElectric_C) == 0x000928, "Member 'UGA_Trap_WallElectric_C::UberGraphFrame_GA_Trap_WallElectric_C' has a wrong offset!");
static_assert(offsetof(UGA_Trap_WallElectric_C, HitActors) == 0x000930, "Member 'UGA_Trap_WallElectric_C::HitActors' has a wrong offset!");
static_assert(offsetof(UGA_Trap_WallElectric_C, TargetCount) == 0x000940, "Member 'UGA_Trap_WallElectric_C::TargetCount' has a wrong offset!");
