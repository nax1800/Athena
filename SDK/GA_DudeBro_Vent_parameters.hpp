...
static_assert(sizeof(GA_DudeBro_Vent_C_ExecuteUbergraph_GA_DudeBro_Vent) == 0x0003E0, "Wrong size on GA_DudeBro_Vent_C_ExecuteUbergraph_GA_DudeBro_Vent");
...
static_assert(sizeof(GA_DudeBro_Vent_C_PlayerCapsuleHit) == 0x000120, "Wrong size on GA_DudeBro_Vent_C_PlayerCapsuleHit");
