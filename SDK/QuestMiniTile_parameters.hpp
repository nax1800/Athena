...
static_assert(offsetof(QuestMiniTile_C_SetState, CallFunc_IsValid_ReturnValue1) == 0x000038, "Member 'QuestMiniTile_C_SetState::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
