...
public:
	...
	class UUMGSequencePlayer*                     CallFunc_PlayAnimationTo_ReturnValue;              // 0x0018(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UUMGSequencePlayer*                     CallFunc_PlayAnimationTo_ReturnValue1;             // 0x0020(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UUMGSequencePlayer*                     CallFunc_PlayAnimationAtTime_ReturnValue;          // 0x0028(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(QuestMiniTile_C_SetState, CallFunc_PlayAnimationTo_ReturnValue) == 0x000018, "Member 'QuestMiniTile_C_SetState::CallFunc_PlayAnimationTo_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuestMiniTile_C_SetState, CallFunc_PlayAnimationTo_ReturnValue1) == 0x000020, "Member 'QuestMiniTile_C_SetState::CallFunc_PlayAnimationTo_ReturnValue1' has a wrong offset!");
static_assert(offsetof(QuestMiniTile_C_SetState, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000028, "Member 'QuestMiniTile_C_SetState::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(QuestMiniTile_C_PlayTileAnimation, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000000, "Member 'QuestMiniTile_C_PlayTileAnimation::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UUMGSequencePlayer*                     CallFunc_PlayAnimationTo_ReturnValue;              // 0x0008(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UUMGSequencePlayer*                     CallFunc_PlayAnimationTo_ReturnValue1;             // 0x0010(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(QuestMiniTile_C_SetStateAndFindIncompleteQuest, CallFunc_PlayAnimationTo_ReturnValue) == 0x000008, "Member 'QuestMiniTile_C_SetStateAndFindIncompleteQuest::CallFunc_PlayAnimationTo_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuestMiniTile_C_SetStateAndFindIncompleteQuest, CallFunc_PlayAnimationTo_ReturnValue1) == 0x000010, "Member 'QuestMiniTile_C_SetStateAndFindIncompleteQuest::CallFunc_PlayAnimationTo_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(QuestMiniTile_C_SetStateAndFindIncompleteQuest, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000020, "Member 'QuestMiniTile_C_SetStateAndFindIncompleteQuest::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
