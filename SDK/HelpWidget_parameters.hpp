...
static_assert(offsetof(HelpWidget_C_ExecuteUbergraph_HelpWidget, K2Node_ComponentBoundEvent_Button) == 0x000008, "Member 'HelpWidget_C_ExecuteUbergraph_HelpWidget::K2Node_ComponentBoundEvent_Button' has a wrong offset!");
static_assert(offsetof(HelpWidget_C_ExecuteUbergraph_HelpWidget, CallFunc_GetUIManagerWidget_ReturnValue) == 0x000010, "Member 'HelpWidget_C_ExecuteUbergraph_HelpWidget::CallFunc_GetUIManagerWidget_ReturnValue' has a wrong offset!");
