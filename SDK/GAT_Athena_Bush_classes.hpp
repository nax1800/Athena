...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GAT_Athena_Bush_C;                  // 0x0958(0x0008)(Transient, DuplicateTransient)
...
static_assert(offsetof(UGAT_Athena_Bush_C, UberGraphFrame_GAT_Athena_Bush_C) == 0x000958, "Member 'UGAT_Athena_Bush_C::UberGraphFrame_GAT_Athena_Bush_C' has a wrong offset!");
static_assert(offsetof(UGAT_Athena_Bush_C, PlayerPawn) == 0x000960, "Member 'UGAT_Athena_Bush_C::PlayerPawn' has a wrong offset!");
