...
static_assert(offsetof(OnlineStatusPanel_C_ExecuteUbergraph_OnlineStatusPanel, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000008, "Member 'OnlineStatusPanel_C_ExecuteUbergraph_OnlineStatusPanel::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
