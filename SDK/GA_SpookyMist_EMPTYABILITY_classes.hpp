...
static_assert(sizeof(UGA_SpookyMist_EMPTYABILITY_C) == 0x000948, "Wrong size on UGA_SpookyMist_EMPTYABILITY_C");
static_assert(offsetof(UGA_SpookyMist_EMPTYABILITY_C, UberGraphFrame) == 0x000940, "Member 'UGA_SpookyMist_EMPTYABILITY_C::UberGraphFrame' has a wrong offset!");
