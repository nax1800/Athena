...
public:
	...
	class UWidgetAnimation*                       IconSlide;                                         // 0x0268(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash)
	class UWidgetAnimation*                       IconPulse;                                         // 0x0270(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash)
	class UWidgetAnimation*                       ModeChanged;                                       // 0x0278(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          bSimplifiedHUD;                                    // 0x02A8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(UAthenaGamePhaseChangeWidget_C) == 0x0002B0, "Wrong size on UAthenaGamePhaseChangeWidget_C");
...
static_assert(offsetof(UAthenaGamePhaseChangeWidget_C, bSimplifiedHUD) == 0x0002A8, "Member 'UAthenaGamePhaseChangeWidget_C::bSimplifiedHUD' has a wrong offset!");
