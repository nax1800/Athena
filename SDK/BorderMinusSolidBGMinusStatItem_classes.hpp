...
static_assert(alignof(UBorderMinusSolidBGMinusStatItem_C) == 0x000010, "Wrong alignment on UBorderMinusSolidBGMinusStatItem_C");
static_assert(sizeof(UBorderMinusSolidBGMinusStatItem_C) == 0x0000F0, "Wrong size on UBorderMinusSolidBGMinusStatItem_C");
