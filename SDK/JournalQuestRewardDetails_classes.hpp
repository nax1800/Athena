...
static_assert(offsetof(UJournalQuestRewardDetails_C, UberGraphFrame) == 0x000238, "Member 'UJournalQuestRewardDetails_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UJournalQuestRewardDetails_C, BorderBonusesBottomEdge) == 0x000240, "Member 'UJournalQuestRewardDetails_C::BorderBonusesBottomEdge' has a wrong offset!");
