...
public:
	...
	class UHorizontalBox*                         HBox_Content;                                      // 0x0358(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UAthenaGlobalCashHorizontal_C) == 0x000360, "Wrong size on UAthenaGlobalCashHorizontal_C");
