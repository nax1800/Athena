...
static_assert(sizeof(UAtomModelAssetUserData) == 0x000058, "Wrong size on UAtomModelAssetUserData");
...
static_assert(sizeof(UAtomPrimitiveGeometryContainer) == 0x000100, "Wrong size on UAtomPrimitiveGeometryContainer");
...
static_assert(sizeof(UAtomISMPoolRenderer) == 0x0000F0, "Wrong size on UAtomISMPoolRenderer");
...
static_assert(sizeof(UAtomModel) == 0x000248, "Wrong size on UAtomModel");
