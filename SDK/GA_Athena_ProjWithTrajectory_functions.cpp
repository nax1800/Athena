...
// Parameters:
// class AFortProjectileBase*              Param_GrenadeReference                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UGA_Athena_ProjWithTrajectory_C::AthenaGrenadeSpawned(class AFortProjectileBase* Param_GrenadeReference)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_GrenadeReference = Param_GrenadeReference;
