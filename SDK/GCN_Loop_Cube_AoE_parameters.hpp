...
static_assert(offsetof(GCN_Loop_Cube_AoE_C_ExecuteUbergraph_GCN_Loop_Cube_AoE, K2Node_CustomEvent_Hit) == 0x000268, "Member 'GCN_Loop_Cube_AoE_C_ExecuteUbergraph_GCN_Loop_Cube_AoE::K2Node_CustomEvent_Hit' has a wrong offset!");
...
static_assert(alignof(GCN_Loop_Cube_AoE_C_TargetPlayerLanded) == 0x000008, "Wrong alignment on GCN_Loop_Cube_AoE_C_TargetPlayerLanded");
