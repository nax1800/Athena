...
// 0x0008 (0x0008 - 0x0000)
struct HordeWaveModifiersTile_C_PlayIntro final
{
public:
...
static_assert(alignof(HordeWaveModifiersTile_C_PlayIntro) == 0x000008, "Wrong alignment on HordeWaveModifiersTile_C_PlayIntro");
static_assert(sizeof(HordeWaveModifiersTile_C_PlayIntro) == 0x000008, "Wrong size on HordeWaveModifiersTile_C_PlayIntro");
static_assert(offsetof(HordeWaveModifiersTile_C_PlayIntro, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000000, "Member 'HordeWaveModifiersTile_C_PlayIntro::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
