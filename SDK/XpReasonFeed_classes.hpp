...
static_assert(sizeof(UXpReasonFeed_C) == 0x000220, "Wrong size on UXpReasonFeed_C");
static_assert(offsetof(UXpReasonFeed_C, UberGraphFrame) == 0x000208, "Member 'UXpReasonFeed_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UXpReasonFeed_C, DynamicXpFeed) == 0x000210, "Member 'UXpReasonFeed_C::DynamicXpFeed' has a wrong offset!");
static_assert(offsetof(UXpReasonFeed_C, Animating) == 0x000218, "Member 'UXpReasonFeed_C::Animating' has a wrong offset!");
