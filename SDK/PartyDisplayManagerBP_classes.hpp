...
static_assert(sizeof(APartyDisplayManagerBP_C) == 0x0005E0, "Wrong size on APartyDisplayManagerBP_C");
...
static_assert(offsetof(APartyDisplayManagerBP_C, InScaleFx) == 0x0005D8, "Member 'APartyDisplayManagerBP_C::InScaleFx' has a wrong offset!");
