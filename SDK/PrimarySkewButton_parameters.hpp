...
static_assert(sizeof(PrimarySkewButton_C_ExecuteUbergraph_PrimarySkewButton) == 0x000290, "Wrong size on PrimarySkewButton_C_ExecuteUbergraph_PrimarySkewButton");
