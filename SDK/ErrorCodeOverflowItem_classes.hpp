...
static_assert(sizeof(UErrorCodeOverflowItem_C) == 0x000210, "Wrong size on UErrorCodeOverflowItem_C");
static_assert(offsetof(UErrorCodeOverflowItem_C, TextBlock_332) == 0x000208, "Member 'UErrorCodeOverflowItem_C::TextBlock_332' has a wrong offset!");
