...
static_assert(sizeof(AFortnitePartyBackdrop_Camera_C) == 0x0008A0, "Wrong size on AFortnitePartyBackdrop_Camera_C");
...
static_assert(offsetof(AFortnitePartyBackdrop_Camera_C, FortEntryMusic) == 0x000890, "Member 'AFortnitePartyBackdrop_Camera_C::FortEntryMusic' has a wrong offset!");
static_assert(offsetof(AFortnitePartyBackdrop_Camera_C, Fort_Entry_Music_Controller) == 0x000898, "Member 'AFortnitePartyBackdrop_Camera_C::Fort_Entry_Music_Controller' has a wrong offset!");
