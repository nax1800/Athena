...
static_assert(sizeof(UCollectionBookPurchaseWidget_C) == 0x000358, "Wrong size on UCollectionBookPurchaseWidget_C");
static_assert(offsetof(UCollectionBookPurchaseWidget_C, UberGraphFrame) == 0x000328, "Member 'UCollectionBookPurchaseWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UCollectionBookPurchaseWidget_C, ButtonClose) == 0x000330, "Member 'UCollectionBookPurchaseWidget_C::ButtonClose' has a wrong offset!");
static_assert(offsetof(UCollectionBookPurchaseWidget_C, CollectionBookPurchasePanel) == 0x000338, "Member 'UCollectionBookPurchaseWidget_C::CollectionBookPurchasePanel' has a wrong offset!");
static_assert(offsetof(UCollectionBookPurchaseWidget_C, DisplayName) == 0x000340, "Member 'UCollectionBookPurchaseWidget_C::DisplayName' has a wrong offset!");
static_assert(offsetof(UCollectionBookPurchaseWidget_C, Lightbox) == 0x000348, "Member 'UCollectionBookPurchaseWidget_C::Lightbox' has a wrong offset!");
static_assert(offsetof(UCollectionBookPurchaseWidget_C, SectionNameTextWidget) == 0x000350, "Member 'UCollectionBookPurchaseWidget_C::SectionNameTextWidget' has a wrong offset!");
