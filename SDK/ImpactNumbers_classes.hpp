...
static_assert(sizeof(AImpactNumbers_C) == 0x000598, "Wrong size on AImpactNumbers_C");
static_assert(offsetof(AImpactNumbers_C, UberGraphFrame) == 0x000518, "Member 'AImpactNumbers_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AImpactNumbers_C, DefaultSceneRoot) == 0x000520, "Member 'AImpactNumbers_C::DefaultSceneRoot' has a wrong offset!");
static_assert(offsetof(AImpactNumbers_C, Spacing_percentage_for_1s) == 0x000528, "Member 'AImpactNumbers_C::Spacing_percentage_for_1s' has a wrong offset!");
static_assert(offsetof(AImpactNumbers_C, FontYSize_0) == 0x00052C, "Member 'AImpactNumbers_C::FontYSize_0' has a wrong offset!");
static_assert(offsetof(AImpactNumbers_C, FontXSize_0) == 0x000530, "Member 'AImpactNumbers_C::FontXSize_0' has a wrong offset!");
static_assert(offsetof(AImpactNumbers_C, FontSizeScaleMaxPerc) == 0x000534, "Member 'AImpactNumbers_C::FontSizeScaleMaxPerc' has a wrong offset!");
static_assert(offsetof(AImpactNumbers_C, Standard_Hit_Color) == 0x000538, "Member 'AImpactNumbers_C::Standard_Hit_Color' has a wrong offset!");
static_assert(offsetof(AImpactNumbers_C, Critical_Wall_Hit_Color) == 0x000548, "Member 'AImpactNumbers_C::Critical_Wall_Hit_Color' has a wrong offset!");
static_assert(offsetof(AImpactNumbers_C, Player_Damage_Color) == 0x000558, "Member 'AImpactNumbers_C::Player_Damage_Color' has a wrong offset!");
static_assert(offsetof(AImpactNumbers_C, Number_Spacing_Multiplier) == 0x000568, "Member 'AImpactNumbers_C::Number_Spacing_Multiplier' has a wrong offset!");
static_assert(offsetof(AImpactNumbers_C, Number_of_number_rotations) == 0x00056C, "Member 'AImpactNumbers_C::Number_of_number_rotations' has a wrong offset!");
static_assert(offsetof(AImpactNumbers_C, Critical_Hit_Multiplier) == 0x000570, "Member 'AImpactNumbers_C::Critical_Hit_Multiplier' has a wrong offset!");
static_assert(offsetof(AImpactNumbers_C, Distance_from_Camera_Before_Doubling_Size) == 0x000574, "Member 'AImpactNumbers_C::Distance_from_Camera_Before_Doubling_Size' has a wrong offset!");
static_assert(offsetof(AImpactNumbers_C, Critical_Enemy_Hit_Color) == 0x000578, "Member 'AImpactNumbers_C::Critical_Enemy_Hit_Color' has a wrong offset!");
static_assert(offsetof(AImpactNumbers_C, Number_offset_per) == 0x000588, "Member 'AImpactNumbers_C::Number_offset_per' has a wrong offset!");
