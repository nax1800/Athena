...
static_assert(sizeof(GCL_Athena_Blade_Aura_C_ExecuteUbergraph_GCL_Athena_Blade_Aura) == 0x0000E8, "Wrong size on GCL_Athena_Blade_Aura_C_ExecuteUbergraph_GCL_Athena_Blade_Aura");
...
static_assert(offsetof(GCL_Athena_Blade_Aura_C_ExecuteUbergraph_GCL_Athena_Blade_Aura, K2Node_Event_MyTarget) == 0x000008, "Member 'GCL_Athena_Blade_Aura_C_ExecuteUbergraph_GCL_Athena_Blade_Aura::K2Node_Event_MyTarget' has a wrong offset!");
static_assert(offsetof(GCL_Athena_Blade_Aura_C_ExecuteUbergraph_GCL_Athena_Blade_Aura, K2Node_Event_Parameters) == 0x000010, "Member 'GCL_Athena_Blade_Aura_C_ExecuteUbergraph_GCL_Athena_Blade_Aura::K2Node_Event_Parameters' has a wrong offset!");
static_assert(offsetof(GCL_Athena_Blade_Aura_C_ExecuteUbergraph_GCL_Athena_Blade_Aura, K2Node_Event_ParticleComponents) == 0x0000C8, "Member 'GCL_Athena_Blade_Aura_C_ExecuteUbergraph_GCL_Athena_Blade_Aura::K2Node_Event_ParticleComponents' has a wrong offset!");
static_assert(offsetof(GCL_Athena_Blade_Aura_C_ExecuteUbergraph_GCL_Athena_Blade_Aura, K2Node_Event_AudioComponents) == 0x0000D8, "Member 'GCL_Athena_Blade_Aura_C_ExecuteUbergraph_GCL_Athena_Blade_Aura::K2Node_Event_AudioComponents' has a wrong offset!");
