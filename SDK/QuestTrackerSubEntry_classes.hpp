...
static_assert(sizeof(UQuestTrackerSubEntry_C) == 0x0003B0, "Wrong size on UQuestTrackerSubEntry_C");
...
static_assert(offsetof(UQuestTrackerSubEntry_C, NonHUDPin) == 0x000328, "Member 'UQuestTrackerSubEntry_C::NonHUDPin' has a wrong offset!");
