...
static_assert(sizeof(UAthenaMatchStatusTextPlayer_C) == 0x0002F8, "Wrong size on UAthenaMatchStatusTextPlayer_C");
static_assert(offsetof(UAthenaMatchStatusTextPlayer_C, UberGraphFrame) == 0x000208, "Member 'UAthenaMatchStatusTextPlayer_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UAthenaMatchStatusTextPlayer_C, TopPlayerDead) == 0x000210, "Member 'UAthenaMatchStatusTextPlayer_C::TopPlayerDead' has a wrong offset!");
static_assert(offsetof(UAthenaMatchStatusTextPlayer_C, NewTopPlayer) == 0x000218, "Member 'UAthenaMatchStatusTextPlayer_C::NewTopPlayer' has a wrong offset!");
static_assert(offsetof(UAthenaMatchStatusTextPlayer_C, LensFlare1) == 0x000220, "Member 'UAthenaMatchStatusTextPlayer_C::LensFlare1' has a wrong offset!");
static_assert(offsetof(UAthenaMatchStatusTextPlayer_C, LensFlare2) == 0x000228, "Member 'UAthenaMatchStatusTextPlayer_C::LensFlare2' has a wrong offset!");
static_assert(offsetof(UAthenaMatchStatusTextPlayer_C, LensFlare3) == 0x000230, "Member 'UAthenaMatchStatusTextPlayer_C::LensFlare3' has a wrong offset!");
static_assert(offsetof(UAthenaMatchStatusTextPlayer_C, LensFlare4) == 0x000238, "Member 'UAthenaMatchStatusTextPlayer_C::LensFlare4' has a wrong offset!");
static_assert(offsetof(UAthenaMatchStatusTextPlayer_C, Strikethrough) == 0x000240, "Member 'UAthenaMatchStatusTextPlayer_C::Strikethrough' has a wrong offset!");
static_assert(offsetof(UAthenaMatchStatusTextPlayer_C, TextBlock) == 0x000248, "Member 'UAthenaMatchStatusTextPlayer_C::TextBlock' has a wrong offset!");
static_assert(offsetof(UAthenaMatchStatusTextPlayer_C, Font) == 0x000250, "Member 'UAthenaMatchStatusTextPlayer_C::Font' has a wrong offset!");
static_assert(offsetof(UAthenaMatchStatusTextPlayer_C, Color) == 0x0002A8, "Member 'UAthenaMatchStatusTextPlayer_C::Color' has a wrong offset!");
static_assert(offsetof(UAthenaMatchStatusTextPlayer_C, ShowMaterialHighlight) == 0x0002D0, "Member 'UAthenaMatchStatusTextPlayer_C::ShowMaterialHighlight' has a wrong offset!");
static_assert(offsetof(UAthenaMatchStatusTextPlayer_C, HighlightMaterial) == 0x0002D8, "Member 'UAthenaMatchStatusTextPlayer_C::HighlightMaterial' has a wrong offset!");
static_assert(offsetof(UAthenaMatchStatusTextPlayer_C, TextToDisplay) == 0x0002E0, "Member 'UAthenaMatchStatusTextPlayer_C::TextToDisplay' has a wrong offset!");
