...
static_assert(offsetof(ItemAttributesDetailWidget_C_ExecuteUbergraph_ItemAttributesDetailWidget, CallFunc_IsValid_ReturnValue2) == 0x000035, "Member 'ItemAttributesDetailWidget_C_ExecuteUbergraph_ItemAttributesDetailWidget::CallFunc_IsValid_ReturnValue2' has a wrong offset!");
static_assert(offsetof(ItemAttributesDetailWidget_C_ExecuteUbergraph_ItemAttributesDetailWidget, CallFunc_IsValid_ReturnValue3) == 0x000036, "Member 'ItemAttributesDetailWidget_C_ExecuteUbergraph_ItemAttributesDetailWidget::CallFunc_IsValid_ReturnValue3' has a wrong offset!");
static_assert(offsetof(ItemAttributesDetailWidget_C_ExecuteUbergraph_ItemAttributesDetailWidget, K2Node_CreateDelegate_OutputDelegate2) == 0x000038, "Member 'ItemAttributesDetailWidget_C_ExecuteUbergraph_ItemAttributesDetailWidget::K2Node_CreateDelegate_OutputDelegate2' has a wrong offset!");
static_assert(offsetof(ItemAttributesDetailWidget_C_ExecuteUbergraph_ItemAttributesDetailWidget, K2Node_CreateDelegate_OutputDelegate3) == 0x000048, "Member 'ItemAttributesDetailWidget_C_ExecuteUbergraph_ItemAttributesDetailWidget::K2Node_CreateDelegate_OutputDelegate3' has a wrong offset!");
