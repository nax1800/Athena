...
public:
	...
	class AEnemyPawn_Parent_C*                    DeimosPawn;                                        // 0x0E50(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ATrap_Floor_BouncePad_C) == 0x000E58, "Wrong size on ATrap_Floor_BouncePad_C");
static_assert(offsetof(ATrap_Floor_BouncePad_C, UberGraphFrame) == 0x000C88, "Member 'ATrap_Floor_BouncePad_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ATrap_Floor_BouncePad_C, Box) == 0x000C90, "Member 'ATrap_Floor_BouncePad_C::Box' has a wrong offset!");
static_assert(offsetof(ATrap_Floor_BouncePad_C, Arrow) == 0x000C98, "Member 'ATrap_Floor_BouncePad_C::Arrow' has a wrong offset!");
static_assert(offsetof(ATrap_Floor_BouncePad_C, BouncePadFX) == 0x000CA0, "Member 'ATrap_Floor_BouncePad_C::BouncePadFX' has a wrong offset!");
static_assert(offsetof(ATrap_Floor_BouncePad_C, Trigger) == 0x000CA8, "Member 'ATrap_Floor_BouncePad_C::Trigger' has a wrong offset!");
static_assert(offsetof(ATrap_Floor_BouncePad_C, Root) == 0x000CB0, "Member 'ATrap_Floor_BouncePad_C::Root' has a wrong offset!");
static_assert(offsetof(ATrap_Floor_BouncePad_C, Place_Trap_Sound) == 0x000CB8, "Member 'ATrap_Floor_BouncePad_C::Place_Trap_Sound' has a wrong offset!");
static_assert(offsetof(ATrap_Floor_BouncePad_C, Trap_Active_Sound) == 0x000CC0, "Member 'ATrap_Floor_BouncePad_C::Trap_Active_Sound' has a wrong offset!");
static_assert(offsetof(ATrap_Floor_BouncePad_C, Trap_Explode_Sound) == 0x000CC8, "Member 'ATrap_Floor_BouncePad_C::Trap_Explode_Sound' has a wrong offset!");
static_assert(offsetof(ATrap_Floor_BouncePad_C, Trap_Fire_Sound) == 0x000CD0, "Member 'ATrap_Floor_BouncePad_C::Trap_Fire_Sound' has a wrong offset!");
static_assert(offsetof(ATrap_Floor_BouncePad_C, Trap_Destroyed_Sound) == 0x000CD8, "Member 'ATrap_Floor_BouncePad_C::Trap_Destroyed_Sound' has a wrong offset!");
static_assert(offsetof(ATrap_Floor_BouncePad_C, OverlappedActor) == 0x000CE0, "Member 'ATrap_Floor_BouncePad_C::OverlappedActor' has a wrong offset!");
static_assert(offsetof(ATrap_Floor_BouncePad_C, PlayerMinusDestructionRange) == 0x000CE8, "Member 'ATrap_Floor_BouncePad_C::PlayerMinusDestructionRange' has a wrong offset!");
static_assert(offsetof(ATrap_Floor_BouncePad_C, BouncePadTagMaxCount) == 0x000CF0, "Member 'ATrap_Floor_BouncePad_C::BouncePadTagMaxCount' has a wrong offset!");
static_assert(offsetof(ATrap_Floor_BouncePad_C, LaunchedPlayer) == 0x000CF8, "Member 'ATrap_Floor_BouncePad_C::LaunchedPlayer' has a wrong offset!");
static_assert(offsetof(ATrap_Floor_BouncePad_C, LaunchedVehicle) == 0x000D00, "Member 'ATrap_Floor_BouncePad_C::LaunchedVehicle' has a wrong offset!");
