...
public:
	...
	class UImage*                                 TimeoutIcon;                                       // 0x0348(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UNetDebugUI_C) == 0x000350, "Wrong size on UNetDebugUI_C");
...
static_assert(offsetof(UNetDebugUI_C, TimeoutIcon) == 0x000348, "Member 'UNetDebugUI_C::TimeoutIcon' has a wrong offset!");
