...
public:
	...
	class UParticleSystemComponent*               PSMinusNoPlayerMinusSparkle;                       // 0x0388(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UParticleSystemComponent*               PSMinusNoPlayerMinusSwirl02;                       // 0x0390(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UParticleSystemComponent*               PSMinusNoPlayerMinusSwirl01;                       // 0x0398(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(APartyCharacterPlacementHelper_C, PSMinusNoPlayerMinusSparkle) == 0x000388, "Member 'APartyCharacterPlacementHelper_C::PSMinusNoPlayerMinusSparkle' has a wrong offset!");
static_assert(offsetof(APartyCharacterPlacementHelper_C, PSMinusNoPlayerMinusSwirl02) == 0x000390, "Member 'APartyCharacterPlacementHelper_C::PSMinusNoPlayerMinusSwirl02' has a wrong offset!");
static_assert(offsetof(APartyCharacterPlacementHelper_C, PSMinusNoPlayerMinusSwirl01) == 0x000398, "Member 'APartyCharacterPlacementHelper_C::PSMinusNoPlayerMinusSwirl01' has a wrong offset!");
