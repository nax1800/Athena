...
static_assert(offsetof(ItemIconWidget_C_ExecuteUbergraph_ItemIconWidget, Temp_int_Variable2) == 0x000010, "Member 'ItemIconWidget_C_ExecuteUbergraph_ItemIconWidget::Temp_int_Variable2' has a wrong offset!");
static_assert(offsetof(ItemIconWidget_C_ExecuteUbergraph_ItemIconWidget, Temp_int_Variable3) == 0x000014, "Member 'ItemIconWidget_C_ExecuteUbergraph_ItemIconWidget::Temp_int_Variable3' has a wrong offset!");
static_assert(offsetof(ItemIconWidget_C_ExecuteUbergraph_ItemIconWidget, Temp_int_Variable4) == 0x000018, "Member 'ItemIconWidget_C_ExecuteUbergraph_ItemIconWidget::Temp_int_Variable4' has a wrong offset!");
static_assert(offsetof(ItemIconWidget_C_ExecuteUbergraph_ItemIconWidget, Temp_int_Variable5) == 0x00001C, "Member 'ItemIconWidget_C_ExecuteUbergraph_ItemIconWidget::Temp_int_Variable5' has a wrong offset!");
...
static_assert(offsetof(ItemIconWidget_C_ExecuteUbergraph_ItemIconWidget, CallFunc_GetOrLoadSynchronously_ReturnValue) == 0x000048, "Member 'ItemIconWidget_C_ExecuteUbergraph_ItemIconWidget::CallFunc_GetOrLoadSynchronously_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ItemIconWidget_C_ExecuteUbergraph_ItemIconWidget, CallFunc_MakeBrushFromTexture_ReturnValue) == 0x000058, "Member 'ItemIconWidget_C_ExecuteUbergraph_ItemIconWidget::CallFunc_MakeBrushFromTexture_ReturnValue' has a wrong offset!");
