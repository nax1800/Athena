...
static_assert(sizeof(NormalBangWrapper_C_ExecuteUbergraph_NormalBangWrapper) == 0x000030, "Wrong size on NormalBangWrapper_C_ExecuteUbergraph_NormalBangWrapper");
...
static_assert(offsetof(NormalBangWrapper_C_ExecuteUbergraph_NormalBangWrapper, K2Node_Event_IsDesignTime) == 0x000010, "Member 'NormalBangWrapper_C_ExecuteUbergraph_NormalBangWrapper::K2Node_Event_IsDesignTime' has a wrong offset!");
static_assert(offsetof(NormalBangWrapper_C_ExecuteUbergraph_NormalBangWrapper, CallFunc_Conv_IntToText_ReturnValue) == 0x000018, "Member 'NormalBangWrapper_C_ExecuteUbergraph_NormalBangWrapper::CallFunc_Conv_IntToText_ReturnValue' has a wrong offset!");
...
static_assert(alignof(NormalBangWrapper_C_InitialReset) == 0x000004, "Wrong alignment on NormalBangWrapper_C_InitialReset");
static_assert(sizeof(NormalBangWrapper_C_InitialReset) == 0x000008, "Wrong size on NormalBangWrapper_C_InitialReset");
