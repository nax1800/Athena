...
static_assert(sizeof(NormalBangWrapper_C_ExecuteUbergraph_NormalBangWrapper) == 0x000038, "Wrong size on NormalBangWrapper_C_ExecuteUbergraph_NormalBangWrapper");
