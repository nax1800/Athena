...
static_assert(sizeof(SidebarPanelKoala_C_ExecuteUbergraph_SidebarPanelKoala) == 0x000150, "Wrong size on SidebarPanelKoala_C_ExecuteUbergraph_SidebarPanelKoala");
...
static_assert(sizeof(SidebarPanelKoala_C_UpdateUsageDescription) == 0x000038, "Wrong size on SidebarPanelKoala_C_UpdateUsageDescription");
