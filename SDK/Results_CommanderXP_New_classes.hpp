...
static_assert(sizeof(UResults_CommanderXP_New_C) == 0x000308, "Wrong size on UResults_CommanderXP_New_C");
static_assert(offsetof(UResults_CommanderXP_New_C, UberGraphFrame) == 0x000210, "Member 'UResults_CommanderXP_New_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, Anim_SkipToFinalState) == 0x000218, "Member 'UResults_CommanderXP_New_C::Anim_SkipToFinalState' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, Anim_SkillPointIncrement2) == 0x000220, "Member 'UResults_CommanderXP_New_C::Anim_SkillPointIncrement2' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, Anim_ContinueButtonOutro) == 0x000228, "Member 'UResults_CommanderXP_New_C::Anim_ContinueButtonOutro' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, Anim_ContinueButtonIntro) == 0x000230, "Member 'UResults_CommanderXP_New_C::Anim_ContinueButtonIntro' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, Anim_Intro) == 0x000238, "Member 'UResults_CommanderXP_New_C::Anim_Intro' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, Anim_SkillPointIncrement1) == 0x000240, "Member 'UResults_CommanderXP_New_C::Anim_SkillPointIncrement1' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, Anim_SkillPointIncrementBase) == 0x000248, "Member 'UResults_CommanderXP_New_C::Anim_SkillPointIncrementBase' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, ButtonContinue) == 0x000250, "Member 'UResults_CommanderXP_New_C::ButtonContinue' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, ImageSkillPointDynamic1) == 0x000258, "Member 'UResults_CommanderXP_New_C::ImageSkillPointDynamic1' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, ImageSkillPointDynamic2) == 0x000260, "Member 'UResults_CommanderXP_New_C::ImageSkillPointDynamic2' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, ImageSkillPointStatic) == 0x000268, "Member 'UResults_CommanderXP_New_C::ImageSkillPointStatic' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, PlayerBanner) == 0x000270, "Member 'UResults_CommanderXP_New_C::PlayerBanner' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, SafeZone_0) == 0x000278, "Member 'UResults_CommanderXP_New_C::SafeZone_0' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, TextFortName) == 0x000280, "Member 'UResults_CommanderXP_New_C::TextFortName' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, TextSkillPointIncrement) == 0x000288, "Member 'UResults_CommanderXP_New_C::TextSkillPointIncrement' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, TextSkillPoints) == 0x000290, "Member 'UResults_CommanderXP_New_C::TextSkillPoints' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, XpBar) == 0x000298, "Member 'UResults_CommanderXP_New_C::XpBar' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, PlayRate) == 0x0002A0, "Member 'UResults_CommanderXP_New_C::PlayRate' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, TimeBetweenIntroAndCount) == 0x0002A4, "Member 'UResults_CommanderXP_New_C::TimeBetweenIntroAndCount' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, TeamTotalScore) == 0x0002A8, "Member 'UResults_CommanderXP_New_C::TeamTotalScore' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, Finished) == 0x0002B0, "Member 'UResults_CommanderXP_New_C::Finished' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, SkillPointsItem) == 0x0002C0, "Member 'UResults_CommanderXP_New_C::SkillPointsItem' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, CurrentSkillPoints) == 0x0002C8, "Member 'UResults_CommanderXP_New_C::CurrentSkillPoints' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, bSkippedToEnd) == 0x0002CC, "Member 'UResults_CommanderXP_New_C::bSkippedToEnd' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, bSkippingToEnd) == 0x0002CD, "Member 'UResults_CommanderXP_New_C::bSkippingToEnd' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, TimeBetweenSkipAndContinue) == 0x0002D0, "Member 'UResults_CommanderXP_New_C::TimeBetweenSkipAndContinue' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, FinalSkillPoints) == 0x0002D4, "Member 'UResults_CommanderXP_New_C::FinalSkillPoints' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, bCanSkipToEnd) == 0x0002D8, "Member 'UResults_CommanderXP_New_C::bCanSkipToEnd' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, XPBarAppear) == 0x0002E0, "Member 'UResults_CommanderXP_New_C::XPBarAppear' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, XPBadge) == 0x0002E8, "Member 'UResults_CommanderXP_New_C::XPBadge' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, PlayerSkillPoint) == 0x0002F0, "Member 'UResults_CommanderXP_New_C::PlayerSkillPoint' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, XPBadgeIncrement) == 0x0002F8, "Member 'UResults_CommanderXP_New_C::XPBadgeIncrement' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXP_New_C, TextSkillPointIncrement_0) == 0x000300, "Member 'UResults_CommanderXP_New_C::TextSkillPointIncrement_0' has a wrong offset!");
