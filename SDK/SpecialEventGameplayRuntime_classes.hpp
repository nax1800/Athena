...
static_assert(sizeof(UFortCameraMode_SpecialEventFocalPoint) == 0x001CE0, "Wrong size on UFortCameraMode_SpecialEventFocalPoint");
...
static_assert(sizeof(USpecialEventCursorPawnComponent) == 0x0003D0, "Wrong size on USpecialEventCursorPawnComponent");
