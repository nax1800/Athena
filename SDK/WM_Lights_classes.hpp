...
static_assert(sizeof(AWM_Lights_C) == 0x000358, "Wrong size on AWM_Lights_C");
static_assert(offsetof(AWM_Lights_C, UberGraphFrame) == 0x000328, "Member 'AWM_Lights_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AWM_Lights_C, Arrow) == 0x000330, "Member 'AWM_Lights_C::Arrow' has a wrong offset!");
static_assert(offsetof(AWM_Lights_C, DirectionalLight) == 0x000338, "Member 'AWM_Lights_C::DirectionalLight' has a wrong offset!");
static_assert(offsetof(AWM_Lights_C, SkyLight) == 0x000340, "Member 'AWM_Lights_C::SkyLight' has a wrong offset!");
static_assert(offsetof(AWM_Lights_C, PointLight1) == 0x000348, "Member 'AWM_Lights_C::PointLight1' has a wrong offset!");
static_assert(offsetof(AWM_Lights_C, DefaultSceneRoot) == 0x000350, "Member 'AWM_Lights_C::DefaultSceneRoot' has a wrong offset!");
