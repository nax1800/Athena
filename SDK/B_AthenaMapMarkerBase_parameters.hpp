...
static_assert(sizeof(B_AthenaMapMarkerBase_C_ExecuteUbergraph_B_AthenaMapMarkerBase) == 0x0000F8, "Wrong size on B_AthenaMapMarkerBase_C_ExecuteUbergraph_B_AthenaMapMarkerBase");
...
static_assert(sizeof(B_AthenaMapMarkerBase_C_UserConstructionScript) == 0x000030, "Wrong size on B_AthenaMapMarkerBase_C_UserConstructionScript");
...
static_assert(offsetof(B_AthenaMapMarkerBase_C_UserConstructionScript, CallFunc_K2_GetComponentLocation_ReturnValue) == 0x000008, "Member 'B_AthenaMapMarkerBase_C_UserConstructionScript::CallFunc_K2_GetComponentLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_AthenaMapMarkerBase_C_UserConstructionScript, CallFunc_Conv_VectorToLinearColor_ReturnValue) == 0x000014, "Member 'B_AthenaMapMarkerBase_C_UserConstructionScript::CallFunc_Conv_VectorToLinearColor_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_AthenaMapMarkerBase_C_UserConstructionScript, CallFunc_CreateDynamicMaterialInstance_ReturnValue1) == 0x000028, "Member 'B_AthenaMapMarkerBase_C_UserConstructionScript::CallFunc_CreateDynamicMaterialInstance_ReturnValue1' has a wrong offset!");
