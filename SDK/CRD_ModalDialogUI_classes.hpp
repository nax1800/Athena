...
static_assert(sizeof(UCreativeModalDialogViewmodel) == 0x000188, "Wrong size on UCreativeModalDialogViewmodel");
...
static_assert(sizeof(UCreativeModalDialogWidget) == 0x000418, "Wrong size on UCreativeModalDialogWidget");
