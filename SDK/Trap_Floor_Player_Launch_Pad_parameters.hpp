...
static_assert(offsetof(Trap_Floor_Player_Launch_Pad_C_ExecuteUbergraph_Trap_Floor_Player_Launch_Pad, CallFunc_K2_GetActorLocation_ReturnValue2) == 0x000424, "Member 'Trap_Floor_Player_Launch_Pad_C_ExecuteUbergraph_Trap_Floor_Player_Launch_Pad::CallFunc_K2_GetActorLocation_ReturnValue2' has a wrong offset!");
...
static_assert(offsetof(Trap_Floor_Player_Launch_Pad_C_ExecuteUbergraph_Trap_Floor_Player_Launch_Pad, CallFunc_K2_GetActorLocation_ReturnValue3) == 0x00043C, "Member 'Trap_Floor_Player_Launch_Pad_C_ExecuteUbergraph_Trap_Floor_Player_Launch_Pad::CallFunc_K2_GetActorLocation_ReturnValue3' has a wrong offset!");
...
static_assert(offsetof(Trap_Floor_Player_Launch_Pad_C_ExecuteUbergraph_Trap_Floor_Player_Launch_Pad, CallFunc_K2_GetComponentLocation_ReturnValue2) == 0x000610, "Member 'Trap_Floor_Player_Launch_Pad_C_ExecuteUbergraph_Trap_Floor_Player_Launch_Pad::CallFunc_K2_GetComponentLocation_ReturnValue2' has a wrong offset!");
