...
static_assert(sizeof(GCN_NPC_Ice_C_OnActive) == 0x000250, "Wrong size on GCN_NPC_Ice_C_OnActive");
...
static_assert(offsetof(GCN_NPC_Ice_C_OnActive, K2Node_DynamicCast_AsTaker_Pawn) == 0x0000E8, "Member 'GCN_NPC_Ice_C_OnActive::K2Node_DynamicCast_AsTaker_Pawn' has a wrong offset!");
...
static_assert(offsetof(GCN_NPC_Ice_C_OnActive, K2Node_DynamicCast_AsFlinger_Pawn) == 0x0000F8, "Member 'GCN_NPC_Ice_C_OnActive::K2Node_DynamicCast_AsFlinger_Pawn' has a wrong offset!");
...
static_assert(offsetof(GCN_NPC_Ice_C_OnActive, Temp_bool_Variable) == 0x0001D0, "Member 'GCN_NPC_Ice_C_OnActive::Temp_bool_Variable' has a wrong offset!");
...
static_assert(offsetof(GCN_NPC_Ice_C_OnActive, Temp_int_Loop_Counter_Variable) == 0x0001E8, "Member 'GCN_NPC_Ice_C_OnActive::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(GCN_NPC_Ice_C_OnActive, CallFunc_Less_IntInt_ReturnValue) == 0x0001EC, "Member 'GCN_NPC_Ice_C_OnActive::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCN_NPC_Ice_C_OnActive, CallFunc_Add_IntInt_ReturnValue) == 0x0001F0, "Member 'GCN_NPC_Ice_C_OnActive::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCN_NPC_Ice_C_OnActive, Temp_bool_Variable1) == 0x0001F4, "Member 'GCN_NPC_Ice_C_OnActive::Temp_bool_Variable1' has a wrong offset!");
static_assert(offsetof(GCN_NPC_Ice_C_OnActive, CallFunc_IsDedicatedServer_ReturnValue) == 0x0001F5, "Member 'GCN_NPC_Ice_C_OnActive::CallFunc_IsDedicatedServer_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCN_NPC_Ice_C_OnActive, CallFunc_K2_AttachToComponent_ReturnValue) == 0x0001F6, "Member 'GCN_NPC_Ice_C_OnActive::CallFunc_K2_AttachToComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCN_NPC_Ice_C_OnActive, Temp_string_Variable1) == 0x0001F8, "Member 'GCN_NPC_Ice_C_OnActive::Temp_string_Variable1' has a wrong offset!");
static_assert(offsetof(GCN_NPC_Ice_C_OnActive, K2Node_Select_Default) == 0x000208, "Member 'GCN_NPC_Ice_C_OnActive::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(GCN_NPC_Ice_C_OnActive, CallFunc_Map_Find_Value) == 0x000218, "Member 'GCN_NPC_Ice_C_OnActive::CallFunc_Map_Find_Value' has a wrong offset!");
static_assert(offsetof(GCN_NPC_Ice_C_OnActive, CallFunc_Map_Find_ReturnValue) == 0x000220, "Member 'GCN_NPC_Ice_C_OnActive::CallFunc_Map_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCN_NPC_Ice_C_OnActive, Temp_bool_True_if_break_was_hit_Variable) == 0x000221, "Member 'GCN_NPC_Ice_C_OnActive::Temp_bool_True_if_break_was_hit_Variable' has a wrong offset!");
static_assert(offsetof(GCN_NPC_Ice_C_OnActive, Temp_int_Array_Index_Variable) == 0x000224, "Member 'GCN_NPC_Ice_C_OnActive::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(GCN_NPC_Ice_C_OnActive, CallFunc_Array_Get_Item) == 0x000228, "Member 'GCN_NPC_Ice_C_OnActive::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(GCN_NPC_Ice_C_OnActive, CallFunc_Conv_NameToString_ReturnValue) == 0x000230, "Member 'GCN_NPC_Ice_C_OnActive::CallFunc_Conv_NameToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCN_NPC_Ice_C_OnActive, CallFunc_Map_Contains_ReturnValue) == 0x000240, "Member 'GCN_NPC_Ice_C_OnActive::CallFunc_Map_Contains_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCN_NPC_Ice_C_OnActive, CallFunc_Not_PreBool_ReturnValue) == 0x000241, "Member 'GCN_NPC_Ice_C_OnActive::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCN_NPC_Ice_C_OnActive, CallFunc_BooleanAND_ReturnValue) == 0x000242, "Member 'GCN_NPC_Ice_C_OnActive::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(GCN_NPC_Ice_C_OnRemove, K2Node_DynamicCast_AsTaker_Pawn) == 0x0000C8, "Member 'GCN_NPC_Ice_C_OnRemove::K2Node_DynamicCast_AsTaker_Pawn' has a wrong offset!");
...
static_assert(offsetof(GCN_NPC_Ice_C_OnRemove, K2Node_DynamicCast_AsFlinger_Pawn) == 0x0000D8, "Member 'GCN_NPC_Ice_C_OnRemove::K2Node_DynamicCast_AsFlinger_Pawn' has a wrong offset!");
