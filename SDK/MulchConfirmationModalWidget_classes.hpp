...
static_assert(sizeof(UMulchConfirmationModalWidget_C) == 0x000408, "Wrong size on UMulchConfirmationModalWidget_C");
static_assert(offsetof(UMulchConfirmationModalWidget_C, UberGraphFrame) == 0x000348, "Member 'UMulchConfirmationModalWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UMulchConfirmationModalWidget_C, ConfirmButton) == 0x000350, "Member 'UMulchConfirmationModalWidget_C::ConfirmButton' has a wrong offset!");
static_assert(offsetof(UMulchConfirmationModalWidget_C, DeclineButton) == 0x000358, "Member 'UMulchConfirmationModalWidget_C::DeclineButton' has a wrong offset!");
static_assert(offsetof(UMulchConfirmationModalWidget_C, Lightbox_NUI) == 0x000360, "Member 'UMulchConfirmationModalWidget_C::Lightbox_NUI' has a wrong offset!");
static_assert(offsetof(UMulchConfirmationModalWidget_C, RootOverlay) == 0x000368, "Member 'UMulchConfirmationModalWidget_C::RootOverlay' has a wrong offset!");
static_assert(offsetof(UMulchConfirmationModalWidget_C, TitleWidget) == 0x000370, "Member 'UMulchConfirmationModalWidget_C::TitleWidget' has a wrong offset!");
static_assert(offsetof(UMulchConfirmationModalWidget_C, TotalItemsText) == 0x000378, "Member 'UMulchConfirmationModalWidget_C::TotalItemsText' has a wrong offset!");
static_assert(offsetof(UMulchConfirmationModalWidget_C, TotalWarningsText) == 0x000380, "Member 'UMulchConfirmationModalWidget_C::TotalWarningsText' has a wrong offset!");
static_assert(offsetof(UMulchConfirmationModalWidget_C, WarningImage) == 0x000388, "Member 'UMulchConfirmationModalWidget_C::WarningImage' has a wrong offset!");
static_assert(offsetof(UMulchConfirmationModalWidget_C, WarningList) == 0x000390, "Member 'UMulchConfirmationModalWidget_C::WarningList' has a wrong offset!");
static_assert(offsetof(UMulchConfirmationModalWidget_C, ItemsToMulch) == 0x000398, "Member 'UMulchConfirmationModalWidget_C::ItemsToMulch' has a wrong offset!");
static_assert(offsetof(UMulchConfirmationModalWidget_C, WarningItemMap) == 0x0003A8, "Member 'UMulchConfirmationModalWidget_C::WarningItemMap' has a wrong offset!");
static_assert(offsetof(UMulchConfirmationModalWidget_C, HoveredItem) == 0x0003F8, "Member 'UMulchConfirmationModalWidget_C::HoveredItem' has a wrong offset!");
static_assert(offsetof(UMulchConfirmationModalWidget_C, SelectedItem) == 0x000400, "Member 'UMulchConfirmationModalWidget_C::SelectedItem' has a wrong offset!");
