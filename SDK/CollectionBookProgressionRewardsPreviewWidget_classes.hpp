...
static_assert(sizeof(UCollectionBookProgressionRewardsPreviewWidget_C) == 0x000248, "Wrong size on UCollectionBookProgressionRewardsPreviewWidget_C");
static_assert(offsetof(UCollectionBookProgressionRewardsPreviewWidget_C, Image_0) == 0x000240, "Member 'UCollectionBookProgressionRewardsPreviewWidget_C::Image_0' has a wrong offset!");
