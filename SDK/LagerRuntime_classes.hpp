...
public:
	...
	void OnActorDestroyed__DelegateSignature(class AActor* DestroyedActor, const class UFortAthenaLivingWorldEventData* EventData);
	void OnActorDied__DelegateSignature(class AActor* DiedActor);
	void OnActorSpawned__DelegateSignature(class AActor* SpawnedActor, const class UFortAthenaLivingWorldEventData* EventData);
...
static_assert(sizeof(AFortAthenaLivingWorldPrefab) == 0x000948, "Wrong size on AFortAthenaLivingWorldPrefab");
