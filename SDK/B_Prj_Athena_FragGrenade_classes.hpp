...
static_assert(sizeof(AB_Prj_Athena_FragGrenade_C) == 0x000768, "Wrong size on AB_Prj_Athena_FragGrenade_C");
static_assert(offsetof(AB_Prj_Athena_FragGrenade_C, UberGraphFrame_B_Prj_Athena_FragGrenade_C) == 0x000760, "Member 'AB_Prj_Athena_FragGrenade_C::UberGraphFrame_B_Prj_Athena_FragGrenade_C' has a wrong offset!");
