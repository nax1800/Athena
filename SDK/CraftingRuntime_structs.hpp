...
static_assert(sizeof(FCraftingObjectEntryState) == 0x000028, "Wrong size on FCraftingObjectEntryState");
...
static_assert(sizeof(FCraftingObjectServerStateData) == 0x0001F0, "Wrong size on FCraftingObjectServerStateData");
...
static_assert(sizeof(FCraftingFormula) == 0x0000B8, "Wrong size on FCraftingFormula");
