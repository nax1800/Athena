...
static_assert(offsetof(AthenaTeamScoreWidget_C_UpdateScore, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000080, "Member 'AthenaTeamScoreWidget_C_UpdateScore::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaTeamScoreWidget_C_UpdateScore, CallFunc_Conv_IntToFloat_ReturnValue1) == 0x000088, "Member 'AthenaTeamScoreWidget_C_UpdateScore::CallFunc_Conv_IntToFloat_ReturnValue1' has a wrong offset!");
...
public:
	...
	class UUMGSequencePlayer*                     CallFunc_PlayAnimationAtTime_ReturnValue;          // 0x0110(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         K2Node_Select1_Default;                            // 0x011C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         K2Node_Select4_Default;                            // 0x0140(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(AthenaTeamScoreWidget_C_UpdatePlacement, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000110, "Member 'AthenaTeamScoreWidget_C_UpdatePlacement::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(AthenaTeamScoreWidget_C_UpdatePlacement, K2Node_Select1_Default) == 0x00011C, "Member 'AthenaTeamScoreWidget_C_UpdatePlacement::K2Node_Select1_Default' has a wrong offset!");
static_assert(offsetof(AthenaTeamScoreWidget_C_UpdatePlacement, K2Node_Select2_Default) == 0x000120, "Member 'AthenaTeamScoreWidget_C_UpdatePlacement::K2Node_Select2_Default' has a wrong offset!");
static_assert(offsetof(AthenaTeamScoreWidget_C_UpdatePlacement, K2Node_Select3_Default) == 0x000138, "Member 'AthenaTeamScoreWidget_C_UpdatePlacement::K2Node_Select3_Default' has a wrong offset!");
static_assert(offsetof(AthenaTeamScoreWidget_C_UpdatePlacement, K2Node_Select4_Default) == 0x000140, "Member 'AthenaTeamScoreWidget_C_UpdatePlacement::K2Node_Select4_Default' has a wrong offset!");
