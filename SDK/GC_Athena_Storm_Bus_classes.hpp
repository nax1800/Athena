...
static_assert(sizeof(AGC_Athena_Storm_Bus_C) == 0x000900, "Wrong size on AGC_Athena_Storm_Bus_C");
static_assert(offsetof(AGC_Athena_Storm_Bus_C, UberGraphFrame) == 0x000898, "Member 'AGC_Athena_Storm_Bus_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AGC_Athena_Storm_Bus_C, Lightining_Flash_LERP_1FC138BF41C8F8C6CC68BAA96F2470A1) == 0x0008A0, "Member 'AGC_Athena_Storm_Bus_C::Lightining_Flash_LERP_1FC138BF41C8F8C6CC68BAA96F2470A1' has a wrong offset!");
static_assert(offsetof(AGC_Athena_Storm_Bus_C, Lightining_Flash__Direction_1FC138BF41C8F8C6CC68BAA96F2470A1) == 0x0008A4, "Member 'AGC_Athena_Storm_Bus_C::Lightining_Flash__Direction_1FC138BF41C8F8C6CC68BAA96F2470A1' has a wrong offset!");
static_assert(offsetof(AGC_Athena_Storm_Bus_C, Lightining_Flash) == 0x0008A8, "Member 'AGC_Athena_Storm_Bus_C::Lightining_Flash' has a wrong offset!");
static_assert(offsetof(AGC_Athena_Storm_Bus_C, LightningSpawnLocation) == 0x0008B0, "Member 'AGC_Athena_Storm_Bus_C::LightningSpawnLocation' has a wrong offset!");
static_assert(offsetof(AGC_Athena_Storm_Bus_C, Bus_Actor) == 0x0008C0, "Member 'AGC_Athena_Storm_Bus_C::Bus_Actor' has a wrong offset!");
static_assert(offsetof(AGC_Athena_Storm_Bus_C, _ChanceOfLightningMesh) == 0x0008C8, "Member 'AGC_Athena_Storm_Bus_C::_ChanceOfLightningMesh' has a wrong offset!");
static_assert(offsetof(AGC_Athena_Storm_Bus_C, LightningFlashDiameter) == 0x0008CC, "Member 'AGC_Athena_Storm_Bus_C::LightningFlashDiameter' has a wrong offset!");
static_assert(offsetof(AGC_Athena_Storm_Bus_C, LightningFlashHeight) == 0x0008D0, "Member 'AGC_Athena_Storm_Bus_C::LightningFlashHeight' has a wrong offset!");
static_assert(offsetof(AGC_Athena_Storm_Bus_C, RandomLightningLight) == 0x0008D8, "Member 'AGC_Athena_Storm_Bus_C::RandomLightningLight' has a wrong offset!");
static_assert(offsetof(AGC_Athena_Storm_Bus_C, LightningIntensityMin) == 0x0008E0, "Member 'AGC_Athena_Storm_Bus_C::LightningIntensityMin' has a wrong offset!");
static_assert(offsetof(AGC_Athena_Storm_Bus_C, LightningIntensityMax) == 0x0008E4, "Member 'AGC_Athena_Storm_Bus_C::LightningIntensityMax' has a wrong offset!");
static_assert(offsetof(AGC_Athena_Storm_Bus_C, LightningIntensity) == 0x0008E8, "Member 'AGC_Athena_Storm_Bus_C::LightningIntensity' has a wrong offset!");
static_assert(offsetof(AGC_Athena_Storm_Bus_C, LightningTimelinePlaySpeedMin) == 0x0008EC, "Member 'AGC_Athena_Storm_Bus_C::LightningTimelinePlaySpeedMin' has a wrong offset!");
static_assert(offsetof(AGC_Athena_Storm_Bus_C, LightningTimelinePlaySpeedMax) == 0x0008F0, "Member 'AGC_Athena_Storm_Bus_C::LightningTimelinePlaySpeedMax' has a wrong offset!");
static_assert(offsetof(AGC_Athena_Storm_Bus_C, LightningFlashRepeatDelayMin) == 0x0008F4, "Member 'AGC_Athena_Storm_Bus_C::LightningFlashRepeatDelayMin' has a wrong offset!");
static_assert(offsetof(AGC_Athena_Storm_Bus_C, LightningFlashRepeatDelayMax) == 0x0008F8, "Member 'AGC_Athena_Storm_Bus_C::LightningFlashRepeatDelayMax' has a wrong offset!");
