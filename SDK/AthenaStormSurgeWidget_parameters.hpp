...
public:
	...
	struct FMargin                                K2Node_MakeStruct_Margin;                          // 0x0018(0x0010)(IsPlainOldData, NoDestructor)
	bool                                          K2Node_Event_IsDesignTime;                         // 0x0028(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_29[0x3];                                       // 0x0029(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMargin                                K2Node_MakeStruct_Margin1;                         // 0x002C(0x0010)(IsPlainOldData, NoDestructor)
	...
	class FText                                   CallFunc_TextToUpper_ReturnValue1;                 // 0x00A0(0x0018)()
	...
	class UVerticalBoxSlot*                       CallFunc_SlotAsVerticalBoxSlot_ReturnValue1;       // 0x00C0(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(AthenaStormSurgeWidget_C_ExecuteUbergraph_AthenaStormSurgeWidget, CallFunc_SlotAsOverlaySlot_ReturnValue1) == 0x000010, "Member 'AthenaStormSurgeWidget_C_ExecuteUbergraph_AthenaStormSurgeWidget::CallFunc_SlotAsOverlaySlot_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(AthenaStormSurgeWidget_C_ExecuteUbergraph_AthenaStormSurgeWidget, K2Node_MakeStruct_Margin1) == 0x00002C, "Member 'AthenaStormSurgeWidget_C_ExecuteUbergraph_AthenaStormSurgeWidget::K2Node_MakeStruct_Margin1' has a wrong offset!");
...
static_assert(offsetof(AthenaStormSurgeWidget_C_ExecuteUbergraph_AthenaStormSurgeWidget, CallFunc_TextToUpper_ReturnValue1) == 0x0000A0, "Member 'AthenaStormSurgeWidget_C_ExecuteUbergraph_AthenaStormSurgeWidget::CallFunc_TextToUpper_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(AthenaStormSurgeWidget_C_ExecuteUbergraph_AthenaStormSurgeWidget, CallFunc_SlotAsVerticalBoxSlot_ReturnValue1) == 0x0000C0, "Member 'AthenaStormSurgeWidget_C_ExecuteUbergraph_AthenaStormSurgeWidget::CallFunc_SlotAsVerticalBoxSlot_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(AthenaStormSurgeWidget_C_Anim_AboveDMGClose, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000000, "Member 'AthenaStormSurgeWidget_C_Anim_AboveDMGClose::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(AthenaStormSurgeWidget_C_Anim_AboveDMGOpen, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000000, "Member 'AthenaStormSurgeWidget_C_Anim_AboveDMGOpen::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(AthenaStormSurgeWidget_C_Anim_BelowDMGClose, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000000, "Member 'AthenaStormSurgeWidget_C_Anim_BelowDMGClose::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(AthenaStormSurgeWidget_C_Anim_BelowDMGOpen, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000008, "Member 'AthenaStormSurgeWidget_C_Anim_BelowDMGOpen::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(AthenaStormSurgeWidget_C_Anim_Load, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000000, "Member 'AthenaStormSurgeWidget_C_Anim_Load::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
