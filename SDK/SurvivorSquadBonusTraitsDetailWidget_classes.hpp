...
static_assert(sizeof(USurvivorSquadBonusTraitsDetailWidget_C) == 0x0004E8, "Wrong size on USurvivorSquadBonusTraitsDetailWidget_C");
...
static_assert(offsetof(USurvivorSquadBonusTraitsDetailWidget_C, NormalCheckmarkBrush) == 0x0003D8, "Member 'USurvivorSquadBonusTraitsDetailWidget_C::NormalCheckmarkBrush' has a wrong offset!");
static_assert(offsetof(USurvivorSquadBonusTraitsDetailWidget_C, NonMatchBrush) == 0x000460, "Member 'USurvivorSquadBonusTraitsDetailWidget_C::NonMatchBrush' has a wrong offset!");
