...
static_assert(sizeof(MatchObjectivesOptionEntryWidget_OnMatchObjectiveEntrySetup) == 0x000178, "Wrong size on MatchObjectivesOptionEntryWidget_OnMatchObjectiveEntrySetup");
