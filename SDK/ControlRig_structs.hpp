...
static_assert(offsetof(FRigUnit_ConvertVectorRotation, Input) == 0x000020, "Member 'FRigUnit_ConvertVectorRotation::Input' has a wrong offset!");
static_assert(offsetof(FRigUnit_ConvertVectorRotation, Result) == 0x000030, "Member 'FRigUnit_ConvertVectorRotation::Result' has a wrong offset!");
...
{
public:
	uint8                                         Pad_800[0x1C0];                                    // 0x0800(0x01C0)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(FRigUnit_GetJointTransform) == 0x000080, "Wrong size on FRigUnit_GetJointTransform");
...
static_assert(offsetof(FRigUnit_GetJointTransform, Output) == 0x000050, "Member 'FRigUnit_GetJointTransform::Output' has a wrong offset!");
