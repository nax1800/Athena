...
static_assert(sizeof(URotatingStarburstWidget_C) == 0x000240, "Wrong size on URotatingStarburstWidget_C");
static_assert(offsetof(URotatingStarburstWidget_C, UberGraphFrame) == 0x000228, "Member 'URotatingStarburstWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(URotatingStarburstWidget_C, Image_0) == 0x000230, "Member 'URotatingStarburstWidget_C::Image_0' has a wrong offset!");
static_assert(offsetof(URotatingStarburstWidget_C, RotationSpeed) == 0x000238, "Member 'URotatingStarburstWidget_C::RotationSpeed' has a wrong offset!");
