...
public:
	...
	class FText                                   Temp_text_Variable91;                              // 0x08C0(0x0018)()
	class FText                                   Temp_text_Variable92;                              // 0x08D8(0x0018)()
	...
	class FText                                   CallFunc_MakeLiteralText_ReturnValue1;             // 0x0950(0x0018)()
	...
	struct FFormatArgumentData                    K2Node_MakeStruct_FormatArgumentData1;             // 0x0970(0x0040)(HasGetValueTypeHash)
	struct FFortRarityItemData                    CallFunc_BPGetRarityData_ReturnValue;              // 0x09B0(0x0080)()
	struct FFortRarityItemData                    CallFunc_BPGetRarityData_ReturnValue1;             // 0x0A30(0x0080)()
	struct FFormatArgumentData                    K2Node_MakeStruct_FormatArgumentData2;             // 0x0AB0(0x0040)(HasGetValueTypeHash)
	struct FFormatArgumentData                    K2Node_MakeStruct_FormatArgumentData3;             // 0x0AF0(0x0040)(HasGetValueTypeHash)
	struct FFortRarityItemData                    CallFunc_BPGetRarityData_ReturnValue2;             // 0x0B30(0x0080)()
	...
	struct FFormatArgumentData                    K2Node_MakeStruct_FormatArgumentData4;             // 0x0BD8(0x0040)(HasGetValueTypeHash)
	class UFortItem*                              CallFunc_GetItemInstance_ReturnValue1;             // 0x0C18(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UFortItem*                              CallFunc_GetItemInstance_ReturnValue2;             // 0x0C30(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FFormatArgumentData                    K2Node_MakeStruct_FormatArgumentData5;             // 0x0CE8(0x0040)(HasGetValueTypeHash)
	class UFortItem*                              CallFunc_GetItemInstance_ReturnValue3;             // 0x0D28(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<struct FFormatArgumentData>            K2Node_MakeArray_Array1;                           // 0x0D30(0x0010)(ZeroConstructor, ReferenceParm)
	...
	bool                                          CallFunc_EqualEqual_ByteByte_ReturnValue1;         // 0x0D60(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_D61[0x7];                                      // 0x0D61(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UFortItem*                              CallFunc_GetItemInstance_ReturnValue4;             // 0x0D68(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EFortItemType                                 CallFunc_GetType_ReturnValue1;                     // 0x0D70(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_D71[0x7];                                      // 0x0D71(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   K2Node_Select_Default;                             // 0x0D78(0x0018)()
	struct FFormatArgumentData                    K2Node_MakeStruct_FormatArgumentData6;             // 0x0D90(0x0040)(HasGetValueTypeHash)
	TArray<struct FFormatArgumentData>            K2Node_MakeArray_Array2;                           // 0x0DD0(0x0010)(ZeroConstructor, ReferenceParm)
	class FText                                   CallFunc_Format_ReturnValue2;                      // 0x0DE0(0x0018)()
};
...
static_assert(sizeof(RewardInfoSimpleMediumWidget_C_GetDisplayName) == 0x000DF8, "Wrong size on RewardInfoSimpleMediumWidget_C_GetDisplayName");
...
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, Temp_text_Variable91) == 0x0008C0, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::Temp_text_Variable91' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, Temp_text_Variable92) == 0x0008D8, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::Temp_text_Variable92' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, CallFunc_MakeLiteralText_ReturnValue) == 0x0008F0, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::CallFunc_MakeLiteralText_ReturnValue' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, K2Node_MakeStruct_FormatArgumentData) == 0x000908, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, CallFunc_GetItemInstance_ReturnValue) == 0x000948, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::CallFunc_GetItemInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, CallFunc_MakeLiteralText_ReturnValue1) == 0x000950, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::CallFunc_MakeLiteralText_ReturnValue1' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, CallFunc_GetRarity_ReturnValue) == 0x000968, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::CallFunc_GetRarity_ReturnValue' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, K2Node_MakeStruct_FormatArgumentData1) == 0x000970, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::K2Node_MakeStruct_FormatArgumentData1' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, CallFunc_BPGetRarityData_ReturnValue) == 0x0009B0, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::CallFunc_BPGetRarityData_ReturnValue' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, CallFunc_BPGetRarityData_ReturnValue1) == 0x000A30, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::CallFunc_BPGetRarityData_ReturnValue1' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, K2Node_MakeStruct_FormatArgumentData2) == 0x000AB0, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::K2Node_MakeStruct_FormatArgumentData2' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, K2Node_MakeStruct_FormatArgumentData3) == 0x000AF0, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::K2Node_MakeStruct_FormatArgumentData3' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, CallFunc_BPGetRarityData_ReturnValue2) == 0x000B30, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::CallFunc_BPGetRarityData_ReturnValue2' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, K2Node_MakeArray_Array) == 0x000BB0, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, CallFunc_Format_ReturnValue) == 0x000BC0, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, K2Node_MakeStruct_FormatArgumentData4) == 0x000BD8, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::K2Node_MakeStruct_FormatArgumentData4' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, CallFunc_GetItemInstance_ReturnValue1) == 0x000C18, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::CallFunc_GetItemInstance_ReturnValue1' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, K2Node_DynamicCast_AsFort_Worker) == 0x000C20, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::K2Node_DynamicCast_AsFort_Worker' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, K2Node_DynamicCast_bSuccess) == 0x000C28, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, CallFunc_GetFilterCategory_ReturnValue) == 0x000C29, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::CallFunc_GetFilterCategory_ReturnValue' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, CallFunc_GetItemInstance_ReturnValue2) == 0x000C30, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::CallFunc_GetItemInstance_ReturnValue2' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000C38, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, CallFunc_GetTertiaryCategory_ItemCategoryText) == 0x000C40, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::CallFunc_GetTertiaryCategory_ItemCategoryText' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, CallFunc_GetTertiaryCategory_ItemCategoryBrush) == 0x000C58, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::CallFunc_GetTertiaryCategory_ItemCategoryBrush' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, CallFunc_GetTertiaryCategory_ReturnValue) == 0x000CE0, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::CallFunc_GetTertiaryCategory_ReturnValue' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, K2Node_MakeStruct_FormatArgumentData5) == 0x000CE8, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::K2Node_MakeStruct_FormatArgumentData5' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, CallFunc_GetItemInstance_ReturnValue3) == 0x000D28, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::CallFunc_GetItemInstance_ReturnValue3' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, K2Node_MakeArray_Array1) == 0x000D30, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::K2Node_MakeArray_Array1' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, CallFunc_GetType_ReturnValue) == 0x000D40, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::CallFunc_GetType_ReturnValue' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, CallFunc_Format_ReturnValue1) == 0x000D48, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::CallFunc_Format_ReturnValue1' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, CallFunc_EqualEqual_ByteByte_ReturnValue1) == 0x000D60, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::CallFunc_EqualEqual_ByteByte_ReturnValue1' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, CallFunc_GetItemInstance_ReturnValue4) == 0x000D68, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::CallFunc_GetItemInstance_ReturnValue4' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, CallFunc_GetType_ReturnValue1) == 0x000D70, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::CallFunc_GetType_ReturnValue1' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, K2Node_Select_Default) == 0x000D78, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, K2Node_MakeStruct_FormatArgumentData6) == 0x000D90, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::K2Node_MakeStruct_FormatArgumentData6' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, K2Node_MakeArray_Array2) == 0x000DD0, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::K2Node_MakeArray_Array2' has a wrong offset!");
static_assert(offsetof(RewardInfoSimpleMediumWidget_C_GetDisplayName, CallFunc_Format_ReturnValue2) == 0x000DE0, "Member 'RewardInfoSimpleMediumWidget_C_GetDisplayName::CallFunc_Format_ReturnValue2' has a wrong offset!");
