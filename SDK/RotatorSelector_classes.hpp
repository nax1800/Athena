...
static_assert(offsetof(URotatorSelector_C, NameBox) == 0x000230, "Member 'URotatorSelector_C::NameBox' has a wrong offset!");
static_assert(offsetof(URotatorSelector_C, Spacer_0) == 0x000238, "Member 'URotatorSelector_C::Spacer_0' has a wrong offset!");
static_assert(offsetof(URotatorSelector_C, TextRotator) == 0x000240, "Member 'URotatorSelector_C::TextRotator' has a wrong offset!");
static_assert(offsetof(URotatorSelector_C, SelectedIndex) == 0x000248, "Member 'URotatorSelector_C::SelectedIndex' has a wrong offset!");
static_assert(offsetof(URotatorSelector_C, HoverText) == 0x000250, "Member 'URotatorSelector_C::HoverText' has a wrong offset!");
static_assert(offsetof(URotatorSelector_C, Selection_Changed) == 0x000268, "Member 'URotatorSelector_C::Selection_Changed' has a wrong offset!");
static_assert(offsetof(URotatorSelector_C, Tab_Tooltip_Text) == 0x000278, "Member 'URotatorSelector_C::Tab_Tooltip_Text' has a wrong offset!");
static_assert(offsetof(URotatorSelector_C, Spacer_Width) == 0x000280, "Member 'URotatorSelector_C::Spacer_Width' has a wrong offset!");
