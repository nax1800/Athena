...
static_assert(sizeof(URotatorSelector_C) == 0x0002A8, "Wrong size on URotatorSelector_C");
...
static_assert(offsetof(URotatorSelector_C, NameBox) == 0x000250, "Member 'URotatorSelector_C::NameBox' has a wrong offset!");
static_assert(offsetof(URotatorSelector_C, Spacer_0) == 0x000258, "Member 'URotatorSelector_C::Spacer_0' has a wrong offset!");
static_assert(offsetof(URotatorSelector_C, TextRotator) == 0x000260, "Member 'URotatorSelector_C::TextRotator' has a wrong offset!");
static_assert(offsetof(URotatorSelector_C, SelectedIndex) == 0x000268, "Member 'URotatorSelector_C::SelectedIndex' has a wrong offset!");
static_assert(offsetof(URotatorSelector_C, HoverText) == 0x000270, "Member 'URotatorSelector_C::HoverText' has a wrong offset!");
static_assert(offsetof(URotatorSelector_C, Selection_Changed) == 0x000288, "Member 'URotatorSelector_C::Selection_Changed' has a wrong offset!");
static_assert(offsetof(URotatorSelector_C, Tab_Tooltip_Text) == 0x000298, "Member 'URotatorSelector_C::Tab_Tooltip_Text' has a wrong offset!");
static_assert(offsetof(URotatorSelector_C, Spacer_Width) == 0x0002A0, "Member 'URotatorSelector_C::Spacer_Width' has a wrong offset!");
