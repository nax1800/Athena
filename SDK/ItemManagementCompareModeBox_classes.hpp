...
static_assert(sizeof(UItemManagementCompareModeBox_C) == 0x000390, "Wrong size on UItemManagementCompareModeBox_C");
static_assert(offsetof(UItemManagementCompareModeBox_C, UberGraphFrame) == 0x000340, "Member 'UItemManagementCompareModeBox_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UItemManagementCompareModeBox_C, ComparisonModeBox) == 0x000348, "Member 'UItemManagementCompareModeBox_C::ComparisonModeBox' has a wrong offset!");
static_assert(offsetof(UItemManagementCompareModeBox_C, Image_30) == 0x000350, "Member 'UItemManagementCompareModeBox_C::Image_30' has a wrong offset!");
static_assert(offsetof(UItemManagementCompareModeBox_C, Image_31) == 0x000358, "Member 'UItemManagementCompareModeBox_C::Image_31' has a wrong offset!");
static_assert(offsetof(UItemManagementCompareModeBox_C, Image_62) == 0x000360, "Member 'UItemManagementCompareModeBox_C::Image_62' has a wrong offset!");
static_assert(offsetof(UItemManagementCompareModeBox_C, NoSelectionDetailsBox) == 0x000368, "Member 'UItemManagementCompareModeBox_C::NoSelectionDetailsBox' has a wrong offset!");
static_assert(offsetof(UItemManagementCompareModeBox_C, NoSelectionText) == 0x000370, "Member 'UItemManagementCompareModeBox_C::NoSelectionText' has a wrong offset!");
static_assert(offsetof(UItemManagementCompareModeBox_C, RightSideSwitcher) == 0x000378, "Member 'UItemManagementCompareModeBox_C::RightSideSwitcher' has a wrong offset!");
static_assert(offsetof(UItemManagementCompareModeBox_C, ScrollBoxWidget) == 0x000380, "Member 'UItemManagementCompareModeBox_C::ScrollBoxWidget' has a wrong offset!");
static_assert(offsetof(UItemManagementCompareModeBox_C, SelectionPromptText) == 0x000388, "Member 'UItemManagementCompareModeBox_C::SelectionPromptText' has a wrong offset!");
