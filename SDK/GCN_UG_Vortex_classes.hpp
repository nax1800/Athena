...
static_assert(sizeof(AGCN_UG_Vortex_C) == 0x000460, "Wrong size on AGCN_UG_Vortex_C");
static_assert(offsetof(AGCN_UG_Vortex_C, UberGraphFrame) == 0x000420, "Member 'AGCN_UG_Vortex_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AGCN_UG_Vortex_C, Decal) == 0x000428, "Member 'AGCN_UG_Vortex_C::Decal' has a wrong offset!");
static_assert(offsetof(AGCN_UG_Vortex_C, Timeline_0_Fadein_75866BE446FADE6DDBA68D8D8FA84BF7) == 0x000430, "Member 'AGCN_UG_Vortex_C::Timeline_0_Fadein_75866BE446FADE6DDBA68D8D8FA84BF7' has a wrong offset!");
static_assert(offsetof(AGCN_UG_Vortex_C, Timeline_0__Direction_75866BE446FADE6DDBA68D8D8FA84BF7) == 0x000434, "Member 'AGCN_UG_Vortex_C::Timeline_0__Direction_75866BE446FADE6DDBA68D8D8FA84BF7' has a wrong offset!");
static_assert(offsetof(AGCN_UG_Vortex_C, Timeline_0) == 0x000438, "Member 'AGCN_UG_Vortex_C::Timeline_0' has a wrong offset!");
static_assert(offsetof(AGCN_UG_Vortex_C, OpacMult) == 0x000440, "Member 'AGCN_UG_Vortex_C::OpacMult' has a wrong offset!");
static_assert(offsetof(AGCN_UG_Vortex_C, Decal_MID) == 0x000448, "Member 'AGCN_UG_Vortex_C::Decal_MID' has a wrong offset!");
static_assert(offsetof(AGCN_UG_Vortex_C, EmissiveMult) == 0x000450, "Member 'AGCN_UG_Vortex_C::EmissiveMult' has a wrong offset!");
static_assert(offsetof(AGCN_UG_Vortex_C, Vortex_Powerup_Sound) == 0x000458, "Member 'AGCN_UG_Vortex_C::Vortex_Powerup_Sound' has a wrong offset!");
