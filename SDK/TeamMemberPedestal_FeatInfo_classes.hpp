...
public:
	...
	class UWidgetAnimation*                       FeatInfoSet;                                       // 0x1538(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, RepSkip, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UTeamMemberPedestal_FeatInfo_C) == 0x001540, "Wrong size on UTeamMemberPedestal_FeatInfo_C");
