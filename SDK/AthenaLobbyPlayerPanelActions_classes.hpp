...
static_assert(sizeof(UAthenaLobbyPlayerPanelActions_C) == 0x0004C8, "Wrong size on UAthenaLobbyPlayerPanelActions_C");
...
static_assert(offsetof(UAthenaLobbyPlayerPanelActions_C, OnEmoteClicked) == 0x000458, "Member 'UAthenaLobbyPlayerPanelActions_C::OnEmoteClicked' has a wrong offset!");
static_assert(offsetof(UAthenaLobbyPlayerPanelActions_C, AddFriendText) == 0x000468, "Member 'UAthenaLobbyPlayerPanelActions_C::AddFriendText' has a wrong offset!");
static_assert(offsetof(UAthenaLobbyPlayerPanelActions_C, AcceptInviteText) == 0x000480, "Member 'UAthenaLobbyPlayerPanelActions_C::AcceptInviteText' has a wrong offset!");
static_assert(offsetof(UAthenaLobbyPlayerPanelActions_C, SentInviteText) == 0x000498, "Member 'UAthenaLobbyPlayerPanelActions_C::SentInviteText' has a wrong offset!");
static_assert(offsetof(UAthenaLobbyPlayerPanelActions_C, AcceptedInviteText) == 0x0004B0, "Member 'UAthenaLobbyPlayerPanelActions_C::AcceptedInviteText' has a wrong offset!");
