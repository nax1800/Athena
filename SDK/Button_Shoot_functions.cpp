...
void UButton_Shoot_C::OnHUDStateUpdate(const struct FFortHUDState& NewState)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Button_Shoot_C", "OnHUDStateUpdate");

	Params::Button_Shoot_C_OnHUDStateUpdate Parms{};
