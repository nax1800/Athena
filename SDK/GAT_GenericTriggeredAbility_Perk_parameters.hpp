...
public:
	...
	float                                         CallFunc_GetValue_ReturnValue1;                    // 0x00A8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(GAT_GenericTriggeredAbility_Perk_C_GetCorrectBalanceValue, CallFunc_GetValue_ReturnValue) == 0x000058, "Member 'GAT_GenericTriggeredAbility_Perk_C_GetCorrectBalanceValue::CallFunc_GetValue_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(GAT_GenericTriggeredAbility_Perk_C_GetCorrectBalanceValue, CallFunc_GetValue_ReturnValue1) == 0x0000A8, "Member 'GAT_GenericTriggeredAbility_Perk_C_GetCorrectBalanceValue::CallFunc_GetValue_ReturnValue1' has a wrong offset!");
...
public:
	...
	bool                                          CallFunc_HasTag_ReturnValue;                       // 0x0079(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_BooleanAND_ReturnValue;                   // 0x007A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_7B[0x5];                                       // 0x007B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	class UClass*                                 CallFunc_Map_Find_Value;                           // 0x0080(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Map_Find_ReturnValue;                     // 0x0088(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_BooleanAND_ReturnValue1;                  // 0x0089(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(sizeof(GAT_GenericTriggeredAbility_Perk_C_SetDamageElement) == 0x000090, "Wrong size on GAT_GenericTriggeredAbility_Perk_C_SetDamageElement");
...
static_assert(offsetof(GAT_GenericTriggeredAbility_Perk_C_SetDamageElement, CallFunc_Array_Get_Item) == 0x000070, "Member 'GAT_GenericTriggeredAbility_Perk_C_SetDamageElement::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(GAT_GenericTriggeredAbility_Perk_C_SetDamageElement, CallFunc_Less_IntInt_ReturnValue) == 0x000078, "Member 'GAT_GenericTriggeredAbility_Perk_C_SetDamageElement::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(GAT_GenericTriggeredAbility_Perk_C_SetDamageElement, CallFunc_HasTag_ReturnValue) == 0x000079, "Member 'GAT_GenericTriggeredAbility_Perk_C_SetDamageElement::CallFunc_HasTag_ReturnValue' has a wrong offset!");
static_assert(offsetof(GAT_GenericTriggeredAbility_Perk_C_SetDamageElement, CallFunc_BooleanAND_ReturnValue) == 0x00007A, "Member 'GAT_GenericTriggeredAbility_Perk_C_SetDamageElement::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(GAT_GenericTriggeredAbility_Perk_C_SetDamageElement, CallFunc_Map_Find_Value) == 0x000080, "Member 'GAT_GenericTriggeredAbility_Perk_C_SetDamageElement::CallFunc_Map_Find_Value' has a wrong offset!");
static_assert(offsetof(GAT_GenericTriggeredAbility_Perk_C_SetDamageElement, CallFunc_Map_Find_ReturnValue) == 0x000088, "Member 'GAT_GenericTriggeredAbility_Perk_C_SetDamageElement::CallFunc_Map_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(GAT_GenericTriggeredAbility_Perk_C_SetDamageElement, CallFunc_BooleanAND_ReturnValue1) == 0x000089, "Member 'GAT_GenericTriggeredAbility_Perk_C_SetDamageElement::CallFunc_BooleanAND_ReturnValue1' has a wrong offset!");
