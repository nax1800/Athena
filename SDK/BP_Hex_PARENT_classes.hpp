...
public:
	...
	class UMaterialInstanceDynamic*               MIDMinusSelected;                                  // 0x0660(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<class UStaticMesh*>                    Hex_Deco_Meshes;                                   // 0x0668(0x0010)(Edit, BlueprintVisible, ZeroConstructor)
	class UMaterialInstanceDynamic*               MIDMinusMouseover;                                 // 0x0678(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(ABP_Hex_PARENT_C, MIDMinusSelected) == 0x000660, "Member 'ABP_Hex_PARENT_C::MIDMinusSelected' has a wrong offset!");
...
static_assert(offsetof(ABP_Hex_PARENT_C, MIDMinusMouseover) == 0x000678, "Member 'ABP_Hex_PARENT_C::MIDMinusMouseover' has a wrong offset!");
