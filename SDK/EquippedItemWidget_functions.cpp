...
// Parameters:
// int32                                   ShotsRemaining                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UEquippedItemWidget_C::CustomEvent_0(int32 ShotsRemaining)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("EquippedItemWidget_C", "CustomEvent_0");

	Params::EquippedItemWidget_C_CustomEvent_0 Parms{};

	Parms.ShotsRemaining = ShotsRemaining;
...
void UEquippedItemWidget_C::UpdateMountedTurret()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("EquippedItemWidget_C", "UpdateMountedTurret");
