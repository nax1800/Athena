...
static_assert(sizeof(AGCN_QuestSpawn_MiniMapIcon_C) == 0x000430, "Wrong size on AGCN_QuestSpawn_MiniMapIcon_C");
static_assert(offsetof(AGCN_QuestSpawn_MiniMapIcon_C, UberGraphFrame) == 0x000420, "Member 'AGCN_QuestSpawn_MiniMapIcon_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AGCN_QuestSpawn_MiniMapIcon_C, MiniMapCrosshair) == 0x000428, "Member 'AGCN_QuestSpawn_MiniMapIcon_C::MiniMapCrosshair' has a wrong offset!");
