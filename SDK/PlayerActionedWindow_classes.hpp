...
static_assert(sizeof(UPlayerActionedWindow_C) == 0x000388, "Wrong size on UPlayerActionedWindow_C");
static_assert(offsetof(UPlayerActionedWindow_C, UberGraphFrame) == 0x000358, "Member 'UPlayerActionedWindow_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UPlayerActionedWindow_C, Intro) == 0x000360, "Member 'UPlayerActionedWindow_C::Intro' has a wrong offset!");
static_assert(offsetof(UPlayerActionedWindow_C, CloseButton) == 0x000368, "Member 'UPlayerActionedWindow_C::CloseButton' has a wrong offset!");
static_assert(offsetof(UPlayerActionedWindow_C, Image_34) == 0x000370, "Member 'UPlayerActionedWindow_C::Image_34' has a wrong offset!");
static_assert(offsetof(UPlayerActionedWindow_C, Lightbox) == 0x000378, "Member 'UPlayerActionedWindow_C::Lightbox' has a wrong offset!");
static_assert(offsetof(UPlayerActionedWindow_C, Title) == 0x000380, "Member 'UPlayerActionedWindow_C::Title' has a wrong offset!");
