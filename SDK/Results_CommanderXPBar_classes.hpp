...
public:
	...
	class UWidgetAnimation*                       Anim_FlashBar;                                     // 0x0240(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash)
	...
	class UResults_BonusXpType_C*                 BonusXpType;                                       // 0x0250(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	struct FTimerHandle                           countTimer;                                        // 0x0268(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	...
	class UAudioComponent*                        ACGainXp;                                          // 0x02D8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(UResults_CommanderXPBar_C, UberGraphFrame) == 0x000230, "Member 'UResults_CommanderXPBar_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXPBar_C, Anim_SkipToFinalState) == 0x000238, "Member 'UResults_CommanderXPBar_C::Anim_SkipToFinalState' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXPBar_C, Anim_FlashBar) == 0x000240, "Member 'UResults_CommanderXPBar_C::Anim_FlashBar' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXPBar_C, Anim_Intro) == 0x000248, "Member 'UResults_CommanderXPBar_C::Anim_Intro' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXPBar_C, BonusXpType) == 0x000250, "Member 'UResults_CommanderXPBar_C::BonusXpType' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXPBar_C, ProgressBarNew) == 0x000258, "Member 'UResults_CommanderXPBar_C::ProgressBarNew' has a wrong offset!");
static_assert(offsetof(UResults_CommanderXPBar_C, TextCommanderLevel) == 0x000260, "Member 'UResults_CommanderXPBar_C::TextCommanderLevel' has a wrong offset!");
