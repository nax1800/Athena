...
static_assert(offsetof(MatchmakingRegionAndPool_C_ExecuteUbergraph_MatchmakingRegionAndPool, CallFunc_GetDeprecatedNonInputBasedPlayAgainstText_ReturnValue) == 0x000028, "Member 'MatchmakingRegionAndPool_C_ExecuteUbergraph_MatchmakingRegionAndPool::CallFunc_GetDeprecatedNonInputBasedPlayAgainstText_ReturnValue' has a wrong offset!");
