...
static_assert(alignof(UTT_AirStrike_C) == 0x000008, "Wrong alignment on UTT_AirStrike_C");
static_assert(sizeof(UTT_AirStrike_C) == 0x000168, "Wrong size on UTT_AirStrike_C");
