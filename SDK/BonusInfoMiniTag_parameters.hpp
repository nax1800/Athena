...
static_assert(sizeof(BonusInfoMiniTag_C_ExecuteUbergraph_BonusInfoMiniTag) == 0x0000C8, "Wrong size on BonusInfoMiniTag_C_ExecuteUbergraph_BonusInfoMiniTag");
...
static_assert(alignof(BonusInfoMiniTag_C_UpdateTextColors) == 0x000004, "Wrong alignment on BonusInfoMiniTag_C_UpdateTextColors");
static_assert(sizeof(BonusInfoMiniTag_C_UpdateTextColors) == 0x000014, "Wrong size on BonusInfoMiniTag_C_UpdateTextColors");
