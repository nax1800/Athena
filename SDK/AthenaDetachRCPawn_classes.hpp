...
static_assert(sizeof(UAthenaDetachRCPawn_C) == 0x000248, "Wrong size on UAthenaDetachRCPawn_C");
static_assert(offsetof(UAthenaDetachRCPawn_C, HBox_DetachRCPawn) == 0x000238, "Member 'UAthenaDetachRCPawn_C::HBox_DetachRCPawn' has a wrong offset!");
static_assert(offsetof(UAthenaDetachRCPawn_C, KeybindWidget) == 0x000240, "Member 'UAthenaDetachRCPawn_C::KeybindWidget' has a wrong offset!");
