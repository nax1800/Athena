...
// Parameters:
// class UAthenaReplayBrowserRowProxyInstance*Param_ReplayInfo                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UAthenaReplayBrowserMatchStats_C::SetReplayInfo(class UAthenaReplayBrowserRowProxyInstance* Param_ReplayInfo)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_ReplayInfo = Param_ReplayInfo;
