...
static_assert(sizeof(UAthenaSeasonBPTrackerSimpleWidget_C) == 0x0002B0, "Wrong size on UAthenaSeasonBPTrackerSimpleWidget_C");
...
static_assert(offsetof(UAthenaSeasonBPTrackerSimpleWidget_C, Image_0) == 0x000268, "Member 'UAthenaSeasonBPTrackerSimpleWidget_C::Image_0' has a wrong offset!");
static_assert(offsetof(UAthenaSeasonBPTrackerSimpleWidget_C, Image_1) == 0x000270, "Member 'UAthenaSeasonBPTrackerSimpleWidget_C::Image_1' has a wrong offset!");
static_assert(offsetof(UAthenaSeasonBPTrackerSimpleWidget_C, ItemIcon) == 0x000278, "Member 'UAthenaSeasonBPTrackerSimpleWidget_C::ItemIcon' has a wrong offset!");
static_assert(offsetof(UAthenaSeasonBPTrackerSimpleWidget_C, ItemIconMax) == 0x000280, "Member 'UAthenaSeasonBPTrackerSimpleWidget_C::ItemIconMax' has a wrong offset!");
static_assert(offsetof(UAthenaSeasonBPTrackerSimpleWidget_C, MaxHB) == 0x000288, "Member 'UAthenaSeasonBPTrackerSimpleWidget_C::MaxHB' has a wrong offset!");
static_assert(offsetof(UAthenaSeasonBPTrackerSimpleWidget_C, MaxTextBlock) == 0x000290, "Member 'UAthenaSeasonBPTrackerSimpleWidget_C::MaxTextBlock' has a wrong offset!");
static_assert(offsetof(UAthenaSeasonBPTrackerSimpleWidget_C, ProgressHB) == 0x000298, "Member 'UAthenaSeasonBPTrackerSimpleWidget_C::ProgressHB' has a wrong offset!");
static_assert(offsetof(UAthenaSeasonBPTrackerSimpleWidget_C, TotalText) == 0x0002A0, "Member 'UAthenaSeasonBPTrackerSimpleWidget_C::TotalText' has a wrong offset!");
static_assert(offsetof(UAthenaSeasonBPTrackerSimpleWidget_C, LastBookXP) == 0x0002A8, "Member 'UAthenaSeasonBPTrackerSimpleWidget_C::LastBookXP' has a wrong offset!");
