...
public:
	...
	class UAnimMontage*                           EatMontage;                                        // 0x0948(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UGA_DefaultPlayer_Consumable_C) == 0x000950, "Wrong size on UGA_DefaultPlayer_Consumable_C");
static_assert(offsetof(UGA_DefaultPlayer_Consumable_C, UberGraphFrame) == 0x000940, "Member 'UGA_DefaultPlayer_Consumable_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_DefaultPlayer_Consumable_C, EatMontage) == 0x000948, "Member 'UGA_DefaultPlayer_Consumable_C::EatMontage' has a wrong offset!");
