...
static_assert(sizeof(URewardsIcon_C) == 0x0002A8, "Wrong size on URewardsIcon_C");
...
static_assert(offsetof(URewardsIcon_C, LazyImageIcon) == 0x000228, "Member 'URewardsIcon_C::LazyImageIcon' has a wrong offset!");
...
static_assert(offsetof(URewardsIcon_C, OriginalMaterial) == 0x0002A0, "Member 'URewardsIcon_C::OriginalMaterial' has a wrong offset!");
