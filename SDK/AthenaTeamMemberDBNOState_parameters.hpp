...
static_assert(offsetof(AthenaTeamMemberDBNOState_C_RefreshVisuals, Temp_byte_Variable2) == 0x000004, "Member 'AthenaTeamMemberDBNOState_C_RefreshVisuals::Temp_byte_Variable2' has a wrong offset!");
static_assert(offsetof(AthenaTeamMemberDBNOState_C_RefreshVisuals, Temp_bool_Variable2) == 0x000005, "Member 'AthenaTeamMemberDBNOState_C_RefreshVisuals::Temp_bool_Variable2' has a wrong offset!");
...
static_assert(offsetof(AthenaTeamMemberDBNOState_C_RefreshVisuals, K2Node_Select2_Default) == 0x000021, "Member 'AthenaTeamMemberDBNOState_C_RefreshVisuals::K2Node_Select2_Default' has a wrong offset!");
