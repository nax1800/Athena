...
static_assert(offsetof(BP_ItemTransform_TabButton_C_ExecuteUbergraph_BP_ItemTransform_TabButton, K2Node_MakeStruct_SlateColor2) == 0x000128, "Member 'BP_ItemTransform_TabButton_C_ExecuteUbergraph_BP_ItemTransform_TabButton::K2Node_MakeStruct_SlateColor2' has a wrong offset!");
static_assert(offsetof(BP_ItemTransform_TabButton_C_ExecuteUbergraph_BP_ItemTransform_TabButton, K2Node_MakeStruct_SlateColor3) == 0x000150, "Member 'BP_ItemTransform_TabButton_C_ExecuteUbergraph_BP_ItemTransform_TabButton::K2Node_MakeStruct_SlateColor3' has a wrong offset!");
static_assert(offsetof(BP_ItemTransform_TabButton_C_ExecuteUbergraph_BP_ItemTransform_TabButton, K2Node_MakeStruct_SlateColor4) == 0x000178, "Member 'BP_ItemTransform_TabButton_C_ExecuteUbergraph_BP_ItemTransform_TabButton::K2Node_MakeStruct_SlateColor4' has a wrong offset!");
static_assert(offsetof(BP_ItemTransform_TabButton_C_ExecuteUbergraph_BP_ItemTransform_TabButton, K2Node_MakeStruct_SlateColor5) == 0x0001A0, "Member 'BP_ItemTransform_TabButton_C_ExecuteUbergraph_BP_ItemTransform_TabButton::K2Node_MakeStruct_SlateColor5' has a wrong offset!");
static_assert(offsetof(BP_ItemTransform_TabButton_C_ExecuteUbergraph_BP_ItemTransform_TabButton, K2Node_MakeStruct_SlateColor6) == 0x0001C8, "Member 'BP_ItemTransform_TabButton_C_ExecuteUbergraph_BP_ItemTransform_TabButton::K2Node_MakeStruct_SlateColor6' has a wrong offset!");
