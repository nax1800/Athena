...
static_assert(sizeof(UAthenaBattlePassTrackerWidget_C) == 0x000288, "Wrong size on UAthenaBattlePassTrackerWidget_C");
...
static_assert(offsetof(UAthenaBattlePassTrackerWidget_C, PassImageGlow) == 0x000268, "Member 'UAthenaBattlePassTrackerWidget_C::PassImageGlow' has a wrong offset!");
...
static_assert(offsetof(UAthenaBattlePassTrackerWidget_C, TrackerCB) == 0x000278, "Member 'UAthenaBattlePassTrackerWidget_C::TrackerCB' has a wrong offset!");
static_assert(offsetof(UAthenaBattlePassTrackerWidget_C, UpsellCB) == 0x000280, "Member 'UAthenaBattlePassTrackerWidget_C::UpsellCB' has a wrong offset!");
