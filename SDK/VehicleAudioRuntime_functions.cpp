...
void UFortVehicleAudioControllerUpdater::UpdateControllers(const float DeltaTime, TArray<TScriptInterface<class IFortVehicleAudioControllerInterface>>* ControllersToUpdate)
{
	static class UFunction* Func = nullptr;
