...
public:
	...
	bool                                          CallFunc_K2_AttachToComponent_ReturnValue;         // 0x0213(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_K2_AttachToComponent_ReturnValue1;        // 0x0214(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsValid_ReturnValue3;                     // 0x0215(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_SwitchEnum2_CmpSuccess;                     // 0x0216(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	ETimelineDirection                            K2Node_CustomEvent_TimelineDirection;              // 0x0217(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_SwitchEnum3_CmpSuccess;                     // 0x0218(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                          CallFunc_HasMatchingGameplayTag_ReturnValue;       // 0x0231(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(sizeof(GC_Husk_Slow_C_ExecuteUbergraph_GC_Husk_Slow) == 0x000238, "Wrong size on GC_Husk_Slow_C_ExecuteUbergraph_GC_Husk_Slow");
...
static_assert(offsetof(GC_Husk_Slow_C_ExecuteUbergraph_GC_Husk_Slow, Temp_bool_Variable) == 0x000211, "Member 'GC_Husk_Slow_C_ExecuteUbergraph_GC_Husk_Slow::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(GC_Husk_Slow_C_ExecuteUbergraph_GC_Husk_Slow, K2Node_SwitchEnum1_CmpSuccess) == 0x000212, "Member 'GC_Husk_Slow_C_ExecuteUbergraph_GC_Husk_Slow::K2Node_SwitchEnum1_CmpSuccess' has a wrong offset!");
static_assert(offsetof(GC_Husk_Slow_C_ExecuteUbergraph_GC_Husk_Slow, CallFunc_K2_AttachToComponent_ReturnValue) == 0x000213, "Member 'GC_Husk_Slow_C_ExecuteUbergraph_GC_Husk_Slow::CallFunc_K2_AttachToComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(GC_Husk_Slow_C_ExecuteUbergraph_GC_Husk_Slow, CallFunc_K2_AttachToComponent_ReturnValue1) == 0x000214, "Member 'GC_Husk_Slow_C_ExecuteUbergraph_GC_Husk_Slow::CallFunc_K2_AttachToComponent_ReturnValue1' has a wrong offset!");
static_assert(offsetof(GC_Husk_Slow_C_ExecuteUbergraph_GC_Husk_Slow, CallFunc_IsValid_ReturnValue3) == 0x000215, "Member 'GC_Husk_Slow_C_ExecuteUbergraph_GC_Husk_Slow::CallFunc_IsValid_ReturnValue3' has a wrong offset!");
static_assert(offsetof(GC_Husk_Slow_C_ExecuteUbergraph_GC_Husk_Slow, K2Node_SwitchEnum2_CmpSuccess) == 0x000216, "Member 'GC_Husk_Slow_C_ExecuteUbergraph_GC_Husk_Slow::K2Node_SwitchEnum2_CmpSuccess' has a wrong offset!");
static_assert(offsetof(GC_Husk_Slow_C_ExecuteUbergraph_GC_Husk_Slow, K2Node_CustomEvent_TimelineDirection) == 0x000217, "Member 'GC_Husk_Slow_C_ExecuteUbergraph_GC_Husk_Slow::K2Node_CustomEvent_TimelineDirection' has a wrong offset!");
static_assert(offsetof(GC_Husk_Slow_C_ExecuteUbergraph_GC_Husk_Slow, K2Node_SwitchEnum3_CmpSuccess) == 0x000218, "Member 'GC_Husk_Slow_C_ExecuteUbergraph_GC_Husk_Slow::K2Node_SwitchEnum3_CmpSuccess' has a wrong offset!");
static_assert(offsetof(GC_Husk_Slow_C_ExecuteUbergraph_GC_Husk_Slow, K2Node_DynamicCast_AsGameplay_Tag_Asset_Interface) == 0x000220, "Member 'GC_Husk_Slow_C_ExecuteUbergraph_GC_Husk_Slow::K2Node_DynamicCast_AsGameplay_Tag_Asset_Interface' has a wrong offset!");
static_assert(offsetof(GC_Husk_Slow_C_ExecuteUbergraph_GC_Husk_Slow, K2Node_DynamicCast_bSuccess3) == 0x000230, "Member 'GC_Husk_Slow_C_ExecuteUbergraph_GC_Husk_Slow::K2Node_DynamicCast_bSuccess3' has a wrong offset!");
static_assert(offsetof(GC_Husk_Slow_C_ExecuteUbergraph_GC_Husk_Slow, CallFunc_HasMatchingGameplayTag_ReturnValue) == 0x000231, "Member 'GC_Husk_Slow_C_ExecuteUbergraph_GC_Husk_Slow::CallFunc_HasMatchingGameplayTag_ReturnValue' has a wrong offset!");
