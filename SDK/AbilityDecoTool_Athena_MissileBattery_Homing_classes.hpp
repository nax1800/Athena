...
static_assert(alignof(AAbilityDecoTool_Athena_MissileBattery_Homing_C) == 0x000008, "Wrong alignment on AAbilityDecoTool_Athena_MissileBattery_Homing_C");
static_assert(sizeof(AAbilityDecoTool_Athena_MissileBattery_Homing_C) == 0x000BF0, "Wrong size on AAbilityDecoTool_Athena_MissileBattery_Homing_C");
static_assert(offsetof(AAbilityDecoTool_Athena_MissileBattery_Homing_C, UberGraphFrame) == 0x000BB0, "Member 'AAbilityDecoTool_Athena_MissileBattery_Homing_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AAbilityDecoTool_Athena_MissileBattery_Homing_C, NewVar_0) == 0x000BB8, "Member 'AAbilityDecoTool_Athena_MissileBattery_Homing_C::NewVar_0' has a wrong offset!");
static_assert(offsetof(AAbilityDecoTool_Athena_MissileBattery_Homing_C, Helper) == 0x000BC0, "Member 'AAbilityDecoTool_Athena_MissileBattery_Homing_C::Helper' has a wrong offset!");
static_assert(offsetof(AAbilityDecoTool_Athena_MissileBattery_Homing_C, HideTimerHandle) == 0x000BC8, "Member 'AAbilityDecoTool_Athena_MissileBattery_Homing_C::HideTimerHandle' has a wrong offset!");
static_assert(offsetof(AAbilityDecoTool_Athena_MissileBattery_Homing_C, FortPawn) == 0x000BD0, "Member 'AAbilityDecoTool_Athena_MissileBattery_Homing_C::FortPawn' has a wrong offset!");
static_assert(offsetof(AAbilityDecoTool_Athena_MissileBattery_Homing_C, PPMissileBatteryHoming) == 0x000BD8, "Member 'AAbilityDecoTool_Athena_MissileBattery_Homing_C::PPMissileBatteryHoming' has a wrong offset!");
static_assert(offsetof(AAbilityDecoTool_Athena_MissileBattery_Homing_C, AimLocation) == 0x000BE0, "Member 'AAbilityDecoTool_Athena_MissileBattery_Homing_C::AimLocation' has a wrong offset!");
