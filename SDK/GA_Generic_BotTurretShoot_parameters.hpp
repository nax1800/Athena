...
static_assert(offsetof(GA_Generic_BotTurretShoot_C_ExecuteUbergraph_GA_Generic_BotTurretShoot, CallFunc_GetRangeTag_TargetTag) == 0x000008, "Member 'GA_Generic_BotTurretShoot_C_ExecuteUbergraph_GA_Generic_BotTurretShoot::CallFunc_GetRangeTag_TargetTag' has a wrong offset!");
