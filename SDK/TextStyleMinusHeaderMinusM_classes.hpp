...
static_assert(alignof(UTextStyleMinusHeaderMinusM_C) == 0x000010, "Wrong alignment on UTextStyleMinusHeaderMinusM_C");
static_assert(sizeof(UTextStyleMinusHeaderMinusM_C) == 0x0001A0, "Wrong size on UTextStyleMinusHeaderMinusM_C");
