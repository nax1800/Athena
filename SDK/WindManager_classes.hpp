...
static_assert(offsetof(AWindManager_C, Max_level_bounds_Minus_used_to_isolate_the_level_from_the_vista) == 0x000678, "Member 'AWindManager_C::Max_level_bounds_Minus_used_to_isolate_the_level_from_the_vista' has a wrong offset!");
