...
static_assert(sizeof(UAthenaTeamCountSlot_C) == 0x000220, "Wrong size on UAthenaTeamCountSlot_C");
static_assert(offsetof(UAthenaTeamCountSlot_C, TeamCount) == 0x000210, "Member 'UAthenaTeamCountSlot_C::TeamCount' has a wrong offset!");
static_assert(offsetof(UAthenaTeamCountSlot_C, TeamName) == 0x000218, "Member 'UAthenaTeamCountSlot_C::TeamName' has a wrong offset!");
