...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// EFortItemCardSize                       NewParam                                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UAthenaCustomizationSlotButton_C::SetCardSize(EFortItemCardSize NewParam)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("AthenaCustomizationSlotButton_C", "SetCardSize");

	Params::AthenaCustomizationSlotButton_C_SetCardSize Parms{};
