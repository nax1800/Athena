...
void ABP_Hex_PARENT_C::HandleTeamMemberPromoted()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_Hex_PARENT_C", "HandleTeamMemberPromoted");
...
void ABP_Hex_PARENT_C::HandlePartyChanged()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_Hex_PARENT_C", "HandlePartyChanged");
...
void ABP_Hex_PARENT_C::HandleTeamMemberRemoved(int32 PlayerIndex)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_Hex_PARENT_C", "HandleTeamMemberRemoved");

	Params::BP_Hex_PARENT_C_HandleTeamMemberRemoved Parms{};
...
void ABP_Hex_PARENT_C::HandleTeamMemberAdded(const struct FFortTeamMemberInfo& NewTeamMemberInfo)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_Hex_PARENT_C", "HandleTeamMemberAdded");

	Params::BP_Hex_PARENT_C_HandleTeamMemberAdded Parms{};
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// EPartyType                              PartyType                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void ABP_Hex_PARENT_C::HandlePartyTypeChanged(EPartyType PartyType)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_Hex_PARENT_C", "HandlePartyTypeChanged");

	Params::BP_Hex_PARENT_C_HandlePartyTypeChanged Parms{};
