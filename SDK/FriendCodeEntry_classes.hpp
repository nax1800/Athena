...
static_assert(sizeof(UFriendCodeEntry_C) == 0x000C00, "Wrong size on UFriendCodeEntry_C");
static_assert(offsetof(UFriendCodeEntry_C, UberGraphFrame) == 0x000BC8, "Member 'UFriendCodeEntry_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UFriendCodeEntry_C, Border_0) == 0x000BD0, "Member 'UFriendCodeEntry_C::Border_0' has a wrong offset!");
static_assert(offsetof(UFriendCodeEntry_C, Border_1) == 0x000BD8, "Member 'UFriendCodeEntry_C::Border_1' has a wrong offset!");
static_assert(offsetof(UFriendCodeEntry_C, Border_2) == 0x000BE0, "Member 'UFriendCodeEntry_C::Border_2' has a wrong offset!");
static_assert(offsetof(UFriendCodeEntry_C, Border_Fill) == 0x000BE8, "Member 'UFriendCodeEntry_C::Border_Fill' has a wrong offset!");
static_assert(offsetof(UFriendCodeEntry_C, WidgetSwitcher_0) == 0x000BF0, "Member 'UFriendCodeEntry_C::WidgetSwitcher_0' has a wrong offset!");
static_assert(offsetof(UFriendCodeEntry_C, MID_FillBorder) == 0x000BF8, "Member 'UFriendCodeEntry_C::MID_FillBorder' has a wrong offset!");
