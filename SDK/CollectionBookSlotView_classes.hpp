...
static_assert(sizeof(UCollectionBookSlotView_C) == 0x0002E0, "Wrong size on UCollectionBookSlotView_C");
static_assert(offsetof(UCollectionBookSlotView_C, UberGraphFrame) == 0x0002D8, "Member 'UCollectionBookSlotView_C::UberGraphFrame' has a wrong offset!");
