...
static_assert(offsetof(Trap_Wall_Electric_Athena_C_ExecuteUbergraph_Trap_Wall_Electric_Athena, CallFunc_Multiply_VectorVector_ReturnValue2) == 0x0000D4, "Member 'Trap_Wall_Electric_Athena_C_ExecuteUbergraph_Trap_Wall_Electric_Athena::CallFunc_Multiply_VectorVector_ReturnValue2' has a wrong offset!");
...
static_assert(offsetof(Trap_Wall_Electric_Athena_C_ExecuteUbergraph_Trap_Wall_Electric_Athena, K2Node_MakeStruct_ParticleSysParam2) == 0x000160, "Member 'Trap_Wall_Electric_Athena_C_ExecuteUbergraph_Trap_Wall_Electric_Athena::K2Node_MakeStruct_ParticleSysParam2' has a wrong offset!");
static_assert(offsetof(Trap_Wall_Electric_Athena_C_ExecuteUbergraph_Trap_Wall_Electric_Athena, K2Node_MakeStruct_ParticleSysParam3) == 0x0001E0, "Member 'Trap_Wall_Electric_Athena_C_ExecuteUbergraph_Trap_Wall_Electric_Athena::K2Node_MakeStruct_ParticleSysParam3' has a wrong offset!");
static_assert(offsetof(Trap_Wall_Electric_Athena_C_ExecuteUbergraph_Trap_Wall_Electric_Athena, CallFunc_Multiply_VectorVector_ReturnValue3) == 0x000260, "Member 'Trap_Wall_Electric_Athena_C_ExecuteUbergraph_Trap_Wall_Electric_Athena::CallFunc_Multiply_VectorVector_ReturnValue3' has a wrong offset!");
static_assert(offsetof(Trap_Wall_Electric_Athena_C_ExecuteUbergraph_Trap_Wall_Electric_Athena, K2Node_MakeStruct_ParticleSysParam4) == 0x000270, "Member 'Trap_Wall_Electric_Athena_C_ExecuteUbergraph_Trap_Wall_Electric_Athena::K2Node_MakeStruct_ParticleSysParam4' has a wrong offset!");
static_assert(offsetof(Trap_Wall_Electric_Athena_C_ExecuteUbergraph_Trap_Wall_Electric_Athena, K2Node_MakeStruct_ParticleSysParam5) == 0x0002F0, "Member 'Trap_Wall_Electric_Athena_C_ExecuteUbergraph_Trap_Wall_Electric_Athena::K2Node_MakeStruct_ParticleSysParam5' has a wrong offset!");
...
static_assert(offsetof(Trap_Wall_Electric_Athena_C_ExecuteUbergraph_Trap_Wall_Electric_Athena, K2Node_MakeStruct_ParticleSysParam6) == 0x000390, "Member 'Trap_Wall_Electric_Athena_C_ExecuteUbergraph_Trap_Wall_Electric_Athena::K2Node_MakeStruct_ParticleSysParam6' has a wrong offset!");
...
static_assert(offsetof(Trap_Wall_Electric_Athena_C_ExecuteUbergraph_Trap_Wall_Electric_Athena, CallFunc_K2_GetActorLocation_ReturnValue2) == 0x000448, "Member 'Trap_Wall_Electric_Athena_C_ExecuteUbergraph_Trap_Wall_Electric_Athena::CallFunc_K2_GetActorLocation_ReturnValue2' has a wrong offset!");
...
static_assert(offsetof(Trap_Wall_Electric_Athena_C_ExecuteUbergraph_Trap_Wall_Electric_Athena, CallFunc_IsValid_ReturnValue2) == 0x000551, "Member 'Trap_Wall_Electric_Athena_C_ExecuteUbergraph_Trap_Wall_Electric_Athena::CallFunc_IsValid_ReturnValue2' has a wrong offset!");
...
static_assert(offsetof(Trap_Wall_Electric_Athena_C_ExecuteUbergraph_Trap_Wall_Electric_Athena, CallFunc_IsValid_ReturnValue3) == 0x000620, "Member 'Trap_Wall_Electric_Athena_C_ExecuteUbergraph_Trap_Wall_Electric_Athena::CallFunc_IsValid_ReturnValue3' has a wrong offset!");
static_assert(offsetof(Trap_Wall_Electric_Athena_C_ExecuteUbergraph_Trap_Wall_Electric_Athena, CallFunc_K2_GetComponentLocation_ReturnValue2) == 0x000624, "Member 'Trap_Wall_Electric_Athena_C_ExecuteUbergraph_Trap_Wall_Electric_Athena::CallFunc_K2_GetComponentLocation_ReturnValue2' has a wrong offset!");
