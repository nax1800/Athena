...
static_assert(sizeof(UMaterialExpressionMaterialXTextureSampleParameterBlur) == 0x000228, "Wrong size on UMaterialExpressionMaterialXTextureSampleParameterBlur");
