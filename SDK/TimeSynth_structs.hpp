...
public:
	...
	struct FVector2D                              DistanceRange;                                     // 0x000C(0x0008)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct alignas(0x08) FTimeSynthClipHandle final
{
public:
...
static_assert(alignof(FTimeSynthClipHandle) == 0x000008, "Wrong alignment on FTimeSynthClipHandle");
static_assert(sizeof(FTimeSynthClipHandle) == 0x000010, "Wrong size on FTimeSynthClipHandle");
