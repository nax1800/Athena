...
static_assert(sizeof(UJournalQuestProgressBar_C) == 0x000318, "Wrong size on UJournalQuestProgressBar_C");
static_assert(offsetof(UJournalQuestProgressBar_C, UberGraphFrame) == 0x000240, "Member 'UJournalQuestProgressBar_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UJournalQuestProgressBar_C, Image_61) == 0x000248, "Member 'UJournalQuestProgressBar_C::Image_61' has a wrong offset!");
static_assert(offsetof(UJournalQuestProgressBar_C, ObjectiveText) == 0x000250, "Member 'UJournalQuestProgressBar_C::ObjectiveText' has a wrong offset!");
static_assert(offsetof(UJournalQuestProgressBar_C, ParentBorder) == 0x000258, "Member 'UJournalQuestProgressBar_C::ParentBorder' has a wrong offset!");
static_assert(offsetof(UJournalQuestProgressBar_C, ProgressBar_0) == 0x000260, "Member 'UJournalQuestProgressBar_C::ProgressBar_0' has a wrong offset!");
static_assert(offsetof(UJournalQuestProgressBar_C, ProgressBorder) == 0x000268, "Member 'UJournalQuestProgressBar_C::ProgressBorder' has a wrong offset!");
static_assert(offsetof(UJournalQuestProgressBar_C, ProgressIndicator) == 0x000270, "Member 'UJournalQuestProgressBar_C::ProgressIndicator' has a wrong offset!");
static_assert(offsetof(UJournalQuestProgressBar_C, TaskProgressText) == 0x000278, "Member 'UJournalQuestProgressBar_C::TaskProgressText' has a wrong offset!");
static_assert(offsetof(UJournalQuestProgressBar_C, FutureObjectiveTextSyle) == 0x000280, "Member 'UJournalQuestProgressBar_C::FutureObjectiveTextSyle' has a wrong offset!");
static_assert(offsetof(UJournalQuestProgressBar_C, FutureObjectiveTaskProgressTextStyle) == 0x000288, "Member 'UJournalQuestProgressBar_C::FutureObjectiveTaskProgressTextStyle' has a wrong offset!");
static_assert(offsetof(UJournalQuestProgressBar_C, FutureObjectProgressBarBrush) == 0x000290, "Member 'UJournalQuestProgressBar_C::FutureObjectProgressBarBrush' has a wrong offset!");
