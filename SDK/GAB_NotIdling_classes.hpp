...
static_assert(sizeof(UGAB_NotIdling_C) == 0x000900, "Wrong size on UGAB_NotIdling_C");
static_assert(offsetof(UGAB_NotIdling_C, UberGraphFrame) == 0x0008F8, "Member 'UGAB_NotIdling_C::UberGraphFrame' has a wrong offset!");
