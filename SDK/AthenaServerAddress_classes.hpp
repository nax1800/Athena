...
static_assert(sizeof(UAthenaServerAddress_C) == 0x000248, "Wrong size on UAthenaServerAddress_C");
static_assert(offsetof(UAthenaServerAddress_C, UberGraphFrame) == 0x000238, "Member 'UAthenaServerAddress_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UAthenaServerAddress_C, Text) == 0x000240, "Member 'UAthenaServerAddress_C::Text' has a wrong offset!");
