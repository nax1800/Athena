...
static_assert(sizeof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack) == 0x0002F0, "Wrong size on GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack");
...
static_assert(sizeof(GA_BoostJumpPack_C_OnPawnLanded) == 0x0000F0, "Wrong size on GA_BoostJumpPack_C_OnPawnLanded");
