...
static_assert(sizeof(UInviteRequest_C) == 0x000260, "Wrong size on UInviteRequest_C");
static_assert(offsetof(UInviteRequest_C, Border_Invite) == 0x000250, "Member 'UInviteRequest_C::Border_Invite' has a wrong offset!");
static_assert(offsetof(UInviteRequest_C, InviteEventTitle) == 0x000258, "Member 'UInviteRequest_C::InviteEventTitle' has a wrong offset!");
