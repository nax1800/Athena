...
public:
	...
	class UCommonTextBlock*                       BubbleText;                                        // 0x0230(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(USpeechBubbleWidget_C) == 0x000238, "Wrong size on USpeechBubbleWidget_C");
static_assert(offsetof(USpeechBubbleWidget_C, UberGraphFrame) == 0x000228, "Member 'USpeechBubbleWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(USpeechBubbleWidget_C, BubbleText) == 0x000230, "Member 'USpeechBubbleWidget_C::BubbleText' has a wrong offset!");
