...
static_assert(sizeof(UActivatableMovieWidget_C) == 0x000370, "Wrong size on UActivatableMovieWidget_C");
static_assert(offsetof(UActivatableMovieWidget_C, UberGraphFrame) == 0x000368, "Member 'UActivatableMovieWidget_C::UberGraphFrame' has a wrong offset!");
