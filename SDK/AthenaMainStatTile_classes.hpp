...
{
public:
	class UImage*                                 Glow;                                              // 0x0308(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UAthenaMainStatTile_C) == 0x000310, "Wrong size on UAthenaMainStatTile_C");
