...
static_assert(offsetof(UAthenaMainStatTile_C, UberGraphFrame) == 0x000230, "Member 'UAthenaMainStatTile_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UAthenaMainStatTile_C, Glow) == 0x000238, "Member 'UAthenaMainStatTile_C::Glow' has a wrong offset!");
