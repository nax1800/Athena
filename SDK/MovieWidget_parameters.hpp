...
static_assert(sizeof(MovieWidget_C_Init) == 0x000068, "Wrong size on MovieWidget_C_Init");
...
static_assert(offsetof(MovieWidget_C_Init, K2Node_MakeStruct_MediaPlayerOptions) == 0x000034, "Member 'MovieWidget_C_Init::K2Node_MakeStruct_MediaPlayerOptions' has a wrong offset!");
static_assert(offsetof(MovieWidget_C_Init, K2Node_CreateDelegate_OutputDelegate) == 0x000050, "Member 'MovieWidget_C_Init::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(MovieWidget_C_Init, CallFunc_SetMediaSource_ReturnValue) == 0x000060, "Member 'MovieWidget_C_Init::CallFunc_SetMediaSource_ReturnValue' has a wrong offset!");
static_assert(offsetof(MovieWidget_C_Init, CallFunc_SetMediaSource_ReturnValue1) == 0x000061, "Member 'MovieWidget_C_Init::CallFunc_SetMediaSource_ReturnValue1' has a wrong offset!");
