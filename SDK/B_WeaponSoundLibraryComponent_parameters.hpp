...
static_assert(sizeof(B_WeaponSoundLibraryComponent_C_ExecuteUbergraph_B_WeaponSoundLibraryComponent) == 0x000068, "Wrong size on B_WeaponSoundLibraryComponent_C_ExecuteUbergraph_B_WeaponSoundLibraryComponent");
...
static_assert(alignof(B_WeaponSoundLibraryComponent_C_StopFireEventsOnDeath) == 0x000008, "Wrong alignment on B_WeaponSoundLibraryComponent_C_StopFireEventsOnDeath");
static_assert(sizeof(B_WeaponSoundLibraryComponent_C_StopFireEventsOnDeath) == 0x000040, "Wrong size on B_WeaponSoundLibraryComponent_C_StopFireEventsOnDeath");
...
static_assert(alignof(B_WeaponSoundLibraryComponent_C_StopFireEventsOnUnequip) == 0x000001, "Wrong alignment on B_WeaponSoundLibraryComponent_C_StopFireEventsOnUnequip");
static_assert(sizeof(B_WeaponSoundLibraryComponent_C_StopFireEventsOnUnequip) == 0x000002, "Wrong size on B_WeaponSoundLibraryComponent_C_StopFireEventsOnUnequip");
