...
static_assert(offsetof(CheckForMessageItems_C_ShowMessage, K2Node_CreateDelegate_OutputDelegate) == 0x000030, "Member 'CheckForMessageItems_C_ShowMessage::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
...
static_assert(offsetof(CheckForMessageItems_C_ShowMessage, CallFunc_IsInViewport_ReturnValue) == 0x000078, "Member 'CheckForMessageItems_C_ShowMessage::CallFunc_IsInViewport_ReturnValue' has a wrong offset!");
static_assert(offsetof(CheckForMessageItems_C_ShowMessage, CallFunc_BooleanOR_ReturnValue) == 0x000079, "Member 'CheckForMessageItems_C_ShowMessage::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
static_assert(offsetof(CheckForMessageItems_C_ShowMessage, CallFunc_IsValid_ReturnValue) == 0x00007A, "Member 'CheckForMessageItems_C_ShowMessage::CallFunc_IsValid_ReturnValue' has a wrong offset!");
