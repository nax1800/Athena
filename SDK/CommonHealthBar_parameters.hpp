...
static_assert(alignof(CommonHealthBar_C_InitializeBar) == 0x000008, "Wrong alignment on CommonHealthBar_C_InitializeBar");
static_assert(sizeof(CommonHealthBar_C_InitializeBar) == 0x000010, "Wrong size on CommonHealthBar_C_InitializeBar");
static_assert(offsetof(CommonHealthBar_C_InitializeBar, CallFunc_GetDynamicMaterial_ReturnValue) == 0x000000, "Member 'CommonHealthBar_C_InitializeBar::CallFunc_GetDynamicMaterial_ReturnValue' has a wrong offset!");
static_assert(offsetof(CommonHealthBar_C_InitializeBar, CallFunc_GetDynamicMaterial_ReturnValue1) == 0x000008, "Member 'CommonHealthBar_C_InitializeBar::CallFunc_GetDynamicMaterial_ReturnValue1' has a wrong offset!");
...
static_assert(sizeof(CommonHealthBar_C_Update_Current_HP_Value) == 0x000028, "Wrong size on CommonHealthBar_C_Update_Current_HP_Value");
...
static_assert(offsetof(CommonHealthBar_C_Update_Current_HP_Value, CallFunc_Conv_IntToText_ReturnValue) == 0x000008, "Member 'CommonHealthBar_C_Update_Current_HP_Value::CallFunc_Conv_IntToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(CommonHealthBar_C_Update_Current_HP_Value, CallFunc_EqualEqual_FloatFloat_ReturnValue) == 0x000020, "Member 'CommonHealthBar_C_Update_Current_HP_Value::CallFunc_EqualEqual_FloatFloat_ReturnValue' has a wrong offset!");
...
static_assert(alignof(CommonHealthBar_C_Update_HP_Fill_Bar) == 0x000008, "Wrong alignment on CommonHealthBar_C_Update_HP_Fill_Bar");
static_assert(sizeof(CommonHealthBar_C_Update_HP_Fill_Bar) == 0x000050, "Wrong size on CommonHealthBar_C_Update_HP_Fill_Bar");
static_assert(offsetof(CommonHealthBar_C_Update_HP_Fill_Bar, CallFunc_Conv_IntToFloat_ReturnValue) == 0x000000, "Member 'CommonHealthBar_C_Update_HP_Fill_Bar::CallFunc_Conv_IntToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(CommonHealthBar_C_Update_HP_Fill_Bar, Temp_float_Variable) == 0x000004, "Member 'CommonHealthBar_C_Update_HP_Fill_Bar::Temp_float_Variable' has a wrong offset!");
static_assert(offsetof(CommonHealthBar_C_Update_HP_Fill_Bar, K2Node_DynamicCast_AsSize_Box_Slot) == 0x000008, "Member 'CommonHealthBar_C_Update_HP_Fill_Bar::K2Node_DynamicCast_AsSize_Box_Slot' has a wrong offset!");
static_assert(offsetof(CommonHealthBar_C_Update_HP_Fill_Bar, K2Node_DynamicCast_bSuccess) == 0x000010, "Member 'CommonHealthBar_C_Update_HP_Fill_Bar::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(CommonHealthBar_C_Update_HP_Fill_Bar, CallFunc_BreakVector2D_X) == 0x000014, "Member 'CommonHealthBar_C_Update_HP_Fill_Bar::CallFunc_BreakVector2D_X' has a wrong offset!");
static_assert(offsetof(CommonHealthBar_C_Update_HP_Fill_Bar, CallFunc_BreakVector2D_Y) == 0x000018, "Member 'CommonHealthBar_C_Update_HP_Fill_Bar::CallFunc_BreakVector2D_Y' has a wrong offset!");
static_assert(offsetof(CommonHealthBar_C_Update_HP_Fill_Bar, CallFunc_Multiply_FloatFloat_ReturnValue) == 0x00001C, "Member 'CommonHealthBar_C_Update_HP_Fill_Bar::CallFunc_Multiply_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(CommonHealthBar_C_Update_HP_Fill_Bar, Temp_bool_Variable) == 0x000020, "Member 'CommonHealthBar_C_Update_HP_Fill_Bar::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(CommonHealthBar_C_Update_HP_Fill_Bar, CallFunc_Greater_FloatFloat_ReturnValue) == 0x000021, "Member 'CommonHealthBar_C_Update_HP_Fill_Bar::CallFunc_Greater_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(CommonHealthBar_C_Update_HP_Fill_Bar, CallFunc_Divide_FloatFloat_ReturnValue) == 0x000024, "Member 'CommonHealthBar_C_Update_HP_Fill_Bar::CallFunc_Divide_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(CommonHealthBar_C_Update_HP_Fill_Bar, CallFunc_Multiply_FloatFloat_ReturnValue1) == 0x000028, "Member 'CommonHealthBar_C_Update_HP_Fill_Bar::CallFunc_Multiply_FloatFloat_ReturnValue1' has a wrong offset!");
static_assert(offsetof(CommonHealthBar_C_Update_HP_Fill_Bar, CallFunc_Add_FloatFloat_ReturnValue) == 0x00002C, "Member 'CommonHealthBar_C_Update_HP_Fill_Bar::CallFunc_Add_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(CommonHealthBar_C_Update_HP_Fill_Bar, CallFunc_Divide_FloatFloat_ReturnValue1) == 0x000030, "Member 'CommonHealthBar_C_Update_HP_Fill_Bar::CallFunc_Divide_FloatFloat_ReturnValue1' has a wrong offset!");
static_assert(offsetof(CommonHealthBar_C_Update_HP_Fill_Bar, CallFunc_LessEqual_FloatFloat_ReturnValue) == 0x000034, "Member 'CommonHealthBar_C_Update_HP_Fill_Bar::CallFunc_LessEqual_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(CommonHealthBar_C_Update_HP_Fill_Bar, K2Node_Select_Default) == 0x000038, "Member 'CommonHealthBar_C_Update_HP_Fill_Bar::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(CommonHealthBar_C_Update_HP_Fill_Bar, K2Node_MakeStruct_LinearColor) == 0x00003C, "Member 'CommonHealthBar_C_Update_HP_Fill_Bar::K2Node_MakeStruct_LinearColor' has a wrong offset!");
...
static_assert(sizeof(CommonHealthBar_C_Set_Timer) == 0x000028, "Wrong size on CommonHealthBar_C_Set_Timer");
...
static_assert(offsetof(CommonHealthBar_C_Set_Timer, K2Node_CreateDelegate_OutputDelegate) == 0x000008, "Member 'CommonHealthBar_C_Set_Timer::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(CommonHealthBar_C_Set_Timer, CallFunc_K2_IsValidTimerHandle_ReturnValue) == 0x000018, "Member 'CommonHealthBar_C_Set_Timer::CallFunc_K2_IsValidTimerHandle_ReturnValue' has a wrong offset!");
static_assert(offsetof(CommonHealthBar_C_Set_Timer, CallFunc_K2_SetTimerDelegate_ReturnValue) == 0x000020, "Member 'CommonHealthBar_C_Set_Timer::CallFunc_K2_SetTimerDelegate_ReturnValue' has a wrong offset!");
...
static_assert(alignof(CommonHealthBar_C_SetColors) == 0x000008, "Wrong alignment on CommonHealthBar_C_SetColors");
static_assert(sizeof(CommonHealthBar_C_SetColors) == 0x000048, "Wrong size on CommonHealthBar_C_SetColors");
static_assert(offsetof(CommonHealthBar_C_SetColors, ColorA) == 0x000000, "Member 'CommonHealthBar_C_SetColors::ColorA' has a wrong offset!");
static_assert(offsetof(CommonHealthBar_C_SetColors, ColorB) == 0x000010, "Member 'CommonHealthBar_C_SetColors::ColorB' has a wrong offset!");
static_assert(offsetof(CommonHealthBar_C_SetColors, BevelColor) == 0x000020, "Member 'CommonHealthBar_C_SetColors::BevelColor' has a wrong offset!");
static_assert(offsetof(CommonHealthBar_C_SetColors, BaseplateColor) == 0x000030, "Member 'CommonHealthBar_C_SetColors::BaseplateColor' has a wrong offset!");
static_assert(offsetof(CommonHealthBar_C_SetColors, CallFunc_GetDynamicMaterial_ReturnValue) == 0x000040, "Member 'CommonHealthBar_C_SetColors::CallFunc_GetDynamicMaterial_ReturnValue' has a wrong offset!");
