...
static_assert(sizeof(UFortConversationParticipantComponent) == 0x000190, "Wrong size on UFortConversationParticipantComponent");
...
static_assert(sizeof(UFortPlayerConversationComponent) == 0x0003D8, "Wrong size on UFortPlayerConversationComponent");
