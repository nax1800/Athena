...
class UGC_Tomato_Hit_Splat_C final : public UFortGameplayCueNotify_Burst
{
public:
...
static_assert(sizeof(UGC_Tomato_Hit_Splat_C) == 0x0001A8, "Wrong size on UGC_Tomato_Hit_Splat_C");
