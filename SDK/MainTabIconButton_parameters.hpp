...
static_assert(offsetof(MainTabIconButton_C_ExecuteUbergraph_MainTabIconButton, K2Node_CreateDelegate_OutputDelegate2) == 0x000028, "Member 'MainTabIconButton_C_ExecuteUbergraph_MainTabIconButton::K2Node_CreateDelegate_OutputDelegate2' has a wrong offset!");
...
struct alignas(0x08) MainTabIconButton_C_SetWrapperNameIDs final
{
public:
...
static_assert(alignof(MainTabIconButton_C_SetWrapperNameIDs) == 0x000008, "Wrong alignment on MainTabIconButton_C_SetWrapperNameIDs");
...
static_assert(offsetof(MainTabIconButton_C_TabAnimateInFinished, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000000, "Member 'MainTabIconButton_C_TabAnimateInFinished::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(MainTabIconButton_C_TabAdded, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000000, "Member 'MainTabIconButton_C_TabAdded::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
