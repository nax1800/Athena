...
static_assert(sizeof(UGA_TrapBuildGeneric_C) == 0x000900, "Wrong size on UGA_TrapBuildGeneric_C");
static_assert(offsetof(UGA_TrapBuildGeneric_C, UberGraphFrame) == 0x0008F8, "Member 'UGA_TrapBuildGeneric_C::UberGraphFrame' has a wrong offset!");
