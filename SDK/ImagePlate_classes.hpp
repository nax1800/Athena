...
static_assert(sizeof(AImagePlate) == 0x000330, "Wrong size on AImagePlate");
static_assert(offsetof(AImagePlate, ImagePlate) == 0x000328, "Member 'AImagePlate::ImagePlate' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_598[0x98];                                     // 0x0598(0x0098)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UImagePlateComponent) == 0x000630, "Wrong size on UImagePlateComponent");
static_assert(offsetof(UImagePlateComponent, Plate) == 0x000560, "Member 'UImagePlateComponent::Plate' has a wrong offset!");
...
static_assert(sizeof(UImagePlateFrustumComponent) == 0x000560, "Wrong size on UImagePlateFrustumComponent");
