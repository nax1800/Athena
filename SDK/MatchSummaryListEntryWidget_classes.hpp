...
static_assert(sizeof(UMatchSummaryListEntryWidget_C) == 0x000B78, "Wrong size on UMatchSummaryListEntryWidget_C");
static_assert(offsetof(UMatchSummaryListEntryWidget_C, UberGraphFrame) == 0x000B38, "Member 'UMatchSummaryListEntryWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UMatchSummaryListEntryWidget_C, OnestPlace1) == 0x000B40, "Member 'UMatchSummaryListEntryWidget_C::OnestPlace1' has a wrong offset!");
static_assert(offsetof(UMatchSummaryListEntryWidget_C, BlueGradBaseFill) == 0x000B48, "Member 'UMatchSummaryListEntryWidget_C::BlueGradBaseFill' has a wrong offset!");
static_assert(offsetof(UMatchSummaryListEntryWidget_C, ElimsText) == 0x000B50, "Member 'UMatchSummaryListEntryWidget_C::ElimsText' has a wrong offset!");
static_assert(offsetof(UMatchSummaryListEntryWidget_C, MatchEntryNumber) == 0x000B58, "Member 'UMatchSummaryListEntryWidget_C::MatchEntryNumber' has a wrong offset!");
static_assert(offsetof(UMatchSummaryListEntryWidget_C, MatchTime) == 0x000B60, "Member 'UMatchSummaryListEntryWidget_C::MatchTime' has a wrong offset!");
static_assert(offsetof(UMatchSummaryListEntryWidget_C, PlacementText) == 0x000B68, "Member 'UMatchSummaryListEntryWidget_C::PlacementText' has a wrong offset!");
static_assert(offsetof(UMatchSummaryListEntryWidget_C, ScoreText) == 0x000B70, "Member 'UMatchSummaryListEntryWidget_C::ScoreText' has a wrong offset!");
