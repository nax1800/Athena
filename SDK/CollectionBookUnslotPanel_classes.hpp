...
static_assert(sizeof(UCollectionBookUnslotPanel_C) == 0x0002A0, "Wrong size on UCollectionBookUnslotPanel_C");
static_assert(offsetof(UCollectionBookUnslotPanel_C, UberGraphFrame) == 0x000210, "Member 'UCollectionBookUnslotPanel_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UCollectionBookUnslotPanel_C, Cost0) == 0x000218, "Member 'UCollectionBookUnslotPanel_C::Cost0' has a wrong offset!");
static_assert(offsetof(UCollectionBookUnslotPanel_C, Cost1) == 0x000220, "Member 'UCollectionBookUnslotPanel_C::Cost1' has a wrong offset!");
static_assert(offsetof(UCollectionBookUnslotPanel_C, CostListBox) == 0x000228, "Member 'UCollectionBookUnslotPanel_C::CostListBox' has a wrong offset!");
static_assert(offsetof(UCollectionBookUnslotPanel_C, ItemCardWidget) == 0x000230, "Member 'UCollectionBookUnslotPanel_C::ItemCardWidget' has a wrong offset!");
static_assert(offsetof(UCollectionBookUnslotPanel_C, Lightbox) == 0x000238, "Member 'UCollectionBookUnslotPanel_C::Lightbox' has a wrong offset!");
static_assert(offsetof(UCollectionBookUnslotPanel_C, PurchaseButton) == 0x000240, "Member 'UCollectionBookUnslotPanel_C::PurchaseButton' has a wrong offset!");
static_assert(offsetof(UCollectionBookUnslotPanel_C, UnableToPurchaseReasonBox) == 0x000248, "Member 'UCollectionBookUnslotPanel_C::UnableToPurchaseReasonBox' has a wrong offset!");
static_assert(offsetof(UCollectionBookUnslotPanel_C, ItemToUnslot) == 0x000250, "Member 'UCollectionBookUnslotPanel_C::ItemToUnslot' has a wrong offset!");
static_assert(offsetof(UCollectionBookUnslotPanel_C, OwningWidget) == 0x000258, "Member 'UCollectionBookUnslotPanel_C::OwningWidget' has a wrong offset!");
static_assert(offsetof(UCollectionBookUnslotPanel_C, CollectionBookData) == 0x000260, "Member 'UCollectionBookUnslotPanel_C::CollectionBookData' has a wrong offset!");
static_assert(offsetof(UCollectionBookUnslotPanel_C, UnslotCatalysts) == 0x000268, "Member 'UCollectionBookUnslotPanel_C::UnslotCatalysts' has a wrong offset!");
static_assert(offsetof(UCollectionBookUnslotPanel_C, UnslotCosts) == 0x000288, "Member 'UCollectionBookUnslotPanel_C::UnslotCosts' has a wrong offset!");
static_assert(offsetof(UCollectionBookUnslotPanel_C, bHasRequiredCatalysts) == 0x000298, "Member 'UCollectionBookUnslotPanel_C::bHasRequiredCatalysts' has a wrong offset!");
static_assert(offsetof(UCollectionBookUnslotPanel_C, bHasRequiredResources) == 0x000299, "Member 'UCollectionBookUnslotPanel_C::bHasRequiredResources' has a wrong offset!");
