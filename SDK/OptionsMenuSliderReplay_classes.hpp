...
static_assert(sizeof(UOptionsMenuSliderReplay_C) == 0x0002D8, "Wrong size on UOptionsMenuSliderReplay_C");
static_assert(offsetof(UOptionsMenuSliderReplay_C, UberGraphFrame) == 0x000208, "Member 'UOptionsMenuSliderReplay_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UOptionsMenuSliderReplay_C, Button_0) == 0x000210, "Member 'UOptionsMenuSliderReplay_C::Button_0' has a wrong offset!");
static_assert(offsetof(UOptionsMenuSliderReplay_C, MenuSlider) == 0x000218, "Member 'UOptionsMenuSliderReplay_C::MenuSlider' has a wrong offset!");
static_assert(offsetof(UOptionsMenuSliderReplay_C, SliderBackground) == 0x000220, "Member 'UOptionsMenuSliderReplay_C::SliderBackground' has a wrong offset!");
static_assert(offsetof(UOptionsMenuSliderReplay_C, SliderText) == 0x000228, "Member 'UOptionsMenuSliderReplay_C::SliderText' has a wrong offset!");
static_assert(offsetof(UOptionsMenuSliderReplay_C, SliderValue) == 0x000230, "Member 'UOptionsMenuSliderReplay_C::SliderValue' has a wrong offset!");
static_assert(offsetof(UOptionsMenuSliderReplay_C, SliderChanged) == 0x000238, "Member 'UOptionsMenuSliderReplay_C::SliderChanged' has a wrong offset!");
static_assert(offsetof(UOptionsMenuSliderReplay_C, Total_Width) == 0x000248, "Member 'UOptionsMenuSliderReplay_C::Total_Width' has a wrong offset!");
static_assert(offsetof(UOptionsMenuSliderReplay_C, Slider_Texture) == 0x000250, "Member 'UOptionsMenuSliderReplay_C::Slider_Texture' has a wrong offset!");
static_assert(offsetof(UOptionsMenuSliderReplay_C, Tab_Tooltip_Text) == 0x000258, "Member 'UOptionsMenuSliderReplay_C::Tab_Tooltip_Text' has a wrong offset!");
static_assert(offsetof(UOptionsMenuSliderReplay_C, Hover_Text) == 0x000260, "Member 'UOptionsMenuSliderReplay_C::Hover_Text' has a wrong offset!");
static_assert(offsetof(UOptionsMenuSliderReplay_C, MinIntegralDigits) == 0x000278, "Member 'UOptionsMenuSliderReplay_C::MinIntegralDigits' has a wrong offset!");
static_assert(offsetof(UOptionsMenuSliderReplay_C, MaxIntegralDigits) == 0x00027C, "Member 'UOptionsMenuSliderReplay_C::MaxIntegralDigits' has a wrong offset!");
static_assert(offsetof(UOptionsMenuSliderReplay_C, MinFractionalDigits) == 0x000280, "Member 'UOptionsMenuSliderReplay_C::MinFractionalDigits' has a wrong offset!");
static_assert(offsetof(UOptionsMenuSliderReplay_C, MaxFractionalDigits) == 0x000284, "Member 'UOptionsMenuSliderReplay_C::MaxFractionalDigits' has a wrong offset!");
static_assert(offsetof(UOptionsMenuSliderReplay_C, RoundingMode) == 0x000288, "Member 'UOptionsMenuSliderReplay_C::RoundingMode' has a wrong offset!");
static_assert(offsetof(UOptionsMenuSliderReplay_C, ShowLightMaterial) == 0x000289, "Member 'UOptionsMenuSliderReplay_C::ShowLightMaterial' has a wrong offset!");
static_assert(offsetof(UOptionsMenuSliderReplay_C, MinMaxValue) == 0x00028C, "Member 'UOptionsMenuSliderReplay_C::MinMaxValue' has a wrong offset!");
static_assert(offsetof(UOptionsMenuSliderReplay_C, ValuePrefixText) == 0x000298, "Member 'UOptionsMenuSliderReplay_C::ValuePrefixText' has a wrong offset!");
static_assert(offsetof(UOptionsMenuSliderReplay_C, ValueSuffixText) == 0x0002B0, "Member 'UOptionsMenuSliderReplay_C::ValueSuffixText' has a wrong offset!");
static_assert(offsetof(UOptionsMenuSliderReplay_C, MouseDragUpdates) == 0x0002C8, "Member 'UOptionsMenuSliderReplay_C::MouseDragUpdates' has a wrong offset!");
static_assert(offsetof(UOptionsMenuSliderReplay_C, SliderSound) == 0x0002D0, "Member 'UOptionsMenuSliderReplay_C::SliderSound' has a wrong offset!");
