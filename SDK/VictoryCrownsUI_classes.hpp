...
static_assert(sizeof(UVictoryCrownsBearerInfoBase) == 0x000300, "Wrong size on UVictoryCrownsBearerInfoBase");
...
static_assert(sizeof(UVictoryCrownsIndicator) == 0x000400, "Wrong size on UVictoryCrownsIndicator");
...
static_assert(sizeof(UVictoryCrownsPlacementOverlay) == 0x000350, "Wrong size on UVictoryCrownsPlacementOverlay");
...
static_assert(sizeof(UVictoryCrownsPlayerInfoWidget) == 0x000340, "Wrong size on UVictoryCrownsPlayerInfoWidget");
...
static_assert(sizeof(UVictoryCrownsPreGameWidget) == 0x000458, "Wrong size on UVictoryCrownsPreGameWidget");
