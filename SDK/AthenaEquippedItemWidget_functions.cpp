...
void UAthenaEquippedItemWidget_C::SetResourceCount(int32 Count)
{
	static class UFunction* Func = nullptr;
	...
	Params::AthenaEquippedItemWidget_C_SetResourceCount Parms{};
...
void UAthenaEquippedItemWidget_C::GetRemainingCountText(int32 RemainingAmmoCount, bool Always_Sign, bool Use_Grouping, int32 Minimum_Integral_Digits, int32 Maximum_Integral_Digits, class FText* CurrentAmmoText) const
{
	static class UFunction* Func = nullptr;
	...
	Params::AthenaEquippedItemWidget_C_GetRemainingCountText Parms{};
