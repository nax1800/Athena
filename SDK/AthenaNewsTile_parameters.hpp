...
static_assert(alignof(AthenaNewsTile_C_ExecuteUbergraph_AthenaNewsTile) == 0x000004, "Wrong alignment on AthenaNewsTile_C_ExecuteUbergraph_AthenaNewsTile");
static_assert(sizeof(AthenaNewsTile_C_ExecuteUbergraph_AthenaNewsTile) == 0x000008, "Wrong size on AthenaNewsTile_C_ExecuteUbergraph_AthenaNewsTile");
