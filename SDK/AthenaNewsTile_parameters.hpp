...
static_assert(offsetof(AthenaNewsTile_C_ExecuteUbergraph_AthenaNewsTile, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000008, "Member 'AthenaNewsTile_C_ExecuteUbergraph_AthenaNewsTile::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
