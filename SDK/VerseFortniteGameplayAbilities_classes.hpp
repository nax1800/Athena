...
static_assert(sizeof(UFortGameplayAbility_PlayAnim) == 0x000B58, "Wrong size on UFortGameplayAbility_PlayAnim");
...
static_assert(sizeof(UFortGameplayAbility_PlayAnimAndApplyEffect) == 0x000B70, "Wrong size on UFortGameplayAbility_PlayAnimAndApplyEffect");
