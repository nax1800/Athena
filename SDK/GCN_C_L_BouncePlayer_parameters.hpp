...
static_assert(offsetof(GCN_C_L_BouncePlayer_C_OnBurst, CallFunc_K2_SetWorldLocation_SweepHitResult) == 0x000138, "Member 'GCN_C_L_BouncePlayer_C_OnBurst::CallFunc_K2_SetWorldLocation_SweepHitResult' has a wrong offset!");
