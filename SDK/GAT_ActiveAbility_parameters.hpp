...
static_assert(alignof(GAT_ActiveAbility_C_SendHeroAbilityActivationEvent) == 0x000008, "Wrong alignment on GAT_ActiveAbility_C_SendHeroAbilityActivationEvent");
