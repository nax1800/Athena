...
static_assert(sizeof(GAT_ActiveAbility_C_SetPawnCollision) == 0x000020, "Wrong size on GAT_ActiveAbility_C_SetPawnCollision");
...
static_assert(offsetof(GAT_ActiveAbility_C_SetPawnCollision, CallFunc_GetCollisionProfileName_ReturnValue) == 0x000010, "Member 'GAT_ActiveAbility_C_SetPawnCollision::CallFunc_GetCollisionProfileName_ReturnValue' has a wrong offset!");
static_assert(offsetof(GAT_ActiveAbility_C_SetPawnCollision, CallFunc_IsValid_ReturnValue) == 0x000018, "Member 'GAT_ActiveAbility_C_SetPawnCollision::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(GAT_ActiveAbility_C_ActiveAbilitySetup) == 0x000008, "Wrong size on GAT_ActiveAbility_C_ActiveAbilitySetup");
static_assert(offsetof(GAT_ActiveAbility_C_ActiveAbilitySetup, AbilitySystemComponent) == 0x000000, "Member 'GAT_ActiveAbility_C_ActiveAbilitySetup::AbilitySystemComponent' has a wrong offset!");
