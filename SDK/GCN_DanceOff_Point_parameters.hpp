...
public:
	...
	struct FLinearColor                           Temp_struct_Variable;                              // 0x00F0(0x0010)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FLinearColor                           Temp_struct_Variable1;                             // 0x0108(0x0010)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FLinearColor                           K2Node_Select_Default;                             // 0x011C(0x0010)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_Conv_LinearColorToVector_ReturnValue;     // 0x012C(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
