...
static_assert(offsetof(UAthenaQuickBarSlot_C, UberGraphFrame_AthenaQuickBarSlot_C) == 0x000370, "Member 'UAthenaQuickBarSlot_C::UberGraphFrame_AthenaQuickBarSlot_C' has a wrong offset!");
