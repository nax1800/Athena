...
static_assert(alignof(Results_TopPanel_C_ExecuteUbergraph_Results_TopPanel) == 0x000008, "Wrong alignment on Results_TopPanel_C_ExecuteUbergraph_Results_TopPanel");
static_assert(sizeof(Results_TopPanel_C_ExecuteUbergraph_Results_TopPanel) == 0x000010, "Wrong size on Results_TopPanel_C_ExecuteUbergraph_Results_TopPanel");
...
static_assert(offsetof(Results_TopPanel_C_ExecuteUbergraph_Results_TopPanel, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000008, "Member 'Results_TopPanel_C_ExecuteUbergraph_Results_TopPanel::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
