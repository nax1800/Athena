...
static_assert(sizeof(UFortSettingRegistryExtension_Pilgrim) == 0x000080, "Wrong size on UFortSettingRegistryExtension_Pilgrim");
...
static_assert(sizeof(UPilgrimPlayerInfoWidgetBase) == 0x0002C8, "Wrong size on UPilgrimPlayerInfoWidgetBase");
...
static_assert(sizeof(UPilgrimPostGameProgressWidget) == 0x0002F0, "Wrong size on UPilgrimPostGameProgressWidget");
...
static_assert(sizeof(UPilgrimPresetSwitcher) == 0x000318, "Wrong size on UPilgrimPresetSwitcher");
...
static_assert(sizeof(UPilgrimSongSortVM) == 0x0000C0, "Wrong size on UPilgrimSongSortVM");
...
static_assert(sizeof(UPilgrimSongAlphaSortVM) == 0x0000F0, "Wrong size on UPilgrimSongAlphaSortVM");
...
static_assert(sizeof(UPilgrimSongFilterItemVM) == 0x0000E0, "Wrong size on UPilgrimSongFilterItemVM");
...
static_assert(sizeof(UPilgrimSongFilterOwnedVM) == 0x0000E0, "Wrong size on UPilgrimSongFilterOwnedVM");
...
static_assert(sizeof(UPilgrimSongFilterAvailableVM) == 0x0000E0, "Wrong size on UPilgrimSongFilterAvailableVM");
