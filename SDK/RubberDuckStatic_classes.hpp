...
public:
	...
	struct FVector                                StartLoc;                                          // 0x0C90(0x000C)(Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ARubberDuckStatic_C) == 0x000CA0, "Wrong size on ARubberDuckStatic_C");
static_assert(offsetof(ARubberDuckStatic_C, UberGraphFrame) == 0x000C88, "Member 'ARubberDuckStatic_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ARubberDuckStatic_C, StartLoc) == 0x000C90, "Member 'ARubberDuckStatic_C::StartLoc' has a wrong offset!");
