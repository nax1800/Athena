...
static_assert(sizeof(UGA_AthenaExitVehicle_C) == 0x000900, "Wrong size on UGA_AthenaExitVehicle_C");
static_assert(offsetof(UGA_AthenaExitVehicle_C, UberGraphFrame) == 0x0008F8, "Member 'UGA_AthenaExitVehicle_C::UberGraphFrame' has a wrong offset!");
