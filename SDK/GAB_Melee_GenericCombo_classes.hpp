...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GAB_Melee_GenericCombo_C;           // 0x0B80(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	double                                        OriginalMontagePlayRate;                           // 0x0B88(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UGAB_Melee_GenericCombo_C) == 0x000B90, "Wrong size on UGAB_Melee_GenericCombo_C");
