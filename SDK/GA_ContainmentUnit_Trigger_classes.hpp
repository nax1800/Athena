...
static_assert(sizeof(UGA_ContainmentUnit_Trigger_C) == 0x000918, "Wrong size on UGA_ContainmentUnit_Trigger_C");
static_assert(offsetof(UGA_ContainmentUnit_Trigger_C, UberGraphFrame) == 0x0008F8, "Member 'UGA_ContainmentUnit_Trigger_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_ContainmentUnit_Trigger_C, OriginalDamageInstigator) == 0x000900, "Member 'UGA_ContainmentUnit_Trigger_C::OriginalDamageInstigator' has a wrong offset!");
static_assert(offsetof(UGA_ContainmentUnit_Trigger_C, OriginalDamageTarget) == 0x000908, "Member 'UGA_ContainmentUnit_Trigger_C::OriginalDamageTarget' has a wrong offset!");
static_assert(offsetof(UGA_ContainmentUnit_Trigger_C, RequestReflectionTag) == 0x000910, "Member 'UGA_ContainmentUnit_Trigger_C::RequestReflectionTag' has a wrong offset!");
