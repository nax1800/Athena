...
static_assert(offsetof(FrontEnd_C_Loading_Screen_Changed, Param_IsVisible) == 0x000000, "Member 'FrontEnd_C_Loading_Screen_Changed::Param_IsVisible' has a wrong offset!");
