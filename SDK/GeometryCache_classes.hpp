...
static_assert(offsetof(UGeometryCacheComponent, NumTracks) == 0x0005B4, "Member 'UGeometryCacheComponent::NumTracks' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, ElapsedTime) == 0x0005B8, "Member 'UGeometryCacheComponent::ElapsedTime' has a wrong offset!");
