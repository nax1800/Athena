...
static_assert(sizeof(B_RCRocket_Launcher_Athena_C_OnWeaponVisibilityChanged) == 0x000001, "Wrong size on B_RCRocket_Launcher_Athena_C_OnWeaponVisibilityChanged");
