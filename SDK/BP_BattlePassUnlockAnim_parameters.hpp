...
static_assert(sizeof(BP_BattlePassUnlockAnim_C_ExecuteUbergraph_BP_BattlePassUnlockAnim) == 0x000050, "Wrong size on BP_BattlePassUnlockAnim_C_ExecuteUbergraph_BP_BattlePassUnlockAnim");
...
static_assert(offsetof(BP_BattlePassUnlockAnim_C_ExecuteUbergraph_BP_BattlePassUnlockAnim, K2Node_Event_IsDesignTime) == 0x000018, "Member 'BP_BattlePassUnlockAnim_C_ExecuteUbergraph_BP_BattlePassUnlockAnim::K2Node_Event_IsDesignTime' has a wrong offset!");
static_assert(offsetof(BP_BattlePassUnlockAnim_C_ExecuteUbergraph_BP_BattlePassUnlockAnim, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000020, "Member 'BP_BattlePassUnlockAnim_C_ExecuteUbergraph_BP_BattlePassUnlockAnim::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_BattlePassUnlockAnim_C_ExecuteUbergraph_BP_BattlePassUnlockAnim, CallFunc_GetUIManagerWidget_ReturnValue) == 0x000028, "Member 'BP_BattlePassUnlockAnim_C_ExecuteUbergraph_BP_BattlePassUnlockAnim::CallFunc_GetUIManagerWidget_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_BattlePassUnlockAnim_C_ExecuteUbergraph_BP_BattlePassUnlockAnim, CallFunc_Create_ReturnValue) == 0x000030, "Member 'BP_BattlePassUnlockAnim_C_ExecuteUbergraph_BP_BattlePassUnlockAnim::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_BattlePassUnlockAnim_C_ExecuteUbergraph_BP_BattlePassUnlockAnim, K2Node_CreateDelegate_OutputDelegate1) == 0x000038, "Member 'BP_BattlePassUnlockAnim_C_ExecuteUbergraph_BP_BattlePassUnlockAnim::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
static_assert(offsetof(BP_BattlePassUnlockAnim_C_ExecuteUbergraph_BP_BattlePassUnlockAnim, CallFunc_GetUIManagerWidget_ReturnValue1) == 0x000048, "Member 'BP_BattlePassUnlockAnim_C_ExecuteUbergraph_BP_BattlePassUnlockAnim::CallFunc_GetUIManagerWidget_ReturnValue1' has a wrong offset!");
