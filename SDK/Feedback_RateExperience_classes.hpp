...
static_assert(sizeof(UFeedback_RateExperience_C) == 0x000410, "Wrong size on UFeedback_RateExperience_C");
static_assert(offsetof(UFeedback_RateExperience_C, UberGraphFrame) == 0x000340, "Member 'UFeedback_RateExperience_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UFeedback_RateExperience_C, OneStar) == 0x000348, "Member 'UFeedback_RateExperience_C::OneStar' has a wrong offset!");
static_assert(offsetof(UFeedback_RateExperience_C, TwoStar) == 0x000350, "Member 'UFeedback_RateExperience_C::TwoStar' has a wrong offset!");
static_assert(offsetof(UFeedback_RateExperience_C, ThreeStar) == 0x000358, "Member 'UFeedback_RateExperience_C::ThreeStar' has a wrong offset!");
static_assert(offsetof(UFeedback_RateExperience_C, FourStar) == 0x000360, "Member 'UFeedback_RateExperience_C::FourStar' has a wrong offset!");
static_assert(offsetof(UFeedback_RateExperience_C, FiveStar) == 0x000368, "Member 'UFeedback_RateExperience_C::FiveStar' has a wrong offset!");
static_assert(offsetof(UFeedback_RateExperience_C, BodyEditable) == 0x000370, "Member 'UFeedback_RateExperience_C::BodyEditable' has a wrong offset!");
static_assert(offsetof(UFeedback_RateExperience_C, CancelButton) == 0x000378, "Member 'UFeedback_RateExperience_C::CancelButton' has a wrong offset!");
static_assert(offsetof(UFeedback_RateExperience_C, CommonActionWidget_0) == 0x000380, "Member 'UFeedback_RateExperience_C::CommonActionWidget_0' has a wrong offset!");
static_assert(offsetof(UFeedback_RateExperience_C, CommonActionWidget_1) == 0x000388, "Member 'UFeedback_RateExperience_C::CommonActionWidget_1' has a wrong offset!");
static_assert(offsetof(UFeedback_RateExperience_C, EntryVbox) == 0x000390, "Member 'UFeedback_RateExperience_C::EntryVbox' has a wrong offset!");
static_assert(offsetof(UFeedback_RateExperience_C, HiddenInitialStar) == 0x000398, "Member 'UFeedback_RateExperience_C::HiddenInitialStar' has a wrong offset!");
static_assert(offsetof(UFeedback_RateExperience_C, Lightbox) == 0x0003A0, "Member 'UFeedback_RateExperience_C::Lightbox' has a wrong offset!");
static_assert(offsetof(UFeedback_RateExperience_C, SendButton) == 0x0003A8, "Member 'UFeedback_RateExperience_C::SendButton' has a wrong offset!");
static_assert(offsetof(UFeedback_RateExperience_C, Title) == 0x0003B0, "Member 'UFeedback_RateExperience_C::Title' has a wrong offset!");
static_assert(offsetof(UFeedback_RateExperience_C, StarCount) == 0x0003B8, "Member 'UFeedback_RateExperience_C::StarCount' has a wrong offset!");
static_assert(offsetof(UFeedback_RateExperience_C, TooltipHeaders) == 0x0003C0, "Member 'UFeedback_RateExperience_C::TooltipHeaders' has a wrong offset!");
static_assert(offsetof(UFeedback_RateExperience_C, TooltipBodys) == 0x0003D0, "Member 'UFeedback_RateExperience_C::TooltipBodys' has a wrong offset!");
static_assert(offsetof(UFeedback_RateExperience_C, LastClickedStar) == 0x0003E0, "Member 'UFeedback_RateExperience_C::LastClickedStar' has a wrong offset!");
static_assert(offsetof(UFeedback_RateExperience_C, FeedbackTitle) == 0x0003E8, "Member 'UFeedback_RateExperience_C::FeedbackTitle' has a wrong offset!");
static_assert(offsetof(UFeedback_RateExperience_C, StarButtons) == 0x000400, "Member 'UFeedback_RateExperience_C::StarButtons' has a wrong offset!");
