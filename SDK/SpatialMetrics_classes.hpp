...
static_assert(sizeof(USpatialActorCountMetric) == 0x000088, "Wrong size on USpatialActorCountMetric");
...
static_assert(sizeof(USpatialAvailableMemoryMetric) == 0x000080, "Wrong size on USpatialAvailableMemoryMetric");
...
static_assert(sizeof(USpatialFrameTimeMetric) == 0x000080, "Wrong size on USpatialFrameTimeMetric");
...
static_assert(sizeof(USpatialGameUpdateTimeMetric) == 0x000080, "Wrong size on USpatialGameUpdateTimeMetric");
...
static_assert(sizeof(USpatialMemoryUsageMetric) == 0x000080, "Wrong size on USpatialMemoryUsageMetric");
...
static_assert(sizeof(USpatialRenderTimeMetric) == 0x000080, "Wrong size on USpatialRenderTimeMetric");
