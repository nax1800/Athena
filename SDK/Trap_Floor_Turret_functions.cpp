...
void ATrap_Floor_Turret_C::SpawnTracer(const struct FVector& Param_HitLocation)
{
	static class UFunction* Func = nullptr;
...
// (Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    Param_ShouldFire                                       (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)

void ATrap_Floor_Turret_C::ShouldFire(bool* Param_ShouldFire)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_ShouldFire != nullptr)
		*Param_ShouldFire = Parms.Param_ShouldFire;
}
...
void ATrap_Floor_Turret_C::SpawnImpactEffects(const struct FVector& Param_HitLocation)
{
	static class UFunction* Func = nullptr;
