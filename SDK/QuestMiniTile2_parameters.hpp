...
static_assert(offsetof(QuestMiniTile2_C_SetStateAndFindIncompleteQuest, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000028, "Member 'QuestMiniTile2_C_SetStateAndFindIncompleteQuest::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuestMiniTile2_C_SetStateAndFindIncompleteQuest, CallFunc_PlayAnimationTo_ReturnValue) == 0x000030, "Member 'QuestMiniTile2_C_SetStateAndFindIncompleteQuest::CallFunc_PlayAnimationTo_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuestMiniTile2_C_SetStateAndFindIncompleteQuest, CallFunc_PlayAnimationTo_ReturnValue1) == 0x000038, "Member 'QuestMiniTile2_C_SetStateAndFindIncompleteQuest::CallFunc_PlayAnimationTo_ReturnValue1' has a wrong offset!");
