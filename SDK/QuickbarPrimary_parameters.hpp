...
public:
	...
	class UCommonUISubsystem*                     CallFunc_GetContext_ReturnValue2;                  // 0x0040(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UCommonUISubsystem*                     CallFunc_GetContext_ReturnValue3;                  // 0x0078(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(QuickbarPrimary_C_ExecuteUbergraph_QuickbarPrimary, CallFunc_GetContext_ReturnValue2) == 0x000040, "Member 'QuickbarPrimary_C_ExecuteUbergraph_QuickbarPrimary::CallFunc_GetContext_ReturnValue2' has a wrong offset!");
...
static_assert(offsetof(QuickbarPrimary_C_ExecuteUbergraph_QuickbarPrimary, CallFunc_GetContext_ReturnValue3) == 0x000078, "Member 'QuickbarPrimary_C_ExecuteUbergraph_QuickbarPrimary::CallFunc_GetContext_ReturnValue3' has a wrong offset!");
...
static_assert(offsetof(QuickbarPrimary_C_HasOneNonHarvestWeapon, CallFunc_IsValid_ReturnValue2) == 0x000003, "Member 'QuickbarPrimary_C_HasOneNonHarvestWeapon::CallFunc_IsValid_ReturnValue2' has a wrong offset!");
