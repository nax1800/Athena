...
static_assert(offsetof(GAB_SmasherTurnTransition_C_ExecuteUbergraph_GAB_SmasherTurnTransition, K2Node_CreateDelegate_OutputDelegate2) == 0x000030, "Member 'GAB_SmasherTurnTransition_C_ExecuteUbergraph_GAB_SmasherTurnTransition::K2Node_CreateDelegate_OutputDelegate2' has a wrong offset!");
static_assert(offsetof(GAB_SmasherTurnTransition_C_ExecuteUbergraph_GAB_SmasherTurnTransition, K2Node_CreateDelegate_OutputDelegate3) == 0x000040, "Member 'GAB_SmasherTurnTransition_C_ExecuteUbergraph_GAB_SmasherTurnTransition::K2Node_CreateDelegate_OutputDelegate3' has a wrong offset!");
