...
static_assert(sizeof(UNewAccountWarning_C) == 0x000358, "Wrong size on UNewAccountWarning_C");
static_assert(offsetof(UNewAccountWarning_C, CommonTextBlock_2) == 0x000348, "Member 'UNewAccountWarning_C::CommonTextBlock_2' has a wrong offset!");
static_assert(offsetof(UNewAccountWarning_C, CommonTextBlock_3) == 0x000350, "Member 'UNewAccountWarning_C::CommonTextBlock_3' has a wrong offset!");
