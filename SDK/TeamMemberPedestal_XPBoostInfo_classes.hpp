...
public:
	...
	class UOverlay*                               PrimaryOvr;                                        // 0x1538(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UTeamMemberPedestal_XPBoostInfo_C) == 0x001540, "Wrong size on UTeamMemberPedestal_XPBoostInfo_C");
