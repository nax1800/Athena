...
static_assert(alignof(UGE_Trap_WallElectric_C) == 0x000008, "Wrong alignment on UGE_Trap_WallElectric_C");
static_assert(sizeof(UGE_Trap_WallElectric_C) == 0x000638, "Wrong size on UGE_Trap_WallElectric_C");
