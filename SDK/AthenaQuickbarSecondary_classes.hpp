...
static_assert(sizeof(UAthenaQuickbarSecondary_C) == 0x0002C8, "Wrong size on UAthenaQuickbarSecondary_C");
...
static_assert(offsetof(UAthenaQuickbarSecondary_C, CurrentBuildingSlot) == 0x0002C0, "Member 'UAthenaQuickbarSecondary_C::CurrentBuildingSlot' has a wrong offset!");
