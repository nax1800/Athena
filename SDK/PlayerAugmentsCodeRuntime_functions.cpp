...
void UFortControllerComponent_AugmentGrantingSystem::OnAuthorityRequestAugmentChoicesDelegate__DelegateSignature(const TArray<class UFortPlayerAugmentItemDefinition*>& IgnoreInRoll)
{
	static class UFunction* Func = nullptr;
