...
static_assert(sizeof(UAthenaDirectAcquisitionOffer_SpecialBanner_C) == 0x000270, "Wrong size on UAthenaDirectAcquisitionOffer_SpecialBanner_C");
...
static_assert(offsetof(UAthenaDirectAcquisitionOffer_SpecialBanner_C, CatalogMessaging) == 0x000268, "Member 'UAthenaDirectAcquisitionOffer_SpecialBanner_C::CatalogMessaging' has a wrong offset!");
