...
static_assert(offsetof(ScoreDetailsRow_C_UpdateRow, CallFunc_NotEqual_IntInt_ReturnValue2) == 0x00002A, "Member 'ScoreDetailsRow_C_UpdateRow::CallFunc_NotEqual_IntInt_ReturnValue2' has a wrong offset!");
...
static_assert(offsetof(ScoreDetailsRow_C_UpdateRow, CallFunc_Conv_IntToFloat_ReturnValue2) == 0x000034, "Member 'ScoreDetailsRow_C_UpdateRow::CallFunc_Conv_IntToFloat_ReturnValue2' has a wrong offset!");
static_assert(offsetof(ScoreDetailsRow_C_UpdateRow, CallFunc_NotEqual_IntInt_ReturnValue3) == 0x000038, "Member 'ScoreDetailsRow_C_UpdateRow::CallFunc_NotEqual_IntInt_ReturnValue3' has a wrong offset!");
static_assert(offsetof(ScoreDetailsRow_C_UpdateRow, CallFunc_Conv_IntToFloat_ReturnValue3) == 0x00003C, "Member 'ScoreDetailsRow_C_UpdateRow::CallFunc_Conv_IntToFloat_ReturnValue3' has a wrong offset!");
