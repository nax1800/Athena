...
static_assert(offsetof(TalkingHeadWidget_C_HandleTalkingHeadBegin, Temp_byte_Variable2) == 0x00003B, "Member 'TalkingHeadWidget_C_HandleTalkingHeadBegin::Temp_byte_Variable2' has a wrong offset!");
static_assert(offsetof(TalkingHeadWidget_C_HandleTalkingHeadBegin, Temp_byte_Variable3) == 0x00003C, "Member 'TalkingHeadWidget_C_HandleTalkingHeadBegin::Temp_byte_Variable3' has a wrong offset!");
