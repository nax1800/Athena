...
static_assert(sizeof(AS_Stream_2W_SBend_3L_a_C) == 0x0003F0, "Wrong size on AS_Stream_2W_SBend_3L_a_C");
static_assert(offsetof(AS_Stream_2W_SBend_3L_a_C, ShowTestMesh_0) == 0x0003EB, "Member 'AS_Stream_2W_SBend_3L_a_C::ShowTestMesh_0' has a wrong offset!");
