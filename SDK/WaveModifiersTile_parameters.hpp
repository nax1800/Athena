...
// 0x0008 (0x0008 - 0x0000)
struct WaveModifiersTile_C_PlayIntro final
{
public:
...
static_assert(alignof(WaveModifiersTile_C_PlayIntro) == 0x000008, "Wrong alignment on WaveModifiersTile_C_PlayIntro");
static_assert(sizeof(WaveModifiersTile_C_PlayIntro) == 0x000008, "Wrong size on WaveModifiersTile_C_PlayIntro");
static_assert(offsetof(WaveModifiersTile_C_PlayIntro, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000000, "Member 'WaveModifiersTile_C_PlayIntro::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
