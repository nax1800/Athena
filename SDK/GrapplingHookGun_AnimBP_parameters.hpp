...
static_assert(offsetof(GrapplingHookGun_AnimBP_C_ExecuteUbergraph_GrapplingHookGun_AnimBP, K2Node_DynamicCast_bSuccess1) == 0x000048, "Member 'GrapplingHookGun_AnimBP_C_ExecuteUbergraph_GrapplingHookGun_AnimBP::K2Node_DynamicCast_bSuccess1' has a wrong offset!");
...
static_assert(offsetof(GrapplingHookGun_AnimBP_C_ExecuteUbergraph_GrapplingHookGun_AnimBP, K2Node_DynamicCast_bSuccess2) == 0x000060, "Member 'GrapplingHookGun_AnimBP_C_ExecuteUbergraph_GrapplingHookGun_AnimBP::K2Node_DynamicCast_bSuccess2' has a wrong offset!");
