...
static_assert(sizeof(USmallStatRowWidget_C) == 0x000258, "Wrong size on USmallStatRowWidget_C");
static_assert(offsetof(USmallStatRowWidget_C, UberGraphFrame) == 0x000240, "Member 'USmallStatRowWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(USmallStatRowWidget_C, StatName) == 0x000248, "Member 'USmallStatRowWidget_C::StatName' has a wrong offset!");
static_assert(offsetof(USmallStatRowWidget_C, StatValue) == 0x000250, "Member 'USmallStatRowWidget_C::StatValue' has a wrong offset!");
