...
static_assert(offsetof(GAB_FlingerRoar_C_ExecuteUbergraph_GAB_FlingerRoar, K2Node_CreateDelegate_OutputDelegate2) == 0x000028, "Member 'GAB_FlingerRoar_C_ExecuteUbergraph_GAB_FlingerRoar::K2Node_CreateDelegate_OutputDelegate2' has a wrong offset!");
static_assert(offsetof(GAB_FlingerRoar_C_ExecuteUbergraph_GAB_FlingerRoar, K2Node_CreateDelegate_OutputDelegate3) == 0x000038, "Member 'GAB_FlingerRoar_C_ExecuteUbergraph_GAB_FlingerRoar::K2Node_CreateDelegate_OutputDelegate3' has a wrong offset!");
