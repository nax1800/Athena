...
static_assert(sizeof(ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription) == 0x0000B0, "Wrong size on ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription");
...
static_assert(offsetof(ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription, CallFunc_BPGetRarityData_ReturnValue) == 0x000030, "Member 'ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription::CallFunc_BPGetRarityData_ReturnValue' has a wrong offset!");
