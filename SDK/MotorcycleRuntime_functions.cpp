...
void AFortMotorcycleVehicle::MotorcycleInventoryMode__DelegateSignature(const bool IsInInventoryMode)
{
	static class UFunction* Func = nullptr;
...
void AFortMotorcycleVehicle::MotorcycleJump__DelegateSignature(const float JumpChargeFactor)
{
	static class UFunction* Func = nullptr;
...
void AFortMotorcycleVehicle::MotorcycleStartAirTrick__DelegateSignature(const EFortMotorcycleAirTrickType TrickType)
{
	static class UFunction* Func = nullptr;
...
void AFortMotorcycleVehicle::MotorcycleSuperSlidingChanged__DelegateSignature(const bool bIsSuperSliding)
{
	static class UFunction* Func = nullptr;
