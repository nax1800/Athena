...
public:
	...
	class AMinigameState_Generic_C*               K2Node_DynamicCast_AsMinigame_State_Generic;       // 0x0020(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0028(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(MinigameMode_FiringRangeV2_C_ExecuteUbergraph_MinigameMode_FiringRangeV2) == 0x000008, "Wrong alignment on MinigameMode_FiringRangeV2_C_ExecuteUbergraph_MinigameMode_FiringRangeV2");
static_assert(sizeof(MinigameMode_FiringRangeV2_C_ExecuteUbergraph_MinigameMode_FiringRangeV2) == 0x000030, "Wrong size on MinigameMode_FiringRangeV2_C_ExecuteUbergraph_MinigameMode_FiringRangeV2");
...
static_assert(offsetof(MinigameMode_FiringRangeV2_C_ExecuteUbergraph_MinigameMode_FiringRangeV2, K2Node_CreateDelegate_OutputDelegate) == 0x000008, "Member 'MinigameMode_FiringRangeV2_C_ExecuteUbergraph_MinigameMode_FiringRangeV2::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(MinigameMode_FiringRangeV2_C_ExecuteUbergraph_MinigameMode_FiringRangeV2, CallFunc_K2_SetTimerDelegate_ReturnValue) == 0x000018, "Member 'MinigameMode_FiringRangeV2_C_ExecuteUbergraph_MinigameMode_FiringRangeV2::CallFunc_K2_SetTimerDelegate_ReturnValue' has a wrong offset!");
static_assert(offsetof(MinigameMode_FiringRangeV2_C_ExecuteUbergraph_MinigameMode_FiringRangeV2, K2Node_DynamicCast_AsMinigame_State_Generic) == 0x000020, "Member 'MinigameMode_FiringRangeV2_C_ExecuteUbergraph_MinigameMode_FiringRangeV2::K2Node_DynamicCast_AsMinigame_State_Generic' has a wrong offset!");
static_assert(offsetof(MinigameMode_FiringRangeV2_C_ExecuteUbergraph_MinigameMode_FiringRangeV2, K2Node_DynamicCast_bSuccess) == 0x000028, "Member 'MinigameMode_FiringRangeV2_C_ExecuteUbergraph_MinigameMode_FiringRangeV2::K2Node_DynamicCast_bSuccess' has a wrong offset!");
...
static_assert(offsetof(MinigameMode_FiringRangeV2_C_GiftWeapons, CallFunc_GetPlayspaceManager_OutPlayspaceManager) == 0x000010, "Member 'MinigameMode_FiringRangeV2_C_GiftWeapons::CallFunc_GetPlayspaceManager_OutPlayspaceManager' has a wrong offset!");
static_assert(offsetof(MinigameMode_FiringRangeV2_C_GiftWeapons, CallFunc_GetPlayspaceManager_OutIsValid) == 0x000018, "Member 'MinigameMode_FiringRangeV2_C_GiftWeapons::CallFunc_GetPlayspaceManager_OutIsValid' has a wrong offset!");
static_assert(offsetof(MinigameMode_FiringRangeV2_C_GiftWeapons, K2Node_SwitchEnum_CmpSuccess) == 0x000019, "Member 'MinigameMode_FiringRangeV2_C_GiftWeapons::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(MinigameMode_FiringRangeV2_C_GiftWeapons, CallFunc_GetAllPlayersInPlayspace_ReturnValue) == 0x000020, "Member 'MinigameMode_FiringRangeV2_C_GiftWeapons::CallFunc_GetAllPlayersInPlayspace_ReturnValue' has a wrong offset!");
static_assert(offsetof(MinigameMode_FiringRangeV2_C_GiftWeapons, CallFunc_Array_Length_ReturnValue) == 0x000030, "Member 'MinigameMode_FiringRangeV2_C_GiftWeapons::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(MinigameMode_FiringRangeV2_C_GiftWeapons, CallFunc_Less_IntInt_ReturnValue) == 0x000040, "Member 'MinigameMode_FiringRangeV2_C_GiftWeapons::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
