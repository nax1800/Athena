...
static_assert(sizeof(AAttachableWheel) == 0x000330, "Wrong size on AAttachableWheel");
...
static_assert(sizeof(UAttachableWheelsComponent) == 0x000108, "Wrong size on UAttachableWheelsComponent");
