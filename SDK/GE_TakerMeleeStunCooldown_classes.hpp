...
static_assert(alignof(UGE_TakerMeleeStunCooldown_C) == 0x000008, "Wrong alignment on UGE_TakerMeleeStunCooldown_C");
static_assert(sizeof(UGE_TakerMeleeStunCooldown_C) == 0x000638, "Wrong size on UGE_TakerMeleeStunCooldown_C");
