...
static_assert(sizeof(ACheckForUnfloweringUITutorials_C) == 0x000398, "Wrong size on ACheckForUnfloweringUITutorials_C");
static_assert(offsetof(ACheckForUnfloweringUITutorials_C, UberGraphFrame) == 0x000388, "Member 'ACheckForUnfloweringUITutorials_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ACheckForUnfloweringUITutorials_C, DefaultSceneRoot) == 0x000390, "Member 'ACheckForUnfloweringUITutorials_C::DefaultSceneRoot' has a wrong offset!");
