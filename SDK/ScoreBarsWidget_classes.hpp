...
static_assert(sizeof(UScoreBarsWidget_C) == 0x000CB0, "Wrong size on UScoreBarsWidget_C");
...
static_assert(offsetof(UScoreBarsWidget_C, BuildingCategoryIcon) == 0x000600, "Member 'UScoreBarsWidget_C::BuildingCategoryIcon' has a wrong offset!");
static_assert(offsetof(UScoreBarsWidget_C, UtilityCategoryIcon) == 0x000930, "Member 'UScoreBarsWidget_C::UtilityCategoryIcon' has a wrong offset!");
static_assert(offsetof(UScoreBarsWidget_C, CategoryIconSize) == 0x000C60, "Member 'UScoreBarsWidget_C::CategoryIconSize' has a wrong offset!");
static_assert(offsetof(UScoreBarsWidget_C, BadgeIconSize) == 0x000C61, "Member 'UScoreBarsWidget_C::BadgeIconSize' has a wrong offset!");
static_assert(offsetof(UScoreBarsWidget_C, CategoriesMargin) == 0x000C64, "Member 'UScoreBarsWidget_C::CategoriesMargin' has a wrong offset!");
static_assert(offsetof(UScoreBarsWidget_C, BarsMargin) == 0x000C74, "Member 'UScoreBarsWidget_C::BarsMargin' has a wrong offset!");
static_assert(offsetof(UScoreBarsWidget_C, BarsIconMargin) == 0x000C84, "Member 'UScoreBarsWidget_C::BarsIconMargin' has a wrong offset!");
static_assert(offsetof(UScoreBarsWidget_C, MessageManager) == 0x000C98, "Member 'UScoreBarsWidget_C::MessageManager' has a wrong offset!");
static_assert(offsetof(UScoreBarsWidget_C, MaxScoreMessagesDisplayed) == 0x000CA0, "Member 'UScoreBarsWidget_C::MaxScoreMessagesDisplayed' has a wrong offset!");
static_assert(offsetof(UScoreBarsWidget_C, bDisplayScoreStream) == 0x000CA4, "Member 'UScoreBarsWidget_C::bDisplayScoreStream' has a wrong offset!");
static_assert(offsetof(UScoreBarsWidget_C, BarHeightOverride) == 0x000CA8, "Member 'UScoreBarsWidget_C::BarHeightOverride' has a wrong offset!");
