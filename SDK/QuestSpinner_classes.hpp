...
static_assert(sizeof(UQuestSpinner_C) == 0x000250, "Wrong size on UQuestSpinner_C");
static_assert(offsetof(UQuestSpinner_C, UberGraphFrame) == 0x000208, "Member 'UQuestSpinner_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UQuestSpinner_C, Spin) == 0x000210, "Member 'UQuestSpinner_C::Spin' has a wrong offset!");
static_assert(offsetof(UQuestSpinner_C, PendingWidget) == 0x000218, "Member 'UQuestSpinner_C::PendingWidget' has a wrong offset!");
static_assert(offsetof(UQuestSpinner_C, TopWidget) == 0x000220, "Member 'UQuestSpinner_C::TopWidget' has a wrong offset!");
static_assert(offsetof(UQuestSpinner_C, VerticalBox_1) == 0x000228, "Member 'UQuestSpinner_C::VerticalBox_1' has a wrong offset!");
static_assert(offsetof(UQuestSpinner_C, PendingQuestItem) == 0x000230, "Member 'UQuestSpinner_C::PendingQuestItem' has a wrong offset!");
static_assert(offsetof(UQuestSpinner_C, QuestItemPool) == 0x000238, "Member 'UQuestSpinner_C::QuestItemPool' has a wrong offset!");
static_assert(offsetof(UQuestSpinner_C, CurrentPoolIndex) == 0x000248, "Member 'UQuestSpinner_C::CurrentPoolIndex' has a wrong offset!");
static_assert(offsetof(UQuestSpinner_C, SpinPeriod) == 0x00024C, "Member 'UQuestSpinner_C::SpinPeriod' has a wrong offset!");
