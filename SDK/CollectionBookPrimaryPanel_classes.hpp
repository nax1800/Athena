...
static_assert(sizeof(UCollectionBookPrimaryPanel_C) == 0x0003E8, "Wrong size on UCollectionBookPrimaryPanel_C");
static_assert(offsetof(UCollectionBookPrimaryPanel_C, UberGraphFrame) == 0x0003D8, "Member 'UCollectionBookPrimaryPanel_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UCollectionBookPrimaryPanel_C, CanShowCollectionBookHelp) == 0x0003E0, "Member 'UCollectionBookPrimaryPanel_C::CanShowCollectionBookHelp' has a wrong offset!");
