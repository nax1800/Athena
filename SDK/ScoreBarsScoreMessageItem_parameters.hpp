...
static_assert(alignof(ScoreBarsScoreMessageItem_C_ExecuteUbergraph_ScoreBarsScoreMessageItem) == 0x000008, "Wrong alignment on ScoreBarsScoreMessageItem_C_ExecuteUbergraph_ScoreBarsScoreMessageItem");
static_assert(sizeof(ScoreBarsScoreMessageItem_C_ExecuteUbergraph_ScoreBarsScoreMessageItem) == 0x000020, "Wrong size on ScoreBarsScoreMessageItem_C_ExecuteUbergraph_ScoreBarsScoreMessageItem");
...
static_assert(offsetof(ScoreBarsScoreMessageItem_C_ExecuteUbergraph_ScoreBarsScoreMessageItem, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000008, "Member 'ScoreBarsScoreMessageItem_C_ExecuteUbergraph_ScoreBarsScoreMessageItem::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
static_assert(offsetof(ScoreBarsScoreMessageItem_C_ExecuteUbergraph_ScoreBarsScoreMessageItem, K2Node_Event_OldStackSize) == 0x000010, "Member 'ScoreBarsScoreMessageItem_C_ExecuteUbergraph_ScoreBarsScoreMessageItem::K2Node_Event_OldStackSize' has a wrong offset!");
static_assert(offsetof(ScoreBarsScoreMessageItem_C_ExecuteUbergraph_ScoreBarsScoreMessageItem, CallFunc_PlayAnimationAtTime_ReturnValue1) == 0x000018, "Member 'ScoreBarsScoreMessageItem_C_ExecuteUbergraph_ScoreBarsScoreMessageItem::CallFunc_PlayAnimationAtTime_ReturnValue1' has a wrong offset!");
...
static_assert(sizeof(ScoreBarsScoreMessageItem_C_Setup) == 0x000040, "Wrong size on ScoreBarsScoreMessageItem_C_Setup");
...
static_assert(offsetof(ScoreBarsScoreMessageItem_C_Setup, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000038, "Member 'ScoreBarsScoreMessageItem_C_Setup::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
