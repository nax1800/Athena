...
static_assert(offsetof(AlterationOption_C_InitIcon, CallFunc_ResizeBrush_NewParam) == 0x000090, "Member 'AlterationOption_C_InitIcon::CallFunc_ResizeBrush_NewParam' has a wrong offset!");
